...
@property (assign,nonatomic) double showStartedTimestamp;                            //@synthesize showStartedTimestamp=_showStartedTimestamp - In the implementation block
@property (assign,nonatomic) CGSize size; 
@property (nonatomic,copy) id completionBlock; 
@property (assign,nonatomic) unsigned long long mode; 
@property (assign,nonatomic) unsigned long long animationType; 
@property (nonatomic,retain) UIView * customView; 
@property (assign,nonatomic,__weak) id<WAProgressHUDDelegate> delegate; 
