...
@class WABlockBasedAlertView, NSMutableDictionary, NSObject, WAWebClient, NSLock, NSMutableOrderedSet, NSMutableSet, CNContactStore, NSString, WASyncManager, NSMutableArray, CLLocation, NSDate;
...
@property (nonatomic,readonly) NSString * twoFactorAuthenticationURL;                      //@synthesize twoFactorAuthenticationURL=_twoFactorAuthenticationURL - In the implementation block
...
@property (nonatomic,readonly) CNContactStore * sharedContactStore;                        //@synthesize sharedContactStore=_sharedContactStore - In the implementation block
...
+(BOOL)showLocalNotificationForError:(id)arg1 userInfo:(id)arg2 ;
+(id)sharedManager;
...
-(void)registerWithVerificationCode:(id)arg1 entryMethod:(int)arg2 completion:(/*^block*/id)arg3 ;
...
-(id)mapsURLsForCoordinate:(CLLocationCoordinate2D)arg1 placeName:(id)arg2 ;
...
-(void)verifyTwoFactorAuthenticationCode:(id)arg1 phoneNumber:(id)arg2 countryCode:(id)arg3 completion:(/*^block*/id)arg4 ;
-(void)resetTwoFactorAuthenticationViaEmailForPhoneNumber:(id)arg1 countryCode:(id)arg2 completion:(/*^block*/id)arg3 ;
-(void)wipeForTwoFactorAuthenticationForPhoneNumber:(id)arg1 countryCode:(id)arg2 wipeToken:(id)arg3 completion:(/*^block*/id)arg4 ;
...
-(void)beginFetchWithRequestURLString:(id)arg1 completion:(/*^block*/id)arg2 ;
...
-(NSString *)twoFactorAuthenticationURL;
