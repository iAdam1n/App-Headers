...
@interface WASampleBufferDisplayViewRenderer : NSObject {
	...
	SCD_Struct_WA8 _lastFramePresentationTimeStamp;
...
-(void)redraw:(id)arg1 ;
-(opaqueCMSampleBufferRef)copyLatestSampleBufferToUseAtTime:(SCD_Struct_WA8)arg1 ;
-(id)initWithView:(id)arg1 queue:(opaqueCMBufferQueueRef)arg2 timebase:(OpaqueCMTimebaseRef)arg3 ;
