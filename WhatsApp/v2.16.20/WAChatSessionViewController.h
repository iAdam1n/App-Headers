...
@class UIPanGestureRecognizer, NSArray, WAWarningView, WAChatCellData, WAMentionsSelectorView, UIButton, UITapGestureRecognizer, UIView, WAChatMessagesController, NSNumber, WAMessageBubbleTableViewCell, WAMessage, WAConversationHeaderView, UIBarButtonItem, UINavigationController, WAPttRecorder, NSTimer, WAMediaStreamUploadOperation, WAPttPlayer, NSDictionary, UIToolbar, NSMutableArray, NSUserActivity, WAChatSession, WAChatSessionTableView, NSString, WAScrollToBottomButton, NSSet;

@interface WAChatSessionViewController : WAChatBackgroundViewController <WAMultiSendMediaPickerControllerDelegate, WAMultiSendPreviewViewControllerDelegate, WAMultiShotCameraControllerDelegate, ABNewPersonViewControllerDelegate, ABPeoplePickerNavigationControllerDelegate, ABDisabledControllerDelegate, CNContactPickerDelegate, CNContactViewControllerDelegate, WAShareContactViewControllerDelegate, WAChatMessagesControllerDelegate, UIDocumentMenuDelegate, UIDocumentPickerDelegate, ShareLocationControllerDelegate, UIViewControllerPreviewingDelegate, WATableViewCellPreviewingDelegate, WAVCardMessagePreviewActionDelegate, UIViewControllerAnimatedTransitioning, WAImageToImageTransitioning, WANavigationControllerPushAnimating, WANavigationControllerPopToAnimating, WAConversationHeaderViewDelegate, WAPttRecorderDelegate, EKEventEditViewDelegate, WAChatBarManagerDelegate, WAMentionsSelectorViewDelegate, WAMessageBubbleTableViewCellDelegate, UIGestureRecognizerDelegate, UITableViewDelegate, UITableViewDataSource, MFMailComposeViewControllerDelegate, MFMessageComposeViewControllerDelegate, WABlurredBackgroundProviding, WAChatSessionPresenting> {
...
@property (nonatomic,readonly) WAScrollToBottomButton * scrollToMostRecentButton; 
...
@property (nonatomic,retain) WAMessage * firstVisibleMessage;                                                   //@synthesize firstVisibleMessage=_firstVisibleMessage - In the implementation block
...
-(void)sendVideoAtURL:(id)arg1 isGIF:(BOOL)arg2 gifProvider:(id)arg3 referenceURL:(id)arg4 caption:(id)arg5 ;
...
-(void)didAddMessages:(long long)arg1 ;
...
-(void)addMergedContactFromVCard:(id)arg1 toCNContact:(id)arg2 ;
...
-(WAMessage *)firstVisibleMessage;
-(id)extendMessagesForwardToCompleteCollection:(id)arg1 fromOffset:(long long)arg2 ;
-(void)addMessagesToTheBottom:(id)arg1 animated:(BOOL)arg2 dividerBehavior:(unsigned long long)arg3 allowScrolling:(BOOL)arg4 searchResultMessageID:(id)arg5 updateCount:(BOOL)arg6 ;
...
-(void)updateMessageControllerBottonPanel;
-(void)reallyBlockContact;
-(void)reallyReportContactAsSpam;
-(BOOL)searchForMatchingVCardsIfNeeded;
...
-(void)searchForVCardsForUnknownContact;
-(WAScrollToBottomButton *)scrollToMostRecentButton;
...
-(void)setFirstVisibleMessage:(WAMessage *)arg1 ;
...
-(void)callContantWithJID:(id)arg1 callUISource:(int)arg2 withVideo:(BOOL)arg3 ;
...
-(void)jumpToChatWithContact:(id)arg1 jid:(id)arg2 ;
-(void)jumpToChatSession:(id)arg1 eligibleForDeletion:(BOOL)arg2 ;
