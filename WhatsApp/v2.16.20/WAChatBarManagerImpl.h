...
@class WAChatBar, NSObject, NSNumber, WAWebPageFromTextLoader, WAWebPageMediaDownloader, NSURL, UIViewController, NSString, UIView, WARichText, WAMessage, UIButton;
...
-(void)loadChatBarIfNeeded;
-(void)resetKeyboardLayout;
-(CGRect)rectRoundedToNearestPoint:(CGRect)arg1 ;
-(BOOL)rect:(CGRect)arg1 intersectsRect:(CGRect)arg2 ;
-(void)checkDictationButton;
-(CGAffineTransform)applyTranslation:(double)arg1 toKeyboardWindowTransform:(CGAffineTransform)arg2 ;
-(void)reallyCheckDictationButton;
-(id)findDictationButtonInView:(id)arg1 ;
-(BOOL)isKeyboardFrameChangeNotification:(id)arg1 ;
-(UIView *)contentView;
