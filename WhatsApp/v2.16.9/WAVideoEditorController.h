...
@interface WAVideoEditorController : WAVideoPreviewViewController <WAMediaPlayerDelegate, WAVideoScrubberDelegate, UIGestureRecognizerDelegate, WAImageToImageTransitioning> {
	...
	SCD_Struct_WA6 _compositionSlowMotionTimeRange;
...
-(void)rebuildCompositionSeekingToSourceTime:(SCD_Struct_WA5)arg1 ;
...
-(SCD_Struct_WA5)playerTimeFromSourceTime:(SCD_Struct_WA5)arg1 ;
...
-(SCD_Struct_WA5)sourceTimeFromPlayerTime:(SCD_Struct_WA5)arg1 ;
