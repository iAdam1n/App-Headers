...
+(id)dictionaryWithValue:(BOOL)arg1 forKey:(id)arg2 ;
+(id)dictionaryWithValues:(const BOOL*)arg1 forKeys:(id*)arg2 count:(unsigned long long)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const BOOL*)arg1 forKeys:(id*)arg2 count:(unsigned long long)arg3 ;
-(void)enumerateForTextFormat:(/*^block*/id)arg1 ;
-(BOOL)valueForKey:(id)arg1 value:(BOOL*)arg2 ;
-(void)setValue:(BOOL)arg1 forKey:(id)arg2 ;
-(void)dealloc;
