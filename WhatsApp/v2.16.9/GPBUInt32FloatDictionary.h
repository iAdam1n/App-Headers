...
+(id)dictionaryWithValue:(float)arg1 forKey:(unsigned)arg2 ;
+(id)dictionaryWithValues:(const float*)arg1 forKeys:(const unsigned*)arg2 count:(unsigned long long)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const float*)arg1 forKeys:(const unsigned*)arg2 count:(unsigned long long)arg3 ;
-(void)enumerateForTextFormat:(/*^block*/id)arg1 ;
-(BOOL)valueForKey:(unsigned)arg1 value:(float*)arg2 ;
-(void)setValue:(float)arg1 forKey:(unsigned)arg2 ;
-(void)dealloc;
