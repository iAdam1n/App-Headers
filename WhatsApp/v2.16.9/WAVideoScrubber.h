...
@interface WAVideoScrubber : UIView <WAVideoScrubberTrimmerDelegate, WAVideoScrubberThumbnailBarDataSource, UIToolbarDelegate> {
	...
	SCD_Struct_WA5 _maximumDuration;
...
@property (nonatomic,readonly) SCD_Struct_WA5 maximumDuration;                                   //@synthesize maximumDuration=_maximumDuration - In the implementation block
@property (nonatomic,readonly) SCD_Struct_WA5 assetDuration;                                     //@synthesize assetDuration=_assetDuration - In the implementation block
...
-(void)videoScrubberThumbnailBar:(id)arg1 videoFramesAtTimes:(id)arg2 size:(CGSize)arg3 tolerance:(SCD_Struct_WA5)arg4 block:(/*^block*/id)arg5 ;
-(void)setNeedsRegenerateThumbnails;
-(void)setThumbnailingEnabled:(BOOL)arg1 ;
-(void)configureWithAssetDuration:(SCD_Struct_WA5)arg1 maximumDuration:(SCD_Struct_WA5)arg2 ;
...
-(void)setTimeRange:(SCD_Struct_WA6)arg1 ofSlider:(id)arg2 ;
...
-(SCD_Struct_WA5)maximumDuration;
