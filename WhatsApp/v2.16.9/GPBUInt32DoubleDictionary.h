...
+(id)dictionaryWithValue:(double)arg1 forKey:(unsigned)arg2 ;
+(id)dictionaryWithValues:(const double*)arg1 forKeys:(const unsigned*)arg2 count:(unsigned long long)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const double*)arg1 forKeys:(const unsigned*)arg2 count:(unsigned long long)arg3 ;
-(void)enumerateForTextFormat:(/*^block*/id)arg1 ;
-(BOOL)valueForKey:(unsigned)arg1 value:(double*)arg2 ;
-(void)setValue:(double)arg1 forKey:(unsigned)arg2 ;
-(void)dealloc;
