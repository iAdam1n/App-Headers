...
@interface WAMapView : UIView <MKMapViewDelegate, WAStaticPinControllerDelegate, UIGestureRecognizerDelegate> {
	...
	SCD_Struct_WA10 _userLocationMapRect;
	SCD_Struct_WA10 _savedMapRect;
...
@property (nonatomic,readonly) SCD_Struct_WA10 region; 
...
-(SCD_Struct_WA10)visibleMapRect;
-(void)handlePanGesture:(id)arg1 ;
-(NSArray *)selectedAnnotations;
-(void)setShowsUserLocation:(BOOL)arg1 ;
-(void)setSelectedAnnotations:(NSArray *)arg1 ;
-(MKUserLocation *)userLocation;
-(SCD_Struct_WA10)mapRectThatFits:(SCD_Struct_WA10)arg1 ;
-(SCD_Struct_WA10)mapRectThatFits:(SCD_Struct_WA10)arg1 edgePadding:(UIEdgeInsets)arg2 ;
-(void)setVisibleMapRect:(SCD_Struct_WA10)arg1 animated:(BOOL)arg2 ;
