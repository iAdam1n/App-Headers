...
+(id)dictionaryWithValue:(unsigned)arg1 forKey:(id)arg2 ;
+(id)dictionaryWithValues:(const unsigned*)arg1 forKeys:(id*)arg2 count:(unsigned long long)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const unsigned*)arg1 forKeys:(id*)arg2 count:(unsigned long long)arg3 ;
-(void)enumerateForTextFormat:(/*^block*/id)arg1 ;
-(BOOL)valueForKey:(id)arg1 value:(unsigned*)arg2 ;
-(void)setValue:(unsigned)arg1 forKey:(id)arg2 ;
-(void)dealloc;
