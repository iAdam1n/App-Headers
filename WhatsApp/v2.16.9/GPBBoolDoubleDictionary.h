...
+(id)dictionaryWithValue:(double)arg1 forKey:(BOOL)arg2 ;
+(id)dictionaryWithValues:(const double*)arg1 forKeys:(const BOOL*)arg2 count:(unsigned long long)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const double*)arg1 forKeys:(const BOOL*)arg2 count:(unsigned long long)arg3 ;
-(void)enumerateForTextFormat:(/*^block*/id)arg1 ;
-(BOOL)valueForKey:(BOOL)arg1 value:(double*)arg2 ;
-(void)setValue:(double)arg1 forKey:(BOOL)arg2 ;
