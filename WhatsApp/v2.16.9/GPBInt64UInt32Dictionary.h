...
+(id)dictionaryWithValue:(unsigned)arg1 forKey:(long long)arg2 ;
+(id)dictionaryWithValues:(const unsigned*)arg1 forKeys:(const long long*)arg2 count:(unsigned long long)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const unsigned*)arg1 forKeys:(const long long*)arg2 count:(unsigned long long)arg3 ;
-(void)enumerateForTextFormat:(/*^block*/id)arg1 ;
-(BOOL)valueForKey:(long long)arg1 value:(unsigned*)arg2 ;
-(void)setValue:(unsigned)arg1 forKey:(long long)arg2 ;
-(void)dealloc;
