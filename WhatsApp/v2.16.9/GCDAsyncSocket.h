...
+(void)freeCFHostConnect:(CFHostRef)arg1 readStream:(CFReadStreamRef)arg2 writeStream:(CFWriteStreamRef)arg3 ;
...
-(void)connectImplWithCFHost:(CFHostRef)arg1 onPort:(unsigned short)arg2 withTimeout:(double)arg3 ;
-(void)didNotConnect:(int)arg1 error:(id)arg2 ;
-(int)blockUntilReadStreamOpened:(CFReadStreamRef)arg1 withTimeout:(double)arg2 ;
...
-(BOOL)connectWithCFHost:(CFHostRef)arg1 onPort:(unsigned short)arg2 withTimeout:(double)arg3 error:(id*)arg4 ;
