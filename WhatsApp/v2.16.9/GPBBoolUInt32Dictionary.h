...
+(id)dictionaryWithValue:(unsigned)arg1 forKey:(BOOL)arg2 ;
+(id)dictionaryWithValues:(const unsigned*)arg1 forKeys:(const BOOL*)arg2 count:(unsigned long long)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const unsigned*)arg1 forKeys:(const BOOL*)arg2 count:(unsigned long long)arg3 ;
-(void)enumerateForTextFormat:(/*^block*/id)arg1 ;
-(BOOL)valueForKey:(BOOL)arg1 value:(unsigned*)arg2 ;
-(void)setValue:(unsigned)arg1 forKey:(BOOL)arg2 ;
