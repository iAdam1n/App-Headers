...
+(id)dictionaryWithValue:(long long)arg1 forKey:(unsigned)arg2 ;
+(id)dictionaryWithValues:(const long long*)arg1 forKeys:(const unsigned*)arg2 count:(unsigned long long)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const long long*)arg1 forKeys:(const unsigned*)arg2 count:(unsigned long long)arg3 ;
-(void)enumerateForTextFormat:(/*^block*/id)arg1 ;
-(BOOL)valueForKey:(unsigned)arg1 value:(long long*)arg2 ;
-(void)setValue:(long long)arg1 forKey:(unsigned)arg2 ;
-(void)dealloc;
