...
+(id)dictionaryWithValue:(unsigned long long)arg1 forKey:(BOOL)arg2 ;
+(id)dictionaryWithValues:(const unsigned long long*)arg1 forKeys:(const BOOL*)arg2 count:(unsigned long long)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const unsigned long long*)arg1 forKeys:(const BOOL*)arg2 count:(unsigned long long)arg3 ;
-(void)enumerateForTextFormat:(/*^block*/id)arg1 ;
-(BOOL)valueForKey:(BOOL)arg1 value:(unsigned long long*)arg2 ;
-(void)setValue:(unsigned long long)arg1 forKey:(BOOL)arg2 ;
