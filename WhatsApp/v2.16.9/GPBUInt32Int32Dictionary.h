...
+(id)dictionaryWithValue:(int)arg1 forKey:(unsigned)arg2 ;
+(id)dictionaryWithValues:(const int*)arg1 forKeys:(const unsigned*)arg2 count:(unsigned long long)arg3 ;
+(id)dictionary;
...
-(id)initWithValues:(const int*)arg1 forKeys:(const unsigned*)arg2 count:(unsigned long long)arg3 ;
