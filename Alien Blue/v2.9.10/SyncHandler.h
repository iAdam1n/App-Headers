...
@property (readonly) BOOL allowHandlingRequests; 
@property (readonly) NSString * keyToMonitor; 
@property (assign) BOOL i_allowHandlingChangeRequests;              //@synthesize i_allowHandlingChangeRequests=_i_allowHandlingChangeRequests - In the implementation block
...
-(void)setI_allowHandlingChangeRequests:(BOOL)arg1 ;
