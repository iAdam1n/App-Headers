...
@class EDAMResourceAttributes, EDAMUserException, EDAMSystemException, EDAMNotFoundException;
...
@property (setter=setSuccess:,getter=success,nonatomic,retain) EDAMResourceAttributes * success; 
...
-(void)setSuccess:(EDAMResourceAttributes *)arg1 ;
-(void)write:(id)arg1 ;
@end
