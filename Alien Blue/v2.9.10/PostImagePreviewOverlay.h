...
@property (retain) CommentPostHeaderNode * node;              //@synthesize node=_node - In the implementation block
...
-(CommentPostHeaderNode *)node;
-(void)setNode:(CommentPostHeaderNode *)arg1 ;
@end
