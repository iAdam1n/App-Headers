...
@class EDAMPublicUserInfo, EDAMNotFoundException, EDAMSystemException, EDAMUserException;
...
@property (setter=setSuccess:,getter=success,nonatomic,retain) EDAMPublicUserInfo * success; 
...
-(void)setSuccess:(EDAMPublicUserInfo *)arg1 ;
-(void)write:(id)arg1 ;
@end
