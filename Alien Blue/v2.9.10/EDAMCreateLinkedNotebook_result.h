...
@class EDAMLinkedNotebook, EDAMUserException, EDAMNotFoundException, EDAMSystemException;
...
@property (setter=setSuccess:,getter=success,nonatomic,retain) EDAMLinkedNotebook * success; 
...
-(void)setSuccess:(EDAMLinkedNotebook *)arg1 ;
-(void)write:(id)arg1 ;
@end
