...
@class EDAMPremiumInfo, EDAMUserException, EDAMSystemException;
...
@property (setter=setSuccess:,getter=success,nonatomic,retain) EDAMPremiumInfo * success; 
...
-(void)setSuccess:(EDAMPremiumInfo *)arg1 ;
-(void)write:(id)arg1 ;
@end
