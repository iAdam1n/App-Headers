...
@class EDAMNoteCollectionCounts, EDAMUserException, EDAMSystemException, EDAMNotFoundException;
...
@property (setter=setSuccess:,getter=success,nonatomic,retain) EDAMNoteCollectionCounts * success; 
...
-(void)setSuccess:(EDAMNoteCollectionCounts *)arg1 ;
-(void)write:(id)arg1 ;
@end
