...
@class EDAMRelatedResult, EDAMUserException, EDAMSystemException, EDAMNotFoundException;
...
@property (setter=setSuccess:,getter=success,nonatomic,retain) EDAMRelatedResult * success; 
...
-(void)setSuccess:(EDAMRelatedResult *)arg1 ;
-(void)write:(id)arg1 ;
@end
