...
@class EDAMResource, EDAMUserException, EDAMSystemException, EDAMNotFoundException;
...
@property (setter=setSuccess:,getter=success,nonatomic,retain) EDAMResource * success; 
...
-(void)setSuccess:(EDAMResource *)arg1 ;
-(void)write:(id)arg1 ;
@end
