...
@class EDAMNotebook, EDAMUserException, EDAMSystemException, EDAMNotFoundException;
...
@property (setter=setSuccess:,getter=success,nonatomic,retain) EDAMNotebook * success; 
...
-(void)setSuccess:(EDAMNotebook *)arg1 ;
-(void)write:(id)arg1 ;
@end
