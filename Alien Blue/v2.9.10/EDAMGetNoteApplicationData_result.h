...
@class EDAMLazyMap, EDAMUserException, EDAMSystemException, EDAMNotFoundException;
...
@property (setter=setSuccess:,getter=success,nonatomic,retain) EDAMLazyMap * success; 
...
-(id)description;
-(EDAMLazyMap *)success;
-(void)setSuccess:(EDAMLazyMap *)arg1 ;
-(void)write:(id)arg1 ;
@end
