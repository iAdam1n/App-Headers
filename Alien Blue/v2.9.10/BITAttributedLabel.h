...
@class NSAttributedString, NSDataDetector, NSArray, NSDictionary, NSTextCheckingResult, NSString;
...
-(id)detectedLinksInString:(id)arg1 range:(NSRange)arg2 error:(id*)arg3 ;
-(CTFramesetterRef)highlightFramesetter;
-(void)drawFramesetter:(CTFramesetterRef)arg1 attributedString:(id)arg2 textRange:(SCD_Struct_BI43)arg3 inRect:(CGRect)arg4 context:(CGContextRef)arg5 ;
...
-(void)setDelegate:(id<BITAttributedLabelDelegate>)arg1 ;
-(void)dealloc;
-(CGSize)sizeThatFits:(CGSize)arg1 ;
-(id<BITAttributedLabelDelegate>)delegate;
