...
@property (assign,setter=setNoteOnly:,getter=noteOnly,nonatomic) BOOL noteOnly; 
@property (assign,setter=setTokenizeForIndexing:,getter=tokenizeForIndexing,nonatomic) BOOL tokenizeForIndexing; 
-(void)read:(id)arg1 ;
-(BOOL)guidIsSet;
-(void)unsetGuid;
-(BOOL)authenticationTokenIsSet;
-(void)unsetAuthenticationToken;
-(void)setNoteOnly:(BOOL)arg1 ;
-(void)setTokenizeForIndexing:(BOOL)arg1 ;
-(id)initWithAuthenticationToken:(id)arg1 guid:(id)arg2 noteOnly:(BOOL)arg3 tokenizeForIndexing:(BOOL)arg4 ;
-(BOOL)noteOnly;
-(BOOL)noteOnlyIsSet;
-(void)unsetNoteOnly;
