...
@class EDAMNoteList, EDAMUserException, EDAMSystemException, EDAMNotFoundException;
...
@property (setter=setSuccess:,getter=success,nonatomic,retain) EDAMNoteList * success; 
...
-(void)setSuccess:(EDAMNoteList *)arg1 ;
-(void)write:(id)arg1 ;
@end
