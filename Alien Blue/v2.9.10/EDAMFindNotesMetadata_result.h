...
@class EDAMNotesMetadataList, EDAMUserException, EDAMSystemException, EDAMNotFoundException;
...
@property (setter=setSuccess:,getter=success,nonatomic,retain) EDAMNotesMetadataList * success; 
...
-(void)setSuccess:(EDAMNotesMetadataList *)arg1 ;
-(void)write:(id)arg1 ;
@end
