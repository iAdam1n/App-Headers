...
@class EDAMSyncChunk, EDAMUserException, EDAMSystemException, EDAMNotFoundException;
...
@property (setter=setSuccess:,getter=success,nonatomic,retain) EDAMSyncChunk * success; 
...
-(void)setSuccess:(EDAMSyncChunk *)arg1 ;
-(void)write:(id)arg1 ;
@end
