...
@class NSString, EDAMNoteEmailParameters;
...
@property (setter=setParameters:,getter=parameters,nonatomic,retain) EDAMNoteEmailParameters * parameters; 
-(void)read:(id)arg1 ;
...
-(void)setParameters:(EDAMNoteEmailParameters *)arg1 ;
