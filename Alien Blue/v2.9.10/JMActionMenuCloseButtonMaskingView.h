...
@interface JMActionMenuCloseButtonMaskingView : UIView {
...
-(void)setMaskingBackgroundImage:(id)arg1 maskingRect:(CGRect)arg2 rotatedAngle:(double)arg3 appliedTransform:(CGAffineTransform)arg4 ;
