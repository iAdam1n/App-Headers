...
@class NSString, EDAMClientUsageMetrics;
...
@property (setter=setClientMetrics:,getter=clientMetrics,nonatomic,retain) EDAMClientUsageMetrics * clientMetrics; 
-(void)read:(id)arg1 ;
-(BOOL)authenticationTokenIsSet;
-(void)unsetAuthenticationToken;
-(void)setClientMetrics:(EDAMClientUsageMetrics *)arg1 ;
