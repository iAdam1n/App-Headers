...
@class EDAMSavedSearch, EDAMUserException, EDAMSystemException, EDAMNotFoundException;
...
@property (setter=setSuccess:,getter=success,nonatomic,retain) EDAMSavedSearch * success; 
...
-(void)setSuccess:(EDAMSavedSearch *)arg1 ;
-(void)write:(id)arg1 ;
@end
