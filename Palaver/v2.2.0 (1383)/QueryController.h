...
@class PLVAppDelegate, IRCQuery, Theme, UIBarButtonItem, UIActionSheet, NSMutableArray, NSString;
...
@property (retain) Theme * theme;                                                   //@synthesize theme=_theme - In the implementation block
