...
#import "SOJULoadConversationsRequest.h"

@class NSString;

@interface SOJULoadConversationsRequest : NSObject <SOJULoadConversationsRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 offset:(id)arg4;
