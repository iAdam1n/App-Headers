...
#import "SOJUAnalyticsUpdateEventsRequest.h"

@class NSArray, NSString;

@interface SOJUAnalyticsUpdateEventsRequest : NSObject <SOJUAnalyticsUpdateEventsRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 events:(id)arg4;
