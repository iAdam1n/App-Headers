...
@class Friends, KeychainItemWrapper, NSArray, NSDate, NSDictionary, NSMutableArray, NSMutableDictionary, NSNumber, NSString, SCCPSessionDataStore, SCChats, SCClientEncryption, SCDiscoverChannels, SCDiscoverUserProperties, SCFeatureSettings, SCProfileImages, SCUserCashStatus, SCUserToolTipStatus, Snap, UploadUrlCache;

@interface User : NSObject <SCMediaOwnerProtocol, NSCoding, SCUserProtocol>
{
    _Bool _appIsBeingTerminated;
    ...
    NSDictionary *_verifiedPublications;
...
@property(nonatomic) _Bool tosAcceptedAgain; // @synthesize tosAcceptedAgain=_tosAcceptedAgain;
...
@property(nonatomic) _Bool shouldSendTextToVerifyNumber; // @synthesize shouldSendTextToVerifyNumber=_shouldSendTextToVerifyNumber;
...
@property(getter=hasAcceptedTermsOfUseForNineEighteen) _Bool acceptedTermsOfUseForNineEighteen; // @synthesize acceptedTermsOfUseForNineEighteen=_acceptedTermsOfUseForNineEighteen;
...
@property(retain, nonatomic) NSMutableArray *sentStickers; // @synthesize sentStickers=_sentStickers;
...
@property(nonatomic, getter=isDiscoverSharingEnabled) _Bool discoverSharingEnabled; // @synthesize discoverSharingEnabled=_discoverSharingEnabled;
...
@property(nonatomic) _Bool isTwoFAEnabled; // @synthesize isTwoFAEnabled=_isTwoFAEnabled;
...
@property(nonatomic) _Bool isOwnerOfVerifiedPublication; // @synthesize isOwnerOfVerifiedPublication=_isOwnerOfVerifiedPublication;
@property(retain, nonatomic) NSDictionary *verifiedPublications; // @synthesize verifiedPublications=_verifiedPublications;
...
@property(nonatomic) _Bool appIsBeingTerminated; // @synthesize appIsBeingTerminated=_appIsBeingTerminated;
- (void).cxx_destruct;
...
- (void)enableTwoFA:(id)arg1 onComplete:(CDUnknownBlockType)arg2;
- (void)sendTwoFACode:(CDUnknownBlockType)arg1;
- (void)generateRecoveryCode:(CDUnknownBlockType)arg1;
- (void)disableTwoFA:(CDUnknownBlockType)arg1;
...
- (id)_localizedErrorMessageFor:(id)arg1;
...
@property(retain) SCFeatureSettings *featureSettings; // @synthesize featureSettings=_featureSettings;
...
- (void)setDisplayedSharedLocalStoriesIntroView:(id)arg1;
...
- (_Bool)shouldDisplaySharedLocalStoriesIntroView:(id)arg1;
