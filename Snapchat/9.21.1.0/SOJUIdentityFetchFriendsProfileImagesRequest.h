...
#import "SOJUIdentityFetchFriendsProfileImagesRequest.h"

@class NSArray, NSString;

@interface SOJUIdentityFetchFriendsProfileImagesRequest : NSObject <SOJUIdentityFetchFriendsProfileImagesRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 size:(id)arg4 addedFriends:(id)arg5;
