...
@interface SCVerticalSwipeView : UIView <UIScrollViewDelegate>
{
...
- (id)initWithPrimaryColor:(id)arg1 secondaryColor:(id)arg2 affordanceText:(id)arg3 showGradientBackgroundForAffordance:(_Bool)arg4;
