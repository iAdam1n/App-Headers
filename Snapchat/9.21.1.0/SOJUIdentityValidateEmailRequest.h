...
#import "SOJUIdentityValidateEmailRequest.h"

@class NSNumber, NSString;

@interface SOJUIdentityValidateEmailRequest : NSObject <SOJUIdentityValidateEmailRequest>
{
    NSString *_email;
    NSString *_username;
    NSString *_reqToken;
...
- (id)initWithEmail:(id)arg1 username:(id)arg2 reqToken:(id)arg3 timestamp:(id)arg4;
