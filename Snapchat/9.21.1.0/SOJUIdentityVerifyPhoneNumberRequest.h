...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 action:(id)arg4 code:(id)arg5 type:(id)arg6 password:(id)arg7 dtoken1i:(id)arg8 dsig:(id)arg9;
