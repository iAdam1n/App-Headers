...
#import "SOJUChatTalkingRequest.h"

@class NSString;

@interface SOJUChatTalkingRequest : NSObject <SOJUChatTalkingRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 recipient:(id)arg4 action:(id)arg5 medium:(id)arg6;
