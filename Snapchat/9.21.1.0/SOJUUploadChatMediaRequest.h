...
#import "SOJUUploadChatMediaRequest.h"

@class NSData, NSString;

@interface SOJUUploadChatMediaRequest : NSObject <SOJUUploadChatMediaRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 idValue:(id)arg4 type:(id)arg5 data:(id)arg6 conversationId:(id)arg7 recipient:(id)arg8;
