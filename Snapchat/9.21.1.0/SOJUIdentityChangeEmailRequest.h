...
#import "SOJUIdentityChangeEmailRequest.h"

@class NSString;

@interface SOJUIdentityChangeEmailRequest : NSObject <SOJUIdentityChangeEmailRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 email:(id)arg4;
