...
#import "SOJULoadMediaCardContentRequest.h"

@class NSArray, NSString;

@interface SOJULoadMediaCardContentRequest : NSObject <SOJULoadMediaCardContentRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 conversationId:(id)arg4 messageId:(id)arg5 urls:(id)arg6;
