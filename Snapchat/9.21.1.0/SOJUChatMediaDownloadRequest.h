...
#import "SOJUChatMediaDownloadRequest.h"

@class NSString;

@interface SOJUChatMediaDownloadRequest : NSObject <SOJUChatMediaDownloadRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 idValue:(id)arg4 conversationId:(id)arg5;
