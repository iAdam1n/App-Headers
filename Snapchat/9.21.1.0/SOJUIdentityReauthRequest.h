...
#import "SOJUIdentityReauthRequest.h"

@class NSString;

@interface SOJUIdentityReauthRequest : NSObject <SOJUIdentityReauthRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 password:(id)arg4;
