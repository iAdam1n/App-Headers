...
#import "SOJUCashRetrieveTransactionRequest.h"

@class NSString;

@interface SOJUCashRetrieveTransactionRequest : NSObject <SOJUCashRetrieveTransactionRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 transactionId:(id)arg4 conversationId:(id)arg5;
