...
#import "SOJUStickerPacksRequest.h"

@class NSString;

@interface SOJUStickerPacksRequest : NSObject <SOJUStickerPacksRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 locale:(id)arg4;
