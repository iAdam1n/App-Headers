...
@class NSArray, NSMutableDictionary, NSString, SCCounterLabel, SCCustomVolumeController, SCHeadset, SCSnapTimer, SCSponsoredSlugView, SCStoriesTimer, UIImageView, UISwipeGestureRecognizer;

@interface SCMediaView : SCFrameableContainerView <UIGestureRecognizerDelegate, SCPullToDismissVolumeController, SCPullToDismissGestureReceiver>
{
    struct CGSize _contentSize;
    _Bool _isLooping;
    _Bool _playerAPlaying;
    _Bool _playerBPlaying;
    id <SCMediaViewDelegate> _delegate;
...
@property(nonatomic) __weak id <SCMediaViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (void)setNaturalContentSizeWithMedia:(id)arg1;
