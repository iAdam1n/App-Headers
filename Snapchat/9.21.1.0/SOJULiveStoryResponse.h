...
- (id)initWithUsername:(id)arg1 stories:(id)arg2 displayName:(id)arg3 isLocal:(id)arg4 hasCustomDescription:(id)arg5 sharedId:(id)arg6 matureContent:(id)arg7 adPlacementMetadata:(id)arg8 thumbnails:(id)arg9 allowStoryExplorer:(id)arg10 error:(id)arg11;
