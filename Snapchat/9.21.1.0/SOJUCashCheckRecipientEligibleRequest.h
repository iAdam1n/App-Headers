...
#import "SOJUCashCheckRecipientEligibleRequest.h"

@class NSString;

@interface SOJUCashCheckRecipientEligibleRequest : NSObject <SOJUCashCheckRecipientEligibleRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 recipient:(id)arg4;
