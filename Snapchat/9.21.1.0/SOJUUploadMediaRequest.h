...
#import "SOJUUploadMediaRequest.h"

@class NSData, NSNumber, NSString;

@interface SOJUUploadMediaRequest : NSObject <SOJUUploadMediaRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 mediaId:(id)arg4 type:(id)arg5 data:(id)arg6;
