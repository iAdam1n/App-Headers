...
#import "SOJUUpdateStoriesRequest.h"

@class NSArray, NSString;

@interface SOJUUpdateStoriesRequest : NSObject <SOJUUpdateStoriesRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 friendStories:(id)arg4;
