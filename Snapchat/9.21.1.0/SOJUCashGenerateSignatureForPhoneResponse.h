...
#import "SOJUCashGenerateSignatureForPhoneResponse.h"

@class NSString;

@interface SOJUCashGenerateSignatureForPhoneResponse : NSObject <SOJUCashGenerateSignatureForPhoneResponse>
{
    NSString *_status;
...
- (id)initWithStatus:(id)arg1 phoneNumber:(id)arg2 signature:(id)arg3;
