...
#import "SOJULoadConversationRequest.h"

@class NSString;

@interface SOJULoadConversationRequest : NSObject <SOJULoadConversationRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 conversationId:(id)arg4 offset:(id)arg5;
