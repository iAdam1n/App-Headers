...
#import "SOJUDeviceSyncRequest.h"

@class NSString;

@interface SOJUDeviceSyncRequest : NSObject <SOJUDeviceSyncRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 type:(id)arg4 deviceToken:(id)arg5 applicationId:(id)arg6;
