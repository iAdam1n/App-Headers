...
- (double)textLeftInsetForTraitCollection:(id)arg1 withSize:(struct CGSize)arg2;
- (double)textLeftInsetForTraitCollection:(id)arg1;
@property(readonly, nonatomic) double textLeftInset;
- (double)horizontalOffsetTextfieldForTraitCollection:(id)arg1 withSize:(struct CGSize)arg2;
- (double)horizontalOffsetTextfieldForTraitCollection:(id)arg1;
@property(readonly, nonatomic) double horizontalOffsetTextfield;
...
- (id)magnifyingGlassBgColorForTraitCollection:(id)arg1 withSize:(struct CGSize)arg2;
- (id)magnifyingGlassBgColorForTraitCollection:(id)arg1;
@property(readonly, nonatomic) UIColor *magnifyingGlassBgColor;
- (id)outerBackgroundColorForTraitCollection:(id)arg1 withSize:(struct CGSize)arg2;
- (id)outerBackgroundColorForTraitCollection:(id)arg1;
@property(readonly, nonatomic) UIColor *outerBackgroundColor;
