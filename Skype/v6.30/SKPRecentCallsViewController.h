...
@interface SKPRecentCallsViewController : SKPViewController <UITableViewDelegate, UITableViewDataSource, SKPViewModelArrayControllerDelegate, SKPDialpadPresenting> {
