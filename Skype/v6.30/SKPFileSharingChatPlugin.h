...
@class SKPFileOpener, NSString;

@interface SKPFileSharingChatPlugin : NSObject <SKPChatPlugin> {

	SKPFileOpener* _fileOpener;

}

@property (nonatomic,retain) SKPFileOpener * fileOpener;              //@synthesize fileOpener=_fileOpener - In the implementation block
@property (readonly) unsigned long long hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
+(void)load;
-(SKPFileOpener *)fileOpener;
-(void)setFileOpener:(SKPFileOpener *)arg1 ;
-(id)cellClasses;
