...
@interface SKPNGCUpgradeMessage : SKPMessage {

	NSArray* _skypeNames;

}

@property (nonatomic,retain) NSArray * skypeNames;              //@synthesize skypeNames=_skypeNames - In the implementation block
-(void)willSetValue:(id)arg1 forKey:(id)arg2 andUseMainQueueToSet:(BOOL)arg3 ;
-(id)attributedSummary;
-(NSArray *)skypeNames;
-(void)setSkypeNames:(NSArray *)arg1 ;
-(long long)type;
-(BOOL)isDeletable;
@end
