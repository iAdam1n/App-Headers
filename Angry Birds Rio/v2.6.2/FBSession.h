...
#import <AngryBirdsRio/FBLoginDialogDelegate.h>

@class NSString, NSMutableArray, NSArray, FBAccessTokenData, UIViewController, FBSessionTokenCachingStrategy, NSDate, FBLoginDialog, NSThread, FBSessionAppEventsState, FBSessionAuthLogger;
...
@property (assign,nonatomic) UIViewController * fromViewController;                   //@synthesize fromViewController=_fromViewController - In the implementation block
...
+(BOOL)openActiveSessionWithAllowLoginUI:(BOOL)arg1 fromViewController:(id)arg2 ;
+(BOOL)openActiveSessionWithPermissions:(id)arg1 allowLoginUI:(BOOL)arg2 allowSystemAccount:(BOOL)arg3 isRead:(BOOL)arg4 defaultAudience:(unsigned long long)arg5 fromViewController:(id)arg6 completionHandler:(/*^block*/id)arg7 ;
+(BOOL)openActiveSessionWithPermissions:(id)arg1 allowLoginUI:(BOOL)arg2 defaultAudience:(unsigned long long)arg3 fromViewController:(id)arg4 completionHandler:(/*^block*/id)arg5 ;
+(BOOL)openActiveSessionWithReadPermissions:(id)arg1 allowLoginUI:(BOOL)arg2 fromViewController:(id)arg3 completionHandler:(/*^block*/id)arg4 ;
+(BOOL)openActiveSessionWithPublishPermissions:(id)arg1 defaultAudience:(unsigned long long)arg2 allowLoginUI:(BOOL)arg3 fromViewController:(id)arg4 completionHandler:(/*^block*/id)arg5 ;
...
+(BOOL)openActiveSessionWithPermissions:(id)arg1 allowLoginUI:(BOOL)arg2 loginBehavior:(unsigned long long)arg3 isRead:(BOOL)arg4 defaultAudience:(unsigned long long)arg5 fromViewController:(id)arg6 completionHandler:(/*^block*/id)arg7 ;
...
-(void)openWithCompletionHandler:(/*^block*/id)arg1 fromViewController:(id)arg2 ;
...
-(id)refreshDate;
-(void)openWithBehavior:(unsigned long long)arg1 fromViewController:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(BOOL)authorizeUsingSafari:(id)arg1 useSFVC:(BOOL)arg2 ;
