...
#import <Tweetbot/SKProductsRequestDelegate.h>

@class SKProductsResponse, NSString;
...
@property (nonatomic,retain) SKProductsResponse * response;              //@synthesize response=_response - In the implementation block
...
-(void)setResponse:(SKProductsResponse *)arg1 ;
@end
