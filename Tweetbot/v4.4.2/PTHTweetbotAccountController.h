...
@interface PTHTweetbotAccountController : PTHViewController <PTHTweetbotAccountTabBarDelegate, PTHTweetbotAccountPickerControllerDelegate, UIGestureRecognizerDelegate> {
	...
	NSMutableDictionary* _tabToRightBarButtonItems;
...
@property (nonatomic,readonly) BOOL isSideControllVisible; 
...
-(void)_willTransitionSideController:(BOOL)arg1 ;
-(void)_transitionSideController:(BOOL)arg1 ;
-(void)_didTransitionSideController:(BOOL)arg1 ;
-(void)_updateTabBarTitleHack;
-(long long)tabForController:(id)arg1 ;
-(void)_toggleSideController;
-(void)_changeAccount:(id)arg1 ;
-(BOOL)isSideControllVisible;
