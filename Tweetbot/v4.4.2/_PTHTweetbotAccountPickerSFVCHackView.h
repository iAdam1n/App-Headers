...
@interface _PTHTweetbotAccountPickerSFVCHackView : UIView {

	BOOL _freezeFrame;

}

@property (assign,nonatomic) BOOL freezeFrame;              //@synthesize freezeFrame=_freezeFrame - In the implementation block
