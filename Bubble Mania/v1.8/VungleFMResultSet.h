...
@class VungleFMDatabase, VungleFMStatement, NSString, NSMutableDictionary;

@interface VungleFMResultSet : NSObject {

	VungleFMDatabase* _parentDB;
	VungleFMStatement* _statement;
	NSString* _query;
...
@property (retain) VungleFMStatement * statement;                             //@synthesize statement=_statement - In the implementation block
...
-(void)setStatement:(VungleFMStatement *)arg1 ;
-(VungleFMStatement *)statement;
-(void)finalize;
@end
