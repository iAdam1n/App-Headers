...
@property (nonatomic,readonly) int iapEngagementType;                //@synthesize iapEngagementType=_iapEngagementType - In the implementation block
+(id)currentAdInfo;
-(void)clearIAPInfo;
...
-(void)setIAPEngagementType:(int)arg1 ;
-(id)init;
-(void)reset;
