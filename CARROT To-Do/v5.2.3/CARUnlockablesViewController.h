...
@class UIImageView, UIColor, UILabel, NSArray, UITableView, UIView, UIButton, NSString;

@interface CARUnlockablesViewController : UIViewController <UITableViewDataSource, UITableViewDelegate> {
