...
@class UIImageView, UIColor, UILabel, NSArray, NSMutableArray, UITableView, UIView, UIButton, NSString;

@interface CARAchievementsViewController : UIViewController <UITableViewDataSource, UITableViewDelegate> {
	...
	NSArray* _menuList;
	NSMutableArray* _newMenuList;
	NSArray* _unlockedAchievements;
