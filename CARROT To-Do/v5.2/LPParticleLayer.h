...
@interface LPParticleLayer : CALayer {
	...
	UIBezierPath* _particlePath;

}

@property (nonatomic,retain) UIBezierPath * particlePath;              //@synthesize particlePath=_particlePath - In the implementation block
-(void)setParticlePath:(UIBezierPath *)arg1 ;
-(UIBezierPath *)particlePath;
@end
