...
@class UIImageView, UIColor, UILabel, NSArray, NSDictionary, UIActivityIndicatorView, UITableView, UIView, UIButton, NSString;

@interface CARIconViewController : UIViewController <UITableViewDataSource, UITableViewDelegate> {
...
-(int)indexForDisplayingUnlockedIcons;
-(void)dealloc;
