...
@property (readonly) NSMutableDictionary * persistentPulseUrlsMap;                     //@synthesize persistentPulseUrlsMap=_persistentPulseUrlsMap - In the implementation block
@property (readonly) NSMutableDictionary * persistentPulsePrepUrlsMap;                 //@synthesize persistentPulsePrepUrlsMap=_persistentPulsePrepUrlsMap - In the implementation block
