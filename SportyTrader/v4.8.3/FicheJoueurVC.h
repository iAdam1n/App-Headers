...
@class UIActivityIndicatorView, DetailedPlayer_Football, NSArray, RequestAndTimerHolder, FicheJoueurContentVC, FicheJoueurBioVC, FicheJoueurStatsVC, UIScrollView, UIView, UIImageView, UILabel, NSLayoutConstraint, UISegmentedControl;

@interface FicheJoueurVC : BaseContentViewController {

	unsigned short _selectedTabIdentifier;
	UIActivityIndicatorView* _activityIndicator;
	long long _defaultTournamentID;
	long long _currentTournamentID;
	DetailedPlayer_Football* _player;
	NSArray* _tabArray;
	RequestAndTimerHolder* _requestHolder;
	FicheJoueurContentVC* _selectedSubviewController;
	FicheJoueurBioVC* _bioViewController;
	FicheJoueurStatsVC* _statsViewController;
	UIScrollView* _mainScrollView;
	UIView* _playerHeaderView;
	UIView* _colorFilterView;
	UIImageView* _portraitImageView;
	UILabel* _playerNameLabel;
	UILabel* _playerPositionLabel;
	UIImageView* _teamLogoImageView;
	NSLayoutConstraint* _teamLogoWidthConstraint;
	UILabel* _teamNameLabel;
	UIImageView* _shirtImageView;
	UILabel* _shirtNumberLabel;
...
@property (nonatomic,retain) FicheJoueurContentVC * selectedSubviewController;                       //@synthesize selectedSubviewController=_selectedSubviewController - In the implementation block
@property (nonatomic,retain) FicheJoueurBioVC * bioViewController;                                   //@synthesize bioViewController=_bioViewController - In the implementation block
@property (nonatomic,retain) FicheJoueurStatsVC * statsViewController;                               //@synthesize statsViewController=_statsViewController - In the implementation block
...
@property (nonatomic,retain) UIView * playerHeaderView;                                              //@synthesize playerHeaderView=_playerHeaderView - In the implementation block
...
@property (nonatomic,retain) UILabel * playerPositionLabel;                                          //@synthesize playerPositionLabel=_playerPositionLabel - In the implementation block
@property (nonatomic,retain) UIImageView * teamLogoImageView;                                        //@synthesize teamLogoImageView=_teamLogoImageView - In the implementation block
@property (nonatomic,retain) NSLayoutConstraint * teamLogoWidthConstraint;                           //@synthesize teamLogoWidthConstraint=_teamLogoWidthConstraint - In the implementation block
@property (nonatomic,retain) UILabel * teamNameLabel;                                                //@synthesize teamNameLabel=_teamNameLabel - In the implementation block
@property (nonatomic,retain) UIImageView * shirtImageView;                                           //@synthesize shirtImageView=_shirtImageView - In the implementation block
@property (nonatomic,retain) UILabel * shirtNumberLabel;                                             //@synthesize shirtNumberLabel=_shirtNumberLabel - In the implementation block
...
@property (nonatomic,retain) DetailedPlayer_Football * player;                                       //@synthesize player=_player - In the implementation block
@property (nonatomic,retain) NSArray * tabArray;                                                     //@synthesize tabArray=_tabArray - In the implementation block
-(UIView *)playerHeaderView;
...
-(UILabel *)playerPositionLabel;
-(UILabel *)teamNameLabel;
-(UILabel *)shirtNumberLabel;
-(UIImageView *)teamLogoImageView;
-(void)updateTeamLogoConstraint;
-(NSLayoutConstraint *)teamLogoWidthConstraint;
-(UIImageView *)shirtImageView;
-(void)setupTimer;
-(unsigned short)selectedTabIdentifier;
-(FicheJoueurContentVC *)selectedSubviewController;
...
-(void)setSelectedSubviewController:(FicheJoueurContentVC *)arg1 ;
-(UIView *)tabContainerView;
-(NSLayoutConstraint *)contentContainerViewHeightConstraint;
-(FicheJoueurBioVC *)bioViewController;
-(void)setBioViewController:(FicheJoueurBioVC *)arg1 ;
-(FicheJoueurStatsVC *)statsViewController;
-(void)setStatsViewController:(FicheJoueurStatsVC *)arg1 ;
-(id)flurryTag;
...
-(void)setPlayerHeaderView:(UIView *)arg1 ;
-(void)setColorFilterView:(UIView *)arg1 ;
-(UIImageView *)portraitImageView;
-(void)setPortraitImageView:(UIImageView *)arg1 ;
-(void)setPlayerNameLabel:(UILabel *)arg1 ;
-(void)setPlayerPositionLabel:(UILabel *)arg1 ;
-(void)setTeamLogoImageView:(UIImageView *)arg1 ;
-(void)setTeamLogoWidthConstraint:(NSLayoutConstraint *)arg1 ;
-(void)setTeamNameLabel:(UILabel *)arg1 ;
-(void)setShirtImageView:(UIImageView *)arg1 ;
-(void)setShirtNumberLabel:(UILabel *)arg1 ;
...
-(void)setPlayer:(DetailedPlayer_Football *)arg1 ;
-(DetailedPlayer_Football *)player;
