...
@interface PronosticsPaysVC : PronosticsContentViewController {

	UIView* noMatchsView;
	UIImageView* noMatchsImageView;
	UILabel* noMatchsLabel;
	UILabel* headerPronosLabel;
	NSArray* countryList;
	BOOL isRefreshing;
...
@property (nonatomic,retain) UILabel * headerPronosLabel; 
...
-(UILabel *)headerPronosLabel;
-(id)URLStringForFullRequestWithDateMatchs:(id)arg1 ;
-(void)setHeaderPronosLabel:(UILabel *)arg1 ;
