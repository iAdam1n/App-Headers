...
@class UIAlertView, NSDictionary, UIView, NSString, NSMutableArray, FlurryAdFrame, FlurryVideoPlayer, FlurryAdNetworkBasePlugin, UIActivityIndicatorView, UITextView, UIViewController, FlurryAdViewState, FlurryAdWebViewLoader, NSTimer, NSURL, FlurryCachedAsset, FlurryAdManager, UIWebView;
...
@interface FlurryAd : UIView <SKStoreProductViewControllerDelegate, IFlurryAdNetworkConnector, IFlurryAdWebViewLoaderConnector, IFlurryAdVideoPlayerConnector, IFlurryEventControllerHandler, UIWebViewDelegate, FlurryActionDelegate, IFlurryAdViewabilityTrackerConnector, UIAlertViewDelegate> {
	...
	float _audioOnAndFullViewInMilliSecs;
...
@property (assign,nonatomic) float audioOnAndFullViewInMilliSecs;                        //@synthesize audioOnAndFullViewInMilliSecs=_audioOnAndFullViewInMilliSecs - In the implementation block
...
-(BOOL)isAudioOn;
-(float)audioOnAndFullViewInMilliSecs;
...
-(void)setAudioOnAndFullViewInMilliSecs:(float)arg1 ;
