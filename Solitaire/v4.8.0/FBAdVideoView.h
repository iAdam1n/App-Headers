...
@class FBAdVideoPlayerView, FBAdVideoPlayButton, FBAdVideoScrubber, UILabel, UITapGestureRecognizer, AVPlayerItem, NSMutableArray, NSURL, FBAdViewabilityValidator, FBGradientView, AVPlayer, NSString;
...
@interface FBAdVideoView : UIView <FBAdViewabilityValidatorDelegate, FBAdFullscreenVideoControllerDelegate, FBAdUpdatableView> {
	...
	SCD_Struct_Un22 _currentTime;
	SCD_Struct_Un22 _maximumSecondsWatched;
...
@property (assign,nonatomic) SCD_Struct_Un22 maximumSecondsWatched;                             //@synthesize maximumSecondsWatched=_maximumSecondsWatched - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_Un22 currentTime;                                       //@synthesize currentTime=_currentTime - In the implementation block
...
-(void)videoController:(id)arg1 periodicTimerTriggered:(SCD_Struct_Un22)arg2 ;
-(void)videoController:(id)arg1 videoTimeCheckTriggered:(SCD_Struct_Un22)arg2 ;
...
-(SCD_Struct_Un22)maximumSecondsWatched;
-(void)logVideoTime:(SCD_Struct_Un22)arg1 withInlineView:(BOOL)arg2 ;
-(void)checkIfVideoEnded;
-(void)updateMaximumWatched:(SCD_Struct_Un22)arg1 ;
...
-(void)setCurrentTimeWithoutSeeking:(SCD_Struct_Un22)arg1 ;
-(void)addTimingObserver:(/*^block*/id)arg1 ;
-(void)setPlayCheck:(id)arg1 ;
-(void)setTimeCheck:(id)arg1 ;
-(BOOL)videoShownToUser;
-(void)setMaximumSecondsWatched:(SCD_Struct_Un22)arg1 ;
-(void)setTimeCheckSent:(BOOL)arg1 ;
-(void)setVideoCurrentlyShownToUser:(BOOL)arg1 ;
-(void)logVideoTime:(SCD_Struct_Un22)arg1 withInlineView:(BOOL)arg2 overrideLimit:(BOOL)arg3 ;
-(id)timeCheck;
-(BOOL)timeCheckSent;
