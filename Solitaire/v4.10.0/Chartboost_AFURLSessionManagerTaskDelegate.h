...
@class Chartboost_AFURLSessionManager, NSMutableData, NSProgress, NSURL, NSString;

@interface Chartboost_AFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate> {

	Chartboost_AFURLSessionManager* _manager;
...
@property (assign,nonatomic,__weak) Chartboost_AFURLSessionManager * manager;              //@synthesize manager=_manager - In the implementation block
...
-(Chartboost_AFURLSessionManager *)manager;
-(void)setManager:(Chartboost_AFURLSessionManager *)arg1 ;
@end
