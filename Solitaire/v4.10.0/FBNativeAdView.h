...
@class NSArray, UIViewController, FBNativeAd, FBNativeAdViewAttributes, UIButton, UILabel, UIImageView, FBMediaView, FBAdChoicesView, FBAdBodyView, UIView, NSHashTable, NSString;
