...
@property (nonatomic,readonly) long long attributionCorner;                             //@synthesize attributionCorner=_attributionCorner - In the implementation block
@property (nonatomic,copy) NSString * debugSignalInformation;                           //@synthesize debugSignalInformation=_debugSignalInformation - In the implementation block
...
-(void)setDebugSignalInformation:(NSString *)arg1 ;
...
-(NSString *)debugSignalInformation;
