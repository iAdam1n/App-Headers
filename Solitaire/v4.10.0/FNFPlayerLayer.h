...
#import <SolitaireFree/FNFDecompressionSessionDelegate.h>
#import <SolitaireFree/FNFPlayerDisplayEngine.h>
#import <SolitaireFree/FNFAVPlayerLayer.h>
...
@interface FNFPlayerLayer : CAEAGLLayer <FNFDecompressionSessionDelegate, FNFPlayerDisplayEngine, FNFAVPlayerLayer> {
	...
	SCD_Struct_AS22 _bufferTimes[60];
...
-(void)_addBuffer:(CVBufferRef)arg1 presentationTimeStamp:(SCD_Struct_AS22)arg2 iFrameEnqueued:(unsigned long long)arg3 ;
-(void)display:(CVBufferRef)arg1 presentationTimeStamp:(SCD_Struct_AS22)arg2 presentationDuration:(SCD_Struct_AS22)arg3 iFrameEnqueued:(unsigned long long)arg4 ;
...
-(id)initWithConfigs:(SCD_Struct_FN118)arg1 ;
