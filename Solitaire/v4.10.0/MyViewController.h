...
#import <SolitaireFree/MWSTrackProviderTreasureDataDelegate.h>
...
#import <SolitaireFree/SFLNativeAdManagerDelegate.h>
...
#import <SolitaireFree/SFLActionSheetDelegate.h>
...
@interface MyViewController : UIViewController <MWSTrackProviderInitializationDelegate, SolitaireTrackConfigurationDelegate, MWSTrackDelegate, AdControlEventLoggingDelegate, MWSTrackProviderTreasureDataDelegate, SolitaireEventHandlerDelegate, UIGestureRecognizerDelegate, SFLApplicationShortcutItemManagerDataSource, SFLNativeAdManagerDelegate, UITextViewDelegate, UIActionSheetDelegate, UIWebViewDelegate, GameCenterController, UIAlertViewDelegate, DailyDelegate, ProgressPanelDelegate, ToastDelegate, GameCenterViewDelegate, SFLActionSheetDelegate, AdParams2Delegate, MWAdControlDelegate, MWInternalAdDelegate, LanguageDelegate, UIPopoverPresentationControllerDelegate, SFLMessageBoxDelegate, UIPopoverPresentationControllerDelegate> {
	...
	unsigned char requestLikeUsOnFacebook;
	...
	BOOL _swipeToToggleEnabled;
	BOOL _emphasizedAutoHint;
	BOOL _showingEmailViewController;
	...
	BOOL _nativeAdsEnabled;
	BOOL _nativeAdDidDisplay;
	BOOL _nativeAdDidHaveError;
	BOOL _lastGameWasShowMeHowToWin;
	BOOL _lastGameWasDebugWon;
	BOOL _adParamsCrossPromoInitialized;
	BOOL _webViewDismissing;
	...
	NSString* _crossPromotionTrayLastViewedID;
	NSString* _crossPromotionTrayBadgeShowID;
	...
	SolitaireTrackConfiguration* _trackConfiguration;
	...
	MWFlatButton* _webviewBackButton;
	MWFlatButton* _webviewForwardButton;
	MWFlatButton* _webviewHomeButton;
	MWFlatButton* _webviewRefreshButton;
	SolitaireMessageBox* _vegasCumulativeScoreMessageBox;
	UIAlertView* _draw3AlertView;
	SFLActionSheet* _playMenu;
	SFLNativeAdManager* _nativeAdManager;
	unsigned long long _nativeAdNoAdReasonsThisAd;
	unsigned long long _nativeAdNotRequestedReasonsThisAd;
...
@property (nonatomic,retain) MWFlatButton * webviewBackButton;                                             //@synthesize webviewBackButton=_webviewBackButton - In the implementation block
@property (nonatomic,retain) MWFlatButton * webviewForwardButton;                                          //@synthesize webviewForwardButton=_webviewForwardButton - In the implementation block
@property (nonatomic,retain) MWFlatButton * webviewHomeButton;                                             //@synthesize webviewHomeButton=_webviewHomeButton - In the implementation block
@property (nonatomic,retain) MWFlatButton * webviewRefreshButton;                                          //@synthesize webviewRefreshButton=_webviewRefreshButton - In the implementation block
@property (nonatomic,retain) SolitaireMessageBox * vegasCumulativeScoreMessageBox;                         //@synthesize vegasCumulativeScoreMessageBox=_vegasCumulativeScoreMessageBox - In the implementation block
@property (nonatomic,retain) UIAlertView * draw3AlertView;                                                 //@synthesize draw3AlertView=_draw3AlertView - In the implementation block
@property (assign,nonatomic,__weak) SFLActionSheet * playMenu;                                             //@synthesize playMenu=_playMenu - In the implementation block
@property (assign,nonatomic) BOOL nativeAdsEnabled;                                                        //@synthesize nativeAdsEnabled=_nativeAdsEnabled - In the implementation block
@property (nonatomic,retain) SFLNativeAdManager * nativeAdManager;                                         //@synthesize nativeAdManager=_nativeAdManager - In the implementation block
@property (assign,nonatomic) unsigned long long nativeAdNoAdReasonsThisAd;                                 //@synthesize nativeAdNoAdReasonsThisAd=_nativeAdNoAdReasonsThisAd - In the implementation block
@property (assign,nonatomic) unsigned long long nativeAdNotRequestedReasonsThisAd;                         //@synthesize nativeAdNotRequestedReasonsThisAd=_nativeAdNotRequestedReasonsThisAd - In the implementation block
@property (assign,nonatomic) BOOL nativeAdDidDisplay;                                                      //@synthesize nativeAdDidDisplay=_nativeAdDidDisplay - In the implementation block
@property (assign,nonatomic) BOOL nativeAdDidHaveError;                                                    //@synthesize nativeAdDidHaveError=_nativeAdDidHaveError - In the implementation block
@property (assign,nonatomic) BOOL lastGameWasShowMeHowToWin;                                               //@synthesize lastGameWasShowMeHowToWin=_lastGameWasShowMeHowToWin - In the implementation block
@property (assign,nonatomic) BOOL lastGameWasDebugWon;                                                     //@synthesize lastGameWasDebugWon=_lastGameWasDebugWon - In the implementation block
...
@property (assign,nonatomic) BOOL webViewDismissing;                                                       //@synthesize webViewDismissing=_webViewDismissing - In the implementation block
...
@property (assign) unsigned char requestLikeUsOnFacebook; 
...
@property (nonatomic,retain) NSString * crossPromotionTrayLastViewedID;                                    //@synthesize crossPromotionTrayLastViewedID=_crossPromotionTrayLastViewedID - In the implementation block
@property (nonatomic,retain) NSString * crossPromotionTrayBadgeShowID;                                     //@synthesize crossPromotionTrayBadgeShowID=_crossPromotionTrayBadgeShowID - In the implementation block
...
@property (assign,nonatomic) BOOL swipeToToggleEnabled;                                                    //@synthesize swipeToToggleEnabled=_swipeToToggleEnabled - In the implementation block
...
@property (nonatomic,readonly) DailyView * dailyView; 
@property (assign,nonatomic) BOOL showingEmailViewController;                                              //@synthesize showingEmailViewController=_showingEmailViewController - In the implementation block
@property (nonatomic,retain) SolitaireTrackConfiguration * trackConfiguration;                             //@synthesize trackConfiguration=_trackConfiguration - In the implementation block
...
-(void)setTrackConfiguration:(SolitaireTrackConfiguration *)arg1 ;
...
-(void)toggleToolBar;
-(void)moveControls;
-(void)whatsNewDone:(int)arg1 andReturnToSettings:(BOOL)arg2 ;
...
-(void)updateSplashScreen:(long long)arg1 animated:(BOOL)arg2 ;
-(MyView *)mview;
...
-(void)dealRandomDeal;
-(void)dealWinningDeal;
-(void)showDailyView;
-(void)dealMultiplayer;
-(SFLNativeAdManager *)nativeAdManager;
-(void)logNativeAdNoAd:(unsigned long long)arg1 ;
-(void)setPlayMenu:(SFLActionSheet *)arg1 ;
...
-(void)setDraw3AlertView:(UIAlertView *)arg1 ;
...
-(BOOL)showingEmailViewController;
...
-(BOOL)lastGameWasShowMeHowToWin;
-(void)setLastGameWasShowMeHowToWin:(BOOL)arg1 ;
-(BOOL)lastGameWasDebugWon;
-(void)clearNativeAdIfNeeded;
-(void)setLastGameWasDebugWon:(BOOL)arg1 ;
...
-(void)setLastDailyChallengeDate;
-(void)startAutoComplete;
-(void)forfeitGame;
-(void)disconnectGame;
-(MWFlatButton *)webviewBackButton;
-(MWFlatButton *)webviewForwardButton;
-(void)setShowingEmailViewController:(BOOL)arg1 ;
-(void)updateUIToolbarBadges;
...
-(void)completeAction;
-(void)setCrossPromotionTrayLastViewedID:(NSString *)arg1 ;
-(NSString *)crossPromotionTrayLastViewedID;
-(NSString *)crossPromotionTrayBadgeShowID;
-(void)crossPromotionTrayButtonPressed:(id)arg1 ;
-(int)getScoreType;
-(void)setDontShowCongratulations:(unsigned char)arg1 ;
-(void)hideConfig;
-(void)whatsNew;
-(void)setWebViewDismissing:(BOOL)arg1 ;
-(void)webViewWasDismissed;
-(void)setWebviewBackButton:(MWFlatButton *)arg1 ;
-(void)webviewBackButtonAction:(id)arg1 ;
-(void)setWebviewForwardButton:(MWFlatButton *)arg1 ;
-(void)webviewForwardButtonAction:(id)arg1 ;
-(void)webDoneAction:(id)arg1 ;
-(void)showAccessibilityConflictMessage:(id)arg1 ;
...
-(UIAlertView *)draw3AlertView;
-(SolitaireMessageBox *)vegasCumulativeScoreMessageBox;
-(void)setVegasCumulativeScoreMessageBox:(SolitaireMessageBox *)arg1 ;
-(void)saveAccessibilityOptions;
...
-(void)getImageIndicesForEventPeriod:(id)arg1 backgroundIndex:(int*)arg2 cardBackIndex:(int*)arg3 ;
-(void)setCurrentEventPeriod:(SFLEventPeriod *)arg1 ;
-(BOOL)wasThemeSetManually:(id)arg1 ;
-(void)showEventMessageBox:(id)arg1 date:(id)arg2 ;
-(SFLEventPeriod *)currentEventPeriod;
-(void)enqueueMessageBoxDisplay:(id)arg1 ;
-(void)eventHandlerShowPreviewScreen:(id)arg1 eventPeriod:(id)arg2 fromIAM:(BOOL)arg3 ;
...
-(void)setNativeAdsEnabled:(BOOL)arg1 ;
-(void)setNativeAdManager:(SFLNativeAdManager *)arg1 ;
-(BOOL)nativeAdDidDisplay;
-(BOOL)nativeAdDidHaveError;
-(void)setNativeAdDidDisplay:(BOOL)arg1 ;
-(void)setNativeAdDidHaveError:(BOOL)arg1 ;
-(void)setNativeAdNoAdReasonsThisAd:(unsigned long long)arg1 ;
-(void)setNativeAdNotRequestedReasonsThisAd:(unsigned long long)arg1 ;
-(unsigned long long)nativeAdNoAdReasonsThisAd;
-(unsigned long long)nativeAdNotRequestedReasonsThisAd;
-(void)logNativeAdNotRquested:(unsigned long long)arg1 ;
-(id)requiredShortcutsForApplicationShortcutItemManager:(id)arg1 ;
-(BOOL)nativeAdManagerShouldLoadAd:(id)arg1 ;
-(void)nativeAdManagerDidStartLoadingAd:(id)arg1 ;
-(void)nativeAdManagerDidLoadAd:(id)arg1 ;
-(void)nativeAdManagerIncompleteAd:(id)arg1 ;
-(void)nativeAdManager:(id)arg1 didFailWithError:(id)arg2 ;
-(void)nativeAdManagerDidClick:(id)arg1 ;
-(void)nativeAdManagerDidReceiveImpression:(id)arg1 ;
-(void)optInDismissed;
...
-(BOOL)sfl_actionSheetShouldShowHeader;
-(void)sfl_actionSheet:(id)arg1 repositionPopoverToRect:(CGRect*)arg2 ;
-(void)adDismissed;
...
-(void)SwipeToToggleToolbarCtlAction:(id)arg1 ;
...
-(BOOL)isCard:(id)arg1 ;
-(void)facebookAction:(id)arg1 ;
-(id)getRankingBadgeImage;
-(id)getCongratsCrossPromotionItem;
-(void)previewCurrentTheme;
-(id)lastDailyChallengeDate;
-(unsigned char)bToolbarVisible;
-(unsigned char)undoShowing;
-(WinGame *)winGame;
...
-(unsigned char)requestLikeUsOnFacebook;
-(void)setRequestLikeUsOnFacebook:(unsigned char)arg1 ;
-(unsigned char)noAd;
-(unsigned char)dontShowCongrats;
-(int)gameTicks;
-(UILabel *)yourHand;
...
-(void)setCrossPromotionTrayBadgeShowID:(NSString *)arg1 ;
...
-(SolitaireTrackConfiguration *)trackConfiguration;
-(MWFlatButton *)webviewHomeButton;
-(void)setWebviewHomeButton:(MWFlatButton *)arg1 ;
-(MWFlatButton *)webviewRefreshButton;
-(void)setWebviewRefreshButton:(MWFlatButton *)arg1 ;
-(BOOL)adParamsCrossPromoInitialized;
-(void)setAdParamsCrossPromoInitialized:(BOOL)arg1 ;
-(BOOL)webViewDismissing;
-(void)logEvent:(id)arg1 withParameters:(id)arg2 ;
-(id)playerDataForTreasureData;
-(void)autoDealNewGame;
-(void)trackInitialized;
-(void)providerInitializationComplete:(id)arg1 ;
-(void)sendSettingsEvents;
-(void)setupLeanplumCrossPromo;
-(id)userConfigForTreasureData;
-(void)startGameMode;
...
-(id)userConfigForDestination:(unsigned long long)arg1 ;
-(void)adClick:(id)arg1 adNet:(id)arg2 placement:(id)arg3 ;
-(void)logAdData:(id)arg1 ;
