...
@protocol FBFacebookRequestSender, FBDeltaSyncOperationDelegate;
...
@property (assign,nonatomic) id<FBDeltaSyncOperationDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
