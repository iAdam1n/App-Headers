...
@property (nonatomic,copy,readonly) FBMSingleThreadSummaryRequestFilter * filter;              //@synthesize filter=_filter - In the implementation block
...
-(FBMSingleThreadSummaryRequestFilter *)filter;
-(id)progressBlock;
@end
