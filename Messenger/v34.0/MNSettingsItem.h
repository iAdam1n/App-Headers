...
-(id)initWithTitle:(id)arg1 subtitle:(id)arg2 iconName:(id)arg3 identifier:(long long)arg4 accessibilityIdentifier:(id)arg5 isOn:(BOOL)arg6 enabled:(BOOL)arg7 settingsItemType:(unsigned long long)arg8 ;
