...
@property (nonatomic,copy,readonly) NSDictionary * singleRecipientToErrorMap;              //@synthesize singleRecipientToErrorMap=_singleRecipientToErrorMap - In the implementation block
-(NSString *)batchId;
...
-(NSDictionary *)singleRecipientToErrorMap;
@end
