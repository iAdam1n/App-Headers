...
@property (nonatomic,retain) ACAccount * fbAccount;                                         //@synthesize fbAccount=_fbAccount - In the implementation block
@property (nonatomic,retain,readonly) ACAccountType * fbAccountType;                        //@synthesize fbAccountType=_fbAccountType - In the implementation block
-(void)startObservingSSOAvailability;
-(void)_accountStoreChanged:(id)arg1 ;
-(void)_determineSSOLoginAvailabilityForDelegate;
-(void)setFbAccount:(ACAccount *)arg1 ;
-(ACAccount *)fbAccount;
