...
@protocol FBProvider;
@class MNMediaCollectionViewController, FBUserSession, FBMPhotoViewImageDownloadController, MNPhotoImageRequester, MNPlatformAppActionFactory, MNPlatformAppActionHandler, MNComposerIconColourExperimentContext, NSString;
