...
@class UIButton, UILabel, FBMemCreditCard;
...
@property (nonatomic,retain) FBMemCreditCard * card;                                                         //@synthesize card=_card - In the implementation block
...
-(void)setCard:(FBMemCreditCard *)arg1 ;
