...
@property (nonatomic,copy) NSString * legacyApiPostId;               //@synthesize legacyApiPostId=_legacyApiPostId - In the implementation block
...
-(void)setLegacyApiPostId:(NSString *)arg1 ;
-(NSString *)placeId;
