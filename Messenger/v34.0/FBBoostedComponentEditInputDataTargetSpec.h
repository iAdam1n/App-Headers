...
@class NSString, NSArray, NSNumber, FBBoostedComponentEditInputDataTargetSpecGeoLocations;
...
@property (nonatomic,copy) FBBoostedComponentEditInputDataTargetSpecGeoLocations * geoLocations;              //@synthesize geoLocations=_geoLocations - In the implementation block
...
-(FBBoostedComponentEditInputDataTargetSpecGeoLocations *)geoLocations;
-(void)setGeoLocations:(FBBoostedComponentEditInputDataTargetSpecGeoLocations *)arg1 ;
-(NSArray *)interestIds;
