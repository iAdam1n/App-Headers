...
@class FBUserSession, UIAlertView, FBSettingsSearchResultActionsController, UISearchDisplayController, FBSettingsSchema, FBSettingsButtonActionController, UITextField, FBSettingsSchemaItemMultiValue, FBSettingsSearchIndex, NSString;
...
@property (nonatomic,retain) FBSettingsButtonActionController * buttonActionController;                          //@synthesize buttonActionController=_buttonActionController - In the implementation block
...
-(BOOL)enableSearch;
-(FBSettingsButtonActionController *)buttonActionController;
-(void)setButtonActionController:(FBSettingsButtonActionController *)arg1 ;
