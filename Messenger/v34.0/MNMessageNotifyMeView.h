...
@class FBNetworkImageView, UIView, MNCommerceItemView, MNBusinessNavigationHandler, MNMessageNotifyMeViewModel, NSString;
...
@property (nonatomic,copy) MNMessageNotifyMeViewModel * viewModel;                                //@synthesize viewModel=_viewModel - In the implementation block
@property (readonly) unsigned long long hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
+(CGSize)sizeThatFits:(CGSize)arg1 withViewModel:(id)arg2 ;
-(void)setViewModel:(MNMessageNotifyMeViewModel *)arg1 ;
-(id)initWithFrame:(CGRect)arg1 imageDownloader:(id)arg2 ;
-(MNBusinessNavigationHandler *)navigationHandler;
-(MNMessageNotifyMeViewModel *)viewModel;
