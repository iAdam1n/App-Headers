...
@protocol MNAuthenticationManager, FBMThreadDeleterDelegate;
@class FBUserSession, FBMDetchedNetworkRequestsQueue, MNMessagingRegionHeaderHelper, FBMThreadSummary, FBSimpleNetworkerRequest, NSString;
