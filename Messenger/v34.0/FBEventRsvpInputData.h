...
@class NSString, NSArray, FBEventRsvpInputDataContext;
...
@property (nonatomic,copy) FBEventRsvpInputDataContext * context;              //@synthesize context=_context - In the implementation block
...
-(FBEventRsvpInputDataContext *)context;
-(void)setContext:(FBEventRsvpInputDataContext *)arg1 ;
