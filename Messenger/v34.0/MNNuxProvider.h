...
@class MNPushInstructionsController, MNQuickPromotionThreadListQPPresenter, MNQuickPromotionThreadViewQPPresenter, FBUserSession, MNQuickPromotionInterstitialDataSource, MNContactSyncPrimerDialogNagController, MNContactSyncInstructionsNagController, NSString;
