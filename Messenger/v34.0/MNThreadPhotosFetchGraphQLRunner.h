...
-(void)fetchPhotosOfThreadWithThreadKey:(id)arg1 afterCursor:(id)arg2 numPhotosToFetch:(unsigned long long)arg3 successBlock:(/*^block*/id)arg4 failureBlock:(/*^block*/id)arg5 ;
-(void)cancel;
-(void)dealloc;
@end
