...
@interface FBSampleBufferTranscodingHandler : NSObject <FBTranscodingHandler> {
	...
	SCD_Struct_FB242 _presentationTime;
...
@property (nonatomic,readonly) SCD_Struct_FB242 presentationTime;                           //@synthesize presentationTime=_presentationTime - In the implementation block
