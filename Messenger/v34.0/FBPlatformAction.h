...
@class FBExceptionHandler, NSString, UIImage, NSDictionary, FBUserSession, FBPlatformAppBridgeTypeToJSONConverter, NSMutableDictionary, NSURL;
...
@property (nonatomic,readonly) NSMutableDictionary * resultBridgeArguments;                                //@synthesize resultBridgeArguments=_resultBridgeArguments - In the implementation block
...
-(NSMutableDictionary *)resultBridgeArguments;
