...
@property (nonatomic,readonly) unsigned long long strategy;                                                  //@synthesize strategy=_strategy - In the implementation block
...
-(id)initWithStrategy:(unsigned long long)arg1 numberOfMessagesRequested:(unsigned long long)arg2 oldestMessageCursorDescriptor:(id)arg3 ;
