...
@class NSString, NSArray, FBEventEditInputDataContext, FBEventEditInputDataCoverPhotoInfo;
...
@property (nonatomic,copy) FBEventEditInputDataContext * context;                            //@synthesize context=_context - In the implementation block
...
@property (nonatomic,copy) FBEventEditInputDataCoverPhotoInfo * coverPhotoInfo;              //@synthesize coverPhotoInfo=_coverPhotoInfo - In the implementation block
...
-(FBEventEditInputDataCoverPhotoInfo *)coverPhotoInfo;
-(void)setCoverPhotoInfo:(FBEventEditInputDataCoverPhotoInfo *)arg1 ;
...
-(FBEventEditInputDataContext *)context;
-(void)setContext:(FBEventEditInputDataContext *)arg1 ;
-(NSString *)startTime;
-(NSString *)objectId;
