...
@class NSString, NSArray, NSNumber, FBBoostedComponentCreateInputDataTargetSpecGeoLocations;
...
@property (nonatomic,copy) FBBoostedComponentCreateInputDataTargetSpecGeoLocations * geoLocations;              //@synthesize geoLocations=_geoLocations - In the implementation block
...
-(FBBoostedComponentCreateInputDataTargetSpecGeoLocations *)geoLocations;
-(void)setGeoLocations:(FBBoostedComponentCreateInputDataTargetSpecGeoLocations *)arg1 ;
-(NSArray *)interestIds;
