...
@property (assign,nonatomic) id<GlobalMuterDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(void)cancel;
-(void)dealloc;
-(void)setDelegate:(id<GlobalMuterDelegate>)arg1 ;
-(id<GlobalMuterDelegate>)delegate;
-(void)start;
@end
