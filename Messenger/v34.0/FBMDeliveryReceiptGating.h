...
@interface FBMDeliveryReceiptGating : NSObject <FBSessionClassProvidable> {
	...
	unsigned long long _displayDeliveryReceiptWithNewUIState;
	unsigned long long _displayDeliveryReceiptWithNewUIStateInInbox;
	unsigned long long _sendDeliveryReceiptWithNewPayloadState;
