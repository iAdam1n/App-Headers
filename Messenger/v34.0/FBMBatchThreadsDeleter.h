...
@protocol MNAuthenticationManager, FBMBatchThreadsDeleterDelegate;
@class FBUserSession, FBMDetchedNetworkRequestsQueue, MNMessagingRegionHeaderHelper, NSMutableDictionary, NSArray, FBSimpleNetworkerRequest, NSString;
