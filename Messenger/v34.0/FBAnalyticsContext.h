...
@class NSString, NSMutableDictionary, NSMutableArray, NSObject, FBExceptionHandler, FBAnalyticsLoggingPolicy, NSArray, FBAnalyticsContextThriftLogger;
...
-(void)beginSession;
-(id)initWithConfiguration:(id)arg1 userFBID:(id)arg2 logDirectoryPath:(id)arg3 networkPriority:(unsigned long long)arg4 processingQueue:(id)arg5 batchLogCountThreshold:(unsigned long long)arg6 maxNetworkErrorRetryCount:(unsigned long long)arg7 channelDescription:(id)arg8 userDefaults:(id)arg9 ;
...
-(id)initWithConfiguration:(id)arg1 userFBID:(id)arg2 logDirectoryPath:(id)arg3 networkPriority:(unsigned long long)arg4 processingQueue:(id)arg5 batchLogCountThreshold:(unsigned long long)arg6 maxNetworkErrorRetryCount:(unsigned long long)arg7 channelDescription:(id)arg8 ;
