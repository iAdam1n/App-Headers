...
@protocol FBNetworkDispatch, MNNewUserRampUpThreadBumpRequestSenderDelegate;
...
@property (assign,nonatomic,__weak) id<MNNewUserRampUpThreadBumpRequestSenderDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(void)setDelegate:(id<MNNewUserRampUpThreadBumpRequestSenderDelegate>)arg1 ;
-(id<MNNewUserRampUpThreadBumpRequestSenderDelegate>)delegate;
-(void)_cleanup;
-(void)send;
@end
