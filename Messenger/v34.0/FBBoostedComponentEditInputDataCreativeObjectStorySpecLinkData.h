...
@class NSArray, NSString, FBBoostedComponentEditInputDataCreativeObjectStorySpecLinkDataCallToAction;
...
@property (nonatomic,copy) FBBoostedComponentEditInputDataCreativeObjectStorySpecLinkDataCallToAction * callToAction;              //@synthesize callToAction=_callToAction - In the implementation block
...
-(FBBoostedComponentEditInputDataCreativeObjectStorySpecLinkDataCallToAction *)callToAction;
-(void)setCallToAction:(FBBoostedComponentEditInputDataCreativeObjectStorySpecLinkDataCallToAction *)arg1 ;
