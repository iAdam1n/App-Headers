...
@property (nonatomic,copy,readonly) NSString * captionVisibility;              //@synthesize captionVisibility=_captionVisibility - In the implementation block
+(id)experimentName;
+(id)parameterConfigurations;
-(NSString *)captionVisibility;
