...
-(id)initWithSession:(id)arg1 titleSentence:(id)arg2 facepileImageURLs:(id)arg3 facepileItemSize:(unsigned long long)arg4 facepileItemStyle:(unsigned long long)arg5 ;
-(void)layoutSubviews;
