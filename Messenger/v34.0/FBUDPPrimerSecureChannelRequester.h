...
#import <Messenger/FBEncryptedChannelManagerSecureChannelRequesting.h>
...
-(void)requestSecureChannelWithCurrentChannelID:(id)arg1 completionBlock:(/*^block*/id)arg2 ;
