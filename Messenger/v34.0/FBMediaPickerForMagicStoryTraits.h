...
@interface FBMediaPickerForMagicStoryTraits : FBMediaPickerBaseTraits {
	...
	unsigned long long _maximumPhotosSelected;

}
+(id)traitsWithMaximumPhotosSelected:(unsigned long long)arg1 ;
...
-(id)initWithMaximumPhotosSelected:(unsigned long long)arg1 ;
-(BOOL)allowTagging;
