...
@class MNContactShareCardHeaderView, MNContactShareAttachmentViewModel, UITableView;

@interface MNContactShareCardView : UIView {

	MNContactShareCardHeaderView* _headerView;
	MNContactShareAttachmentViewModel* _contactAttachmentViewModel;
	UITableView* _tableView;

}

@property (nonatomic,readonly) MNContactShareCardHeaderView * headerView;                                        //@synthesize headerView=_headerView - In the implementation block
...
-(MNContactShareCardHeaderView *)headerView;
@end
