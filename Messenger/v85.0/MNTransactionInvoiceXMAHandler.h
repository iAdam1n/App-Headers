...
@class FBUserSession, MNBusinessPlugin, FBWebViewController, NSString;

@interface MNTransactionInvoiceXMAHandler : NSObject <MNInvoiceBankTransferViewControllerDelegate, MNInvoiceSummaryViewControllerrDelegate, FBViewerContextClassProvidable, MNTransactionInvoiceXMAHandling> {
