...
@property (nonatomic,readonly) SCD_Struct_AS378 constrainedSizeForCalculatedLayout; 
...
-(BOOL)shouldMeasureWithSizeRange:(SCD_Struct_AS378)arg1 ;
-(void)cancelLayoutTransitionsInProgress;
-(id)calculateLayoutThatFits:(SCD_Struct_AS378)arg1 ;
-(BOOL)usesImplicitHierarchyManagement;
-(void)_applyLayout:(id)arg1 layoutTransition:(id)arg2 ;
-(void)_completeLayoutCalculation;
-(BOOL)__shouldSize;
-(BOOL)_hasDirtyLayout;
-(void)transitionLayoutWithSizeRange:(SCD_Struct_AS378)arg1 animated:(BOOL)arg2 shouldMeasureAsync:(BOOL)arg3 measurementCompletion:(/*^block*/id)arg4 ;
...
-(id)layoutSpecThatFits:(SCD_Struct_AS378)arg1 ;
...
-(id)calculatedLayout;
-(SCD_Struct_AS378)constrainedSizeForCalculatedLayout;
