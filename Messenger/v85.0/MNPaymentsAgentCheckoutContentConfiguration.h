...
@class FBUserSession, FBPaymentsPaymentMethodsCoordinator, FBPaymentsPINController, FBPaymentsTouchIDController, MNAgentSuggestedItemCheckoutDataModel, NSString;
...
-(id)initWithSession:(id)arg1 agentCheckoutViewModel:(id)arg2 paymentMethodsCoordinator:(id)arg3 pinController:(id)arg4 touchIDController:(id)arg5 ;
@end
