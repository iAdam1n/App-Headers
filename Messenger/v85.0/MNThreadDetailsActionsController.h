...
@class MNThreadDetailsActionsControllerInjector, MNThreadMutePicker, MNThreadMembersUpdater, MNEphemeralMessageLifeTimePicker, MNNavigationBarController, MNThreadPhotosViewController, MNThreadPhotoEditController, MNThreadCustomizationModalPickerController, MNThreadEphemeralitySetter, MNThreadDetailsSecureCodenameEditController, MNSecureMessagingDeviceStatusOverrideAlertHandler, MNThreadDetailsViewController, MNThreadViewModel, FBMUser, MNProgressBarController, MNThreadDetailsContactViewController, MNThreadNicknameViewController, MNSecureMessagingIdentityKeyViewController, UIAlertView, UIActionSheet, NSString;

@interface MNThreadDetailsActionsController : NSObject <FBClassInjectable, MNThreadMutePickerDelegate, UIActionSheetDelegate, UIAlertViewDelegate, MNThreadMembersUpdaterDelegate, MNThreadPhotoEditControllerDelegate, MNThreadCustomizationModalPickerControllerDelegate, MNEphemeralMessageLifeTimePickerDelegate, MNThreadEphemeralitySetterDelegate, MNThreadPhotosViewControllerDelegate, MNThreadDetailsSecureCodenameEditControllerDelegate, MNThreadDetailsViewControllerDelegate, MNThreadDetailsContactViewControllerDelegate> {
