...
@interface FBOrientationState : NSObject <FBDeviceOrientationSensorDelegate> {
	...
	SCD_Struct_FB96 _preferredAnimationConfiguration;
...
@property (assign,nonatomic) SCD_Struct_FB93 preferredAnimationConfiguration;                          //@synthesize preferredAnimationConfiguration=_preferredAnimationConfiguration - In the implementation block
...
-(void)setPreferredAnimationConfiguration:(SCD_Struct_FB93)arg1 ;
...
-(void)_willBeginRotationToOrientation:(long long)arg1 fromOrientation:(long long)arg2 animationConfig:(SCD_Struct_FB93)arg3 ;
-(id)_orientationTransitionAnimationWithConfig:(SCD_Struct_FB93)arg1 ;
...
-(SCD_Struct_FB93)preferredAnimationConfiguration;
