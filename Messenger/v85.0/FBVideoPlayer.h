...
@property (assign,nonatomic) SCD_Struct_FB21 seekTime;                                   //@synthesize seekTime=_seekTime - In the implementation block
@property (nonatomic,retain) AVAsset * asset;                                            //@synthesize asset=_asset - In the implementation block
@property (nonatomic,readonly) double progress; 
@property (assign,nonatomic) SCD_Struct_FB21 startTime;                                  //@synthesize startTime=_startTime - In the implementation block
...
-(SCD_Struct_FB21)seekTime;
-(AVPlayer *)player;
-(void)setPlayerItem:(AVPlayerItem *)arg1 ;
-(void)setSeekTime:(SCD_Struct_FB21)arg1 ;
-(BOOL)isMuted;
