...
+(SCD_Struct_FB93)transitionAnimationConfiguration;
...
-(void)_finishTransitionForStoryBlock:(id)arg1 withTrackingVelocity:(CGPoint*)arg2 animation:(SCD_Struct_FB93)arg3 ;
...
-(SCD_Struct_FB93)_transitionAnimationConfigurationForStoryBlock:(id)arg1 withVelocity:(double)arg2 ;
...
-(void)performTransitionToPresentationAttributes:(id)arg1 onBlock:(id)arg2 animation:(SCD_Struct_FB93)arg3 ;
