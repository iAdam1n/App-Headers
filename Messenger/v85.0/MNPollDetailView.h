...
@class MNPollDetailTopBarView, UIView, MNLoadingView, MNButton, UITableView;

@interface MNPollDetailView : UIView {
...
-(id)initWithFrame:(CGRect)arg1 contentTableView:(id)arg2 ;
