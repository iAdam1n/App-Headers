...
@interface MNLinkPreviewingContext : FBValueObject <NSCopying> {
	...
	MNLinkPreviewingData* _linkPreviewingData;
...
@property (nonatomic,copy,readonly) MNLinkPreviewingData * linkPreviewingData;              //@synthesize linkPreviewingData=_linkPreviewingData - In the implementation block
...
-(MNLinkPreviewingData *)linkPreviewingData;
-(unsigned long long)defaultActionItemsFlag;
-(NSArray *)customActionItems;
-(id)initWithLinkPreviewingData:(id)arg1 defaultActionItemsFlag:(unsigned long long)arg2 customActionItems:(id)arg3 sourceRect:(CGRect)arg4 ;
-(CGRect)sourceRect;
@end
