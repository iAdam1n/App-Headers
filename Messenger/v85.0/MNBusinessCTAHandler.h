...
@class FBUserSession, MNBusinessCTALogger, MNBusinessCTALegacyRideSharingHandler, MNBusinessCTAPostbackHandler, MNBusinessCTAURLHandler, MNBusinessCTAAccountLinkHandler, MNBusinessCTAShareHandler, MNBusinessCTAManageMessagesHandler, MNAdsImpressionLogger, MNPageSubscriptionLogger, MNInstantArticleLogger, NSString;
