...
-(id)initWithAssetID:(id)arg1 dataSourceID:(id)arg2 indexHint:(unsigned long long)arg3 metadata:(id)arg4 mediaShareItemType:(unsigned long long)arg5 quality:(unsigned long long)arg6 creationDate:(id)arg7 isLivePhoto:(BOOL)arg8 livePhotoHasPlayed:(BOOL)arg9 sphericalParameters:(id)arg10 ;
