...
@class FBUserSession, FBPaymentsPaymentMethodsCoordinator, FBPaymentsPINController, FBPaymentsTouchIDController, FBPaymentsPaymentModulesOptionsDataController, NSString, MNPaymentsPagesCommerceCheckoutDataModel, MNPaymentsPagesCommercePaymentCardDataMutator, MNPaymentsPlatformContextBasedOrderStatusController;
...
@interface MNPaymentsPagesCommerceCheckoutContentConfiguration : NSObject <FBPaymentsCheckoutContentConfiguration> {
	...
	MNPaymentsPlatformContextBasedOrderStatusController* _platformContextBasedOrderStatusController;
...
-(id)initWithSession:(id)arg1 pinController:(id)arg2 touchIDController:(id)arg3 payableDataModel:(id)arg4 platformContextBasedOrderStatusController:(id)arg5 ;
