...
@class MNInvitesCooldownController, MNInvitesViewController, FBUserSession, MNInviteRequestController, MNInviteSenderAnalyticsLogger, MNInvitePeopleExperimentContext, MNInviteSenderConfiguration, MNInviteSenderListenerAnnouncer, NSString;
...
-(void)inviteConverastionContacts:(id)arg1 withMultiPicker:(BOOL)arg2 withSelectedInviteSegment:(unsigned long long)arg3 fromSource:(unsigned long long)arg4 ;
...
-(void)_inviteConversationContacts:(id)arg1 withMultiPicker:(BOOL)arg2 withSelectedInviteSegment:(unsigned long long)arg3 withInvitesViewControllerPresenter:(id)arg4 fromSource:(unsigned long long)arg5 ;
-(void)_presentInvitesViewControllerWithPickedContacts:(id)arg1 withSelectedInviteSegment:(unsigned long long)arg2 withInvitesViewControllerPresenter:(id)arg3 fromSource:(unsigned long long)arg4 ;
-(id)_invitesViewControllerConfigurationWithPickedContacts:(id)arg1 selectedInviteSegment:(unsigned long long)arg2 fromSource:(unsigned long long)arg3 ;
-(void)invitesViewControllerDidTapDismissButton:(id)arg1 ;
-(void)invitesViewController:(id)arg1 didSelectSuggestionsFilteringSegment:(unsigned long long)arg2 ;
