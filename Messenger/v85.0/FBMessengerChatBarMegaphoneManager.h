...
@property (nonatomic,readonly) id<FBMessengerChatBarMegaphoneController> visibleMegaphoneController;              //@synthesize visibleMegaphoneController=_visibleMegaphoneController - In the implementation block
