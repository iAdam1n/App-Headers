...
@interface MNStickerPreviewingContext : FBValueObject <NSCopying> {
	...
	MNStickerPreviewingData* _stickerPreviewingData;
...
@property (nonatomic,copy,readonly) MNStickerPreviewingData * stickerPreviewingData;              //@synthesize stickerPreviewingData=_stickerPreviewingData - In the implementation block
...
-(id)initWithStickerPreviewingData:(id)arg1 defaultActionItemsFlag:(unsigned long long)arg2 customActionItems:(id)arg3 sourceRect:(CGRect)arg4 ;
-(unsigned long long)defaultActionItemsFlag;
-(NSArray *)customActionItems;
-(MNStickerPreviewingData *)stickerPreviewingData;
-(CGRect)sourceRect;
@end
