...
@class CKComponent, NSDictionary, FBInlineVoiceSwitcherViewModel, FBUFITheme, NSString, <FBDisplayableMediaViewProvider>, UIColor, UIImage, NSMutableDictionary, FBNativeArticleController, FBMemModelObject<FBQueriedNodeFieldsProtocol>, NSError, FBScenePath, NSArray, <FBWebImageViewLayoutDelegate>, FBDisplayableMediaViewProviderContext, CAMediaTimingFunction, FBVideoAssetEdits, FBVideoExportConfig, AVAssetReader, AVAssetTrack, AVAssetReaderOutput, AVAssetWriterInput, AVAssetWriter, NSURL, UIFont, FBImageDownloader, NSAttributedString, NSCharacterSet, <NSLayoutManagerDelegate>, FBWhistleAdaptor, <MNServiceControllable>, NSURLRequest, NSData, FBRtmpSession, FBAACEncoder, <FBVideoEncoder>, FBAACPacketizer, FBH264Packetizer, FBDiskVideoRecorder, CKComponentScopeRoot, <NSObject>, NSNumber;
...
typedef union GLKMatrix4 {
	SCD_Struct_FB18 field1;
	float m[16];
} GLKMatrix4;

typedef struct {
	SCD_Struct_FB17 field1;
	SCD_Struct_FB17 field2;
} SCD_Struct_FB20;
...
typedef struct {
	SCD_Struct_FB294 top;
	SCD_Struct_FB294 left;
	SCD_Struct_FB294 bottom;
	SCD_Struct_FB294 right;
} SCD_Struct_FB295;
...
typedef struct {
	SCD_Struct_AS376 field1;
	SCD_Struct_AS376 field2;
} SCD_Struct_AS377;
...
typedef union GLKVector3 {
	SCD_Struct_FB616 field1;
	SCD_Struct_FB616 field2;
	SCD_Struct_FB616 field3;
	float v[3];
} GLKVector3;
...
typedef struct {
	SCD_Struct_FB82 field1;
	compressed_pair<double *, std::__1::allocator<double> > field2;
	FBAudioStreamingConfig field3;
	FBAdaptiveBitrateConfig field4;
	FBVideoStreamingConfig field5;
	SCD_Struct_FB781 field6;
	4 field7;
	SCD_Struct_FB793 field8;
	BOOL field9;
	int field10;
	BOOL field11;
} SCD_Struct_FB838;
...
typedef struct {
	...
	SCD_Struct_FB21 field3;
	SCD_Struct_FB21 field4;
	double field5;
	double field6;
	unsigned long long field7;
	unsigned long long field8;
	SCD_Struct_FB21 field9;
...
typedef struct FNFPlayerState {
	...
	SCD_Struct_FB21 latestEnqueuedVideoPts;
	SCD_Struct_FB21 latestEnqueuedAudioPts;
	SCD_Struct_FB21 latestEnqueuedAudioDts;
	id playbackTimeObserverForAsset;
	id durationTimerForAsset;
	id stallTimerObserver;
	SCD_Struct_FB21 backgroundPauseTime;
