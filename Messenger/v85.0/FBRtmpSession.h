...
@interface FBRtmpSession : NSObject <NSStreamDelegate, FBRtmpSocketDelegate, FBVideoStreamingErrorProcessor> {
	...
	SCD_Struct_FB793 _networkConfig;
...
-(id)initWithURL:(id)arg1 base64ConnectionToken:(id)arg2 audioConfig:(FBAudioStreamingConfig)arg3 videoConfig:(FBVideoStreamingConfig)arg4 networkConfig:(SCD_Struct_FB793)arg5 disconnectWithoutSealing:(BOOL)arg6 sslFactory:(shared_ptr<facebook::livestreaming::RtmpSSLFactory>*)arg7 reachabilityAnnouncer:(shared_ptr<facebook::mobile::xplat::reachability::ReachabilityAnnouncer>*)arg8 bandwidthMonitor:(BandwidthMonitorRef)arg9 delegate:(id)arg10 ;
...
-(SCD_Struct_FB21)convertDeviceTimetampToStreamTimestamp:(SCD_Struct_FB21)arg1 ;
...
-(id)initWithURL:(id)arg1 base64ConnectionToken:(id)arg2 audioConfig:(FBAudioStreamingConfig)arg3 videoConfig:(FBVideoStreamingConfig)arg4 networkConfig:(SCD_Struct_FB793)arg5 sslFactory:(shared_ptr<facebook::livestreaming::RtmpSSLFactory>*)arg6 reachabilityAnnouncer:(shared_ptr<facebook::mobile::xplat::reachability::ReachabilityAnnouncer>*)arg7 bandwidthMonitor:(BandwidthMonitorRef)arg8 delegate:(id)arg9 ;
-(void)setBaseTimestamp:(SCD_Struct_FB21)arg1 ;
-(SCD_Struct_FB21)lastSentVideoPacketPts;
-(SCD_Struct_FB21)lastSentAudioPacketPts;
