...
@property (assign,nonatomic) SCD_Struct_FB23 timeRange;                                           //@synthesize timeRange=_timeRange - In the implementation block
...
-(SCD_Struct_FB21)_timeForFrameIndex:(unsigned long long)arg1 ;
...
-(void)setTimeRange:(SCD_Struct_FB23)arg1 ;
-(double)framerate;
