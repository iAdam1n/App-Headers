...
@interface FBVideoEditingViewController : UIViewController <FBVideoTrimViewDelegate, FBVideoEditingPlaybackViewDelegate, FBVideoVolumeControlViewDelegate, FBAudioSessionManagerClient, UIScrollViewDelegate, FBVideoCreativeToolsApplier, FBVideoFilterViewsUpdateProtocol> {
	...
	SCD_Struct_FB21 _videoMinLength;
	SCD_Struct_FB21 _videoMaxLength;
...
@property (assign,nonatomic) SCD_Struct_FB21 videoMinLength;                                                              //@synthesize videoMinLength=_videoMinLength - In the implementation block
@property (assign,nonatomic) SCD_Struct_FB21 videoMaxLength;                                                              //@synthesize videoMaxLength=_videoMaxLength - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_FB21 videoPosition; 
...
-(SCD_Struct_FB21)videoPosition;
-(void)setOverlayImageView:(UIImageView *)arg1 ;
-(void)updateFilterViews:(opaqueCMSampleBufferRef)arg1 ;
-(void)playbackView:(id)arg1 didPlayToTime:(SCD_Struct_FB21)arg2 ;
-(void)playbackViewDidFinishPlaying:(id)arg1 ;
-(void)trimViewDidBeginInteraction:(id)arg1 ;
-(id)initWithSession:(id)arg1 source:(id)arg2 externalSessionID:(id)arg3 profileVideoLogger:(id)arg4 bannerView:(id)arg5 style:(unsigned long long)arg6 enableColorFilter:(BOOL)arg7 enableStaticFilteredImage:(BOOL)arg8 enableFrameSelection:(BOOL)arg9 enableCropping:(BOOL)arg10 squareCrop:(BOOL)arg11 ;
...
-(id)filterView;
-(void)_trimValueChanged:(id)arg1 autoplay:(BOOL)arg2 fromScrubTime:(SCD_Struct_FB21)arg3 ;
...
-(void)_continuePlayingAfterUserInteractionFromScrubTime:(SCD_Struct_FB21)arg1 ;
