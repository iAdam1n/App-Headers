...
@class CALayer, NSMutableArray, FBSwipeableAnimationAsset;

@interface FBSwipeableFramesPageContentViewController : UIViewController <QuartzCorePlaceholderDelegate> {
