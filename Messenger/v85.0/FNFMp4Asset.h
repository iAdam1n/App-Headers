...
@class NSArray, NSError, NSObject, NSString, AVAudioMix;
...
-(void)_seekDataLoaderToTime:(SCD_Struct_FB21)arg1 offset:(unsigned long long)arg2 shouldUpdateOffset:(BOOL)arg3 track:(long long)arg4 ;
