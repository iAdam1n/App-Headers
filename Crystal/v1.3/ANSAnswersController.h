...
#import <Crystal/ANSUploaderDelegate.h>

@class NSOperationQueue, NSString, ANSMetadata, ANSCrashMetadata, ANSUploader, NSURL, FABCertificatePinner, ANSEventFilter, ANSSettings, ANSTimer, NSMutableDictionary;
