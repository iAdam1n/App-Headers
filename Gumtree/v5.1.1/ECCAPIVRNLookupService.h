...
#import <Gumtree/ECVRNLookupService.h>

@class ECAPIConfiguration, NSString;

@interface ECCAPIVRNLookupService : NSObject <ECVRNLookupService> {
...
-(void)fetchAttributesWithVRN:(id)arg1 categoryID:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
-(id)init;
@end
