...
@interface ECVerticalSlideTransition : NSObject <UIViewControllerAnimatedTransitioning> {
...
-(CGRect)rectForReplyPresentedState:(id)arg1 ;
-(CGRect)rectForReplyDismissedState:(id)arg1 ;
