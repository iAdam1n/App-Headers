...
@property (assign,nonatomic) BOOL isInstall;              //@synthesize isInstall=_isInstall - In the implementation block
@property (nonatomic,copy) id callback;                   //@synthesize callback=_callback - In the implementation block
-(id)initWithCallback:(/*^block*/id)arg1 isInstall:(BOOL)arg2 ;
-(id)getActionName;
-(BOOL)isInstall;
