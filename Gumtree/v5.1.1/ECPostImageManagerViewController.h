...
#import <Gumtree/EBKPHAssetsLibraryViewControllerDelegate.h>

@class ECPostDataProvider, ECPostImageManagerView, EBKImagePickerInternalData, ALAssetsLibrary, EBKImageService, NSString;

@interface ECPostImageManagerViewController : ECBaseViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate, EBKPHAssetsLibraryViewControllerDelegate> {
