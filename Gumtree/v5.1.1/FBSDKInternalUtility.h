...
+(BOOL)isOSRunTimeVersionAtLeast:(SCD_Struct_FB11)arg1 ;
...
+(long long)_compareOperatingSystemVersion:(SCD_Struct_FB11)arg1 toVersion:(SCD_Struct_FB11)arg2 ;
...
+(SCD_Struct_FB11)operatingSystemVersion;
