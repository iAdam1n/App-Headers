...
#import <Gumtree/GADMSlotDelegate.h>
#import <Gumtree/GADMConnectorDelegate.h>
...
-(void)adRequestReturnsFromConnector:(id)arg1 withForwardingNativeAppInstallAd:(id)arg2 ;
