...
@class ECItemListViewModel, ECIpadItemListView, ECIpadSearchResultCollectionViewAdapter, NSString;

@interface ECIpadWatchlistViewController : ECBaseViewController <ECItemListViewModelDelegate, UIViewControllerTransitioningDelegate> {
