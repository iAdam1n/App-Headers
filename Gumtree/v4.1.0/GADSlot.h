...
@protocol GADSlotDelegate, GADSlotAdEventDelegate, GADSlotAdResponseDelegate, GADSlotAdKeyDelegate;
@class GADMAdManager, GADMConfig, NSString, GADAd, GADAdType, GADRequest, NSNumber, GADAdView, GADSlotStatistics, GADIntermission, GADInterstitial, GADBannerAdViewDelegate, GADAdFetcher, NSDictionary, NSSet, NSTimer, GADActiveViewMonitor, GADSDKCoreWebView, UIView, GADPercentDrivenUserInteractionAnimationController, GADViewControllerFullScreenSwipeAnimation, SKStoreProductViewController, UIPanGestureRecognizer, GADScheduler;

@interface GADSlot : NSObject <GADMRAIDEventHandling, SKStoreProductViewControllerDelegate, GADSlotAdResponseDelegate, GADSDKCoreControllerDelegate, GADPercentDrivenUserInteractionAnimationControllerDelegate, GADActiveViewMonitorDelegate, GADAdViewActiveViewMonitoring, GADAdFetcherDelegate> {
