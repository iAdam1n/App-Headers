...
#import <Gumtree/GADAdViewActiveViewMonitoring.h>
#import <Gumtree/GADPercentDrivenUserInteractionAnimationControllerDelegate.h>
#import <Gumtree/GADSDKCoreControllerDelegate.h>
#import <Gumtree/SKStoreProductViewControllerDelegate.h>
#import <Gumtree/GADMRAIDEventHandling.h>

@protocol GADSlotDelegate, GADSlotAdEventDelegate, GADSlotAdResponseDelegate;
@class NSString, GADAd, GADAdType, GADRequest, NSNumber, GADAdView, GADSlotStatistics, GADIntermission, GADBannerAdViewDelegate, GADAdFetcher, NSDictionary, NSSet, NSTimer, GADInterstitial, GADMToGADGlue, GADActiveViewMonitor, GADSDKCoreWebView, UIView, GADPercentDrivenUserInteractionAnimationController, GADViewControllerFullScreenSwipeAnimation, SKStoreProductViewController, UIPanGestureRecognizer, GADScheduler;

@interface GADSlot : NSObject <GADSlotAdResponseDelegate, GADAdFetcherDelegate, GADActiveViewMonitorDelegate, GADAdViewActiveViewMonitoring, GADPercentDrivenUserInteractionAnimationControllerDelegate, GADSDKCoreControllerDelegate, SKStoreProductViewControllerDelegate, GADMRAIDEventHandling> {
