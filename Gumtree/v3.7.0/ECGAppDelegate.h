...
@class UIWindow, ECNotificationRegistrationManager, ECNotificationHandlingManager, UIViewController, ECHomeRootViewController, EMFModule, NSDictionary, ECDCSManager, Reachability, ECNotificationObserver, ECDeepLinkObject, NSArray, NSString;
