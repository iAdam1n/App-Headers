...
@class CRAppLocator, NSString, CRPreferences, CRDevice, CRExceptionHandler, CRCrashArchive, CRTransactionReporter, CRNetStatDispatch, CRNetCollector, CRAppRater, CRNetCrumbs, CRBreadcrumbs, CRNewBreadcrumbs, CRReachability, NSOperationQueue, CRThrottle, PLCrashReporter;
