...
@property (nonatomic,retain) id erroredState;              //@synthesize erroredState=_erroredState - In the implementation block
-(id)initWithConfiguration:(id)arg1 erroredState:(id)arg2 ;
-(void)setErroredState:(id)arg1 ;
-(id)erroredState;
-(id)execute;
@end
