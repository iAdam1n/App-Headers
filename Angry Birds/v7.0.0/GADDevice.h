...
@interface GADDevice : NSObject {
	...
	SCD_Struct_GA19 _operatingSystemVersion;
...
@property (nonatomic,readonly) SCD_Struct_GA19 operatingSystemVersion;                   //@synthesize operatingSystemVersion=_operatingSystemVersion - In the implementation block
