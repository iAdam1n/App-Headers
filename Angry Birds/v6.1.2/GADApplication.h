...
#import <AngryBirdsClassic/GADStatisticDictionaryDelegate.h>

@protocol NSObject, OS_dispatch_queue;
@class GADAd, GADContentQueue, GADScheduler, NSObject, NSArray, NSString, GADSession, GADStatisticDictionary, NSMutableSet, NSMutableDictionary;
