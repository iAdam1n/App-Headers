...
+(void)testShareContent:(id)arg1 containsMedia:(BOOL*)arg2 containsPhotos:(BOOL*)arg3 ;
...
+(void)_testObject:(id)arg1 containsMedia:(BOOL*)arg2 containsPhotos:(BOOL*)arg3 ;
+(void)_testOpenGraphValueContainer:(id)arg1 containsMedia:(BOOL*)arg2 containsPhotos:(BOOL*)arg3 ;
