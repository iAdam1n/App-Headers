...
@property (assign) long long requestID;                                                  //@synthesize requestID=_requestID - In the implementation block
...
-(BOOL)clearIfTracking:(long long)arg1 ;
-(void)timerDidFire;
-(BOOL)cancelIfTracking:(long long)arg1 ;
-(long long)requestID;
