...
@class ECBTweetsDataHubEntity;

@interface ECBTweetsDataHubOperation : OTHERDataHubOperation

@property (nonatomic,readonly) ECBTweetsDataHubEntity * tweetsEntity; 
-(ECBTweetsDataHubEntity *)tweetsEntity;
-(void)updateMatchWithTweets:(id)arg1 ;
-(void)main;
@end
