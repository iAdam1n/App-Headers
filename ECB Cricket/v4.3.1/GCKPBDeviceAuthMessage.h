...
@class GCKPBAuthChallenge, GCKPBAuthResponse, GCKPBAuthError;

@interface GCKPBDeviceAuthMessage : GCKPB_PBGeneratedMessage

@property (assign,nonatomic) BOOL hasChallenge; 
@property (nonatomic,retain) GCKPBAuthChallenge * challenge; 
@property (assign,nonatomic) BOOL hasResponse; 
@property (nonatomic,retain) GCKPBAuthResponse * response; 
@property (assign,nonatomic) BOOL hasError; 
@property (nonatomic,retain) GCKPBAuthError * error; 
+(id)descriptor;
@end
