...
@class ECBNewsDataHubEntity;

@interface ECBNewsDataHubOperation : OTHERDataHubOperation

@property (nonatomic,readonly) ECBNewsDataHubEntity * newsEntity; 
-(ECBNewsDataHubEntity *)newsEntity;
-(void)updateNews:(id)arg1 ;
-(void)updateStatus;
-(void)main;
@end
