...
@property (assign,nonatomic) long long findFriendsSource;                                               //@synthesize findFriendsSource=_findFriendsSource - In the implementation block
-(BOOL)disableNavigationGesture;
-(void)updateNavigationRightBarButtonItem;
-(void)authorizeAndFetchUsers;
-(void)selectNextButton;
-(long long)findFriendsSource;
-(void)setFindFriendsSource:(long long)arg1 ;
