...
@property (assign,getter=isEmptyQuery,nonatomic) BOOL emptyQuery;                                    //@synthesize emptyQuery=_emptyQuery - In the implementation block
...
-(void)beginFilteringUsersInSet:(long long)arg1 scope:(long long)arg2 query:(id)arg3 rankToken:(id)arg4 analyticsInfo:(id)arg5 ;
