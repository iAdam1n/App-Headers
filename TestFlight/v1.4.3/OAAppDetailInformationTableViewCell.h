...
@property (nonatomic,retain) UILabel * iMessageLabelLabel;                   //@synthesize iMessageLabelLabel=_iMessageLabelLabel - In the implementation block
...
@property (nonatomic,retain) UILabel * iMessageLabel;                        //@synthesize iMessageLabel=_iMessageLabel - In the implementation block
...
-(void)setIMessageLabelLabel:(UILabel *)arg1 ;
