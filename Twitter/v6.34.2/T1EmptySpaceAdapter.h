...
@interface T1EmptySpaceAdapter : TFNItemsDataViewAdapter {

	double _spaceHeight;

}

@property (assign,nonatomic) double spaceHeight;              //@synthesize spaceHeight=_spaceHeight - In the implementation block
...
-(void)setSpaceHeight:(double)arg1 ;
-(double)spaceHeight;
-(id)init;
@end
