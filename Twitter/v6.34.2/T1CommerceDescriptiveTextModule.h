...
@interface T1CommerceDescriptiveTextModule : TFNItemsDataViewAdapter <T1CommerceProfileModule> {
...
@property (nonatomic,retain) NSString * previewText;                                   //@synthesize previewText=_previewText - In the implementation block
