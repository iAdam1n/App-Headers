...
@interface T1NativeWebCardViewLayoutDelegate : TFNTwitterBaseCardViewLayoutDelegate <TFNTwitterBaseCardViewLayoutStateCreator>
...
-(id)_layoutHelperForViewModel:(id)arg1 traitCollection:(id)arg2 ;
-(id)init;
@end
