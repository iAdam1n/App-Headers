...
@interface TFSTwitterAPIAccountPushDestinationsRemoveRequest : TFSTwitterAPIEndpointRequest
+(id)endpointPath;
...
+(id)HTTPMethod;
-(id)initWithUDID:(id)arg1 environment:(id)arg2 screenName:(id)arg3 clientApplicationID:(id)arg4 ;
@end
