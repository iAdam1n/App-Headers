...
@property (nonatomic,readonly) long long messageError;                                                                       //@synthesize messageError=_messageError - In the implementation block
