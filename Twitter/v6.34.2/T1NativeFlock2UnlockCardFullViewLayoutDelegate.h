...
@interface T1NativeFlock2UnlockCardFullViewLayoutDelegate : TFNTwitterBaseCardViewLayoutDelegate <TFNTwitterBaseCardViewLayoutStateCreator>
...
-(double)_layoutAvatarAndName:(id)arg1 forNativeCardViewModel:(id)arg2 width:(double)arg3 atPoint:(CGPoint)arg4 ;
-(double)_layoutFlock2UnlockCard:(id)arg1 forNativeCardViewModel:(id)arg2 width:(double)arg3 atPoint:(CGPoint)arg4 ;
-(id)init;
@end
