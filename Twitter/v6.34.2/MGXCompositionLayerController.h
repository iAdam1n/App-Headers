...
@class MGXCompositionController;

@interface MGXCompositionLayerController : MGXLayerController {

	MGXCompositionController* _compositionController;

}

@property (retain) MGXCompositionController * compositionController;              //@synthesize compositionController=_compositionController - In the implementation block
-(void)setDebugRendering:(BOOL)arg1 ;
-(void)playAnimationFromTime:(double)arg1 toTime:(double)arg2 withDuration:(double)arg3 ;
-(id)initWithMotionGraphicsCompositionLayer:(id)arg1 ;
