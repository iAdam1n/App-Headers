...
#import <Twitter/TFNHTTPRequestRetryPolicyProvider.h>

@class NSString;

@interface TFNTwitterAPICardsPreviewHTTPRequestRetryPolicyProvider : NSObject <TFNHTTPRequestRetryPolicyProvider>
