...
@interface T1NativeProductPageCardViewLayoutDelegate : TFNTwitterBaseCardViewLayoutDelegate <TFNTwitterBaseCardViewLayoutStateCreator>
...
-(id)_fullLayoutForViewModel:(id)arg1 displayAreaWidth:(double)arg2 contentRect:(CGRect)arg3 ;
-(id)_forwardLayoutForViewModel:(id)arg1 displayAreaWidth:(double)arg2 contentRect:(CGRect)arg3 ;
-(id)init;
@end
