...
@interface TFNFormFieldAdapter : TFNItemsCollectionItemAdapter {
	...
	BOOL _requiredImmediateInput;

}

@property (assign,nonatomic) BOOL requiredImmediateInput;              //@synthesize requiredImmediateInput=_requiredImmediateInput - In the implementation block
...
-(id)_existingFormFieldCellInCollectionView:(id)arg1 forFormField:(id)arg2 ;
-(BOOL)requiredImmediateInput;
-(void)setRequiredImmediateInput:(BOOL)arg1 ;
@end
