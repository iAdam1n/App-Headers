...
@class TFNDirectMessageConversationImpl, NSArray;
...
@property (nonatomic,readonly) TFNDirectMessageConversationImpl * conversation;              //@synthesize conversation=_conversation - In the implementation block
