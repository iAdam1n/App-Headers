...
@interface TFSTwitterAPIJotClientEventRequest : TFSTwitterAPIEndpointRequest
+(id)endpointPath;
...
+(id)HTTPMethod;
-(id)initWithLog:(id)arg1 language:(id)arg2 eventParameters:(id)arg3 isCompressed:(BOOL)arg4 isDebug:(BOOL)arg5 ;
@end
