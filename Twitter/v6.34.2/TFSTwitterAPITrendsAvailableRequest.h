...
@interface TFSTwitterAPITrendsAvailableRequest : TFSTwitterAPIEndpointRequest
+(id)endpointPath;
+(unsigned long long)supportedAuthenticationTypes;
+(unsigned long long)responseHydrationFlags;
+(Class)responseModelBuilderClass;
-(id)initWithLanguageCode:(id)arg1 latitude:(id)arg2 longitude:(id)arg3 polling:(BOOL)arg4 ;
@end
