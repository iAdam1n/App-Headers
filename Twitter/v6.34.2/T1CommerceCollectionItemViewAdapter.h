...
@interface T1CommerceCollectionItemViewAdapter : TFNItemsDataViewAdapter
...
-(id)_identifierForStatus:(id)arg1 contentWidth:(double)arg2 ;
-(id)_createControllerForStatus:(id)arg1 account:(id)arg2 ;
@end
