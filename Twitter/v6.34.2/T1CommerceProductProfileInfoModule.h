...
@class TFNTwitterCommerceProductPage, NSString, TFNItemsDataViewAdapter, NSArray;

@interface T1CommerceProductProfileInfoModule : TFNBlockDataViewAdapter <T1CommerceProfileModule> {

	TFNTwitterCommerceProductPage* _productPage;

}

@property (nonatomic,readonly) TFNTwitterCommerceProductPage * productPage;              //@synthesize productPage=_productPage - In the implementation block
...
+(id)instanceWithProductPage:(id)arg1 ;
