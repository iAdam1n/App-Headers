...
@property (assign,nonatomic) BOOL useSizeThatFits;              //@synthesize useSizeThatFits=_useSizeThatFits - In the implementation block
...
-(void)setUseSizeThatFits:(BOOL)arg1 ;
...
-(CGSize)_sizeForButton:(id)arg1 constrainedToSize:(CGSize)arg2 withOptions:(id)arg3 defaultPadding:(UIEdgeInsets)arg4 ;
-(BOOL)useSizeThatFits;
@end
