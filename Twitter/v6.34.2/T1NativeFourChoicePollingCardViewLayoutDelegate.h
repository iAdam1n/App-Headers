...
@interface T1NativeFourChoicePollingCardViewLayoutDelegate : TFNTwitterBaseCardViewLayoutDelegate <TFNTwitterBaseCardViewLayoutStateCreator>
...
-(CGRect)_choiceImageFrameWithOrigin:(CGPoint)arg1 aspectRatio:(double)arg2 width:(double)arg3 ;
-(id)init;
@end
