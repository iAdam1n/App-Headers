...
@interface T1NativeBasicAppCardFullViewLayoutDelegate : NSObject <TFNTwitterCardViewLayoutDelegate>
...
-(double)_layoutImageAndInfoAndAction:(id)arg1 forNativeCardViewModel:(id)arg2 width:(double)arg3 atPoint:(CGPoint)arg4 ;
@end
