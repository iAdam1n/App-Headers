...
@interface TIPImageResponse : TNLResponse {
...
@property (nonatomic,readonly) NSString * lastModified;                      //@synthesize lastModified=_lastModified - In the implementation block
