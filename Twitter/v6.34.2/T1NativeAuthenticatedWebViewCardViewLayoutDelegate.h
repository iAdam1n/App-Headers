...
@class T1NativeAuthenticatedWebViewCardModel, NSString;

@interface T1NativeAuthenticatedWebViewCardViewLayoutDelegate : TFNTwitterBaseCardViewLayoutDelegate <TFNTwitterBaseCardViewLayoutStateCreator> {
