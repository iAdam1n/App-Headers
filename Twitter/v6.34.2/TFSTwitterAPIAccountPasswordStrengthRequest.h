...
@interface TFSTwitterAPIAccountPasswordStrengthRequest : TFSTwitterAPIEndpointRequest
+(id)endpointPath;
+(unsigned long long)supportedAuthenticationTypes;
+(unsigned long long)responseHydrationFlags;
+(Class)responseModelBuilderClass;
+(id)HTTPMethod;
-(id)initWithPassword:(id)arg1 name:(id)arg2 screenName:(id)arg3 email:(id)arg4 ;
@end
