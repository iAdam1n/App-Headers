...
@class TFNTwitterCardContext, T1NativeLeadGenCardForwardView, T1NativeLeadGenCardFullView, UIView;

@interface T1NativeLeadGenCardView : UIView <TFNTwitterCardView> {
