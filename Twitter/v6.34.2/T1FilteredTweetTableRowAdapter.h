...
@interface T1FilteredTweetTableRowAdapter : TFNItemsTableRowAdapter
...
-(void)didTapActiveRangeAtIndexPath:(id)arg1 fromController:(id)arg2 ;
-(void)_presentWebViewWithURLString:(id)arg1 fromController:(id)arg2 ;
@end
