...
@property (assign,nonatomic) unsigned lastGoodStreamId;              //@synthesize lastGoodStreamId=_lastGoodStreamId - In the implementation block
@property (assign,nonatomic) unsigned statusCode;                    //@synthesize statusCode=_statusCode - In the implementation block
-(unsigned)lastGoodStreamId;
-(void)setLastGoodStreamId:(unsigned)arg1 ;
-(unsigned)statusCode;
