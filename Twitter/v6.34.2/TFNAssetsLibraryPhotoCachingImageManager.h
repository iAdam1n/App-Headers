...
#import <Twitter/TFNPhotoCachingImageManager.h>

@class NSString;

@interface TFNAssetsLibraryPhotoCachingImageManager : TFNAssetsLibraryPhotoImageManager <TFNPhotoCachingImageManager> {
