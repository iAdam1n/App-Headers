...
@interface T1NativeBasicAppCardForwardViewLayoutDelegate : NSObject <TFNTwitterCardViewLayoutDelegate>
...
-(double)_layoutAttribution:(id)arg1 forNativeCardViewModel:(id)arg2 contentWidth:(double)arg3 atPoint:(CGPoint)arg4 ;
-(double)_layoutImageNextToInfoAndAction:(id)arg1 forNativeCardViewModel:(id)arg2 width:(double)arg3 atPoint:(CGPoint)arg4 ;
-(CGRect)_layoutDetailsForLayoutState:(id)arg1 viewModel:(id)arg2 contentWidth:(double)arg3 atPoint:(CGPoint)arg4 ;
