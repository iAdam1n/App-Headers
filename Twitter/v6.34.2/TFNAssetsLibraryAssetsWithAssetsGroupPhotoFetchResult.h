...
@interface TFNAssetsLibraryAssetsWithAssetsGroupPhotoFetchResult : TFNAssetsLibraryPhotoFetchResult {
...
-(id)initWithAssetsGroup:(id)arg1 options:(id)arg2 ;
-(void)assetsLibraryPhotoLibraryDidChange:(id)arg1 ;
-(id)initWithAssets:(id)arg1 assetsGroup:(id)arg2 options:(id)arg3 ;
-(void)_update;
@end
