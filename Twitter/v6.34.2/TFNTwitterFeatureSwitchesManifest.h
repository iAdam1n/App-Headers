...
@class TFNTwitterFeatureSwitchesConfig, NSDictionary, NSSet, NSArray, NSDate;
...
@property (nonatomic,readonly) TFNTwitterFeatureSwitchesConfig * defaultConfig;              //@synthesize defaultConfig=_defaultConfig - In the implementation block
...
-(NSArray *)facets;
-(NSDate *)createdOn;
-(TFNTwitterFeatureSwitchesConfig *)defaultConfig;
@end
