...
#import <Twitter/TFNPhotoAssetCollection.h>

@class NSDate, CLLocation, NSArray, NSString, NSURL;

@interface TFNAssetsLibraryPhotoAssetCollection : TFNAssetsLibraryPhotoCollection <TFNPhotoAssetCollection>
