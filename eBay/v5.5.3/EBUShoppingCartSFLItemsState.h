...
@interface EBUShoppingCartSFLItemsState : EBUShoppingCartBaseItemsState
...
-(id)groupSavedForLaterItemsByGroup;
-(void)addSavedForLaterItems:(id)arg1 ;
-(id)emptyHeaderForState;
@end
