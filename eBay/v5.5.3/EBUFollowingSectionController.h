...
@class EBUFollowedSearchCell, NSMutableDictionary, EBNUSSFeedDataManager, NSMutableArray, EBULoadingToastView, EBUSwipeActionHelper, EBUPickerDeckViewController, LoadingView, UIView, NSString;
