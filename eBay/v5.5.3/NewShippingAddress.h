...
@interface NewShippingAddress : ProgressViewController <UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, UITextViewDelegate, CheckoutDataManagerObserver> {
