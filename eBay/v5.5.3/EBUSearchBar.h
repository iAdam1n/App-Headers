...
@property (assign,nonatomic) BOOL hideSearchIcon;                                   //@synthesize hideSearchIcon=_hideSearchIcon - In the implementation block
...
-(void)setHideSearchIcon:(BOOL)arg1 ;
-(BOOL)hideSearchIcon;
