...
@interface EBULandingPageSectionHeaderPopoverView : EUICollectionReusableView <UITableViewDataSource, UITableViewDelegate, BlockerViewProtocol, EBUDropdownIndicatorButtonDelegate, RotatingPopoverDelegate> {
