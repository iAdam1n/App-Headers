...
@class EBUDebugCategoryViewController, NSMutableArray, NSArray, NSTimer, EBUDebugCellBase, NSDictionary, EUITableView, EUIAlertControllerWrapper, NSString;

@interface EBUDebugViewController : UIViewController <UISearchControllerDelegate, UITableViewDataSource, UITableViewDelegate> {
...
@property (retain) EUIAlertControllerWrapper * alertController;                   //@synthesize alertController=_alertController - In the implementation block
