...
@class UICollectionView, NSMutableArray, UIView, UIViewController, EGORefreshHelper, LoadingView, NSMutableIndexSet, NSString, EUIView, EBUSplitViewItemPresenter, FloatingHeaderScrollViewContainer, NSTimer, NSIndexPath, UIAlertController, ItemListViewLayout, UICollectionViewCell;
...
@interface EBUItemsCollectionController : UICollectionViewController <EUIImageViewLoaderDelegate, EBUItemsCollectionControllerProtocol, UICollectionViewDelegateFlowLayout, EGORefreshHelperDelegate, EBNAppSpeedViewControllerProtocol, EBUImageZoomTransitionController> {
	...
	EUIView* _splitListSeparatorView;
...
@property (nonatomic,retain) EUIView * splitListSeparatorView;                                         //@synthesize splitListSeparatorView=_splitListSeparatorView - In the implementation block
...
@property (assign,nonatomic) BOOL predictiveAutoload;                                                  //@synthesize predictiveAutoload=_predictiveAutoload - In the implementation block
...
@property (nonatomic,readonly) ItemListViewLayout * itemListViewLayout; 
...
-(void)setupDefaultPresentationType;
...
-(ItemListViewLayout *)itemListViewLayout;
...
-(void)transitionFromPresentation:(long long)arg1 toPresentation:(long long)arg2 newLayout:(id)arg3 animated:(BOOL)arg4 sender:(id)arg5 ;
...
-(BOOL)shouldLoadMore;
-(unsigned long long)autoLoadThreshold;
...
-(EUIView *)splitListSeparatorView;
