...
@class AddressTextField, NSString;

@interface TextEditCell : eBayTableViewCell {

	AddressTextField* editField;
	NSString* stringIdentifier;

}

@property (nonatomic,retain) AddressTextField * editField; 
@property (nonatomic,retain) NSString * stringIdentifier; 
-(double)optimalHeight;
-(NSString *)stringIdentifier;
-(void)setStringIdentifier:(NSString *)arg1 ;
-(AddressTextField *)editField;
-(void)setEditField:(AddressTextField *)arg1 ;
@end
