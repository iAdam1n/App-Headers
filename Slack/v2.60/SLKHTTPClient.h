...
-(void)registerForPushWithToken:(id)arg1 deviceIdentifier:(id)arg2 deviceName:(id)arg3 isVoip:(BOOL)arg4 isNewPrimaryTeam:(BOOL)arg5 completion:(/*^block*/id)arg6 ;
