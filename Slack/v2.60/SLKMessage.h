...
@class NSDate, NSString, NSArray, UIImage, SLKChannel, SLKGroup, SLKIM, SLKStar, NSManagedObjectID, NSManagedObjectContext, NSNumber, SLKUser, SLKFile, SLKCallRoom, SLKComment;
