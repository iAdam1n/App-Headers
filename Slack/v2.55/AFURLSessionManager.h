...
@class NSURLSession, NSOperationQueue, AFSecurityPolicy, AFNetworkReachabilityManager, NSObject, NSURLSessionConfiguration, NSMutableDictionary, NSLock, NSArray, NSString;
