...
#import <Slack/Slack.SLKPerformanceLoggingTableViewDelegate.h>

@class NSArray, NSString, UITableView;

@interface Slack.SLKSearchDataDelegate : NSObject <UIScrollViewDelegate, UITableViewDataSource, UITableViewDelegate, Slack.SLKPerformanceLoggingTableViewDelegate> {
...
-(id)searchItemForIndexPath:(id)arg1 ;
...
-(id)performanceLoggingIdentifierForTableView:(id)arg1 ;
-(id)init;
