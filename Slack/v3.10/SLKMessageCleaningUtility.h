...
@interface SLKMessageCleaningUtility : NSObject
+(id)cleanedAttributedStringForRawMessage:(id)arg1 dependencies:(id)arg2 ;
+(id)cleanedRawMessage:(id)arg1 dependencies:(id)arg2 ;
@end
