...
@interface SLKPin : _SLKPin <SLKGenerics> {
...
+(id)pinForId:(id)arg1 contextType:(unsigned long long)arg2 dependencies:(id)arg3 ;
+(id)pinsForChannel:(id)arg1 contextType:(unsigned long long)arg2 dependencies:(id)arg3 ;
