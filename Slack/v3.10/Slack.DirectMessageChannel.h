...
@interface Slack.DirectMessageChannel : NSObject <Slack.SLKChannelListItem> {
...
@property (retain,nonatomic) _TtC5Slack4User * user; 
@property (assign,nonatomic) BOOL isOpen; 
@property (assign,nonatomic) long long channelIconType; 
...
-(long long)channelIconType;
-(void)setChannelIconType:(long long)arg1 ;
...
-(NSDate *)createdAt;
-(_TtC5Slack4User *)user;
-(void)setUser:(_TtC5Slack4User *)arg1 ;
