...
@property (assign,nonatomic) SCD_Struct_JT14 startingInfo;                                                              //@synthesize startingInfo=_startingInfo - In the implementation block
@property (assign,nonatomic) SCD_Struct_JT15 flags;                                                                     //@synthesize flags=_flags - In the implementation block
...
-(SCD_Struct_JT14)startingInfo;
-(void)setStartingInfo:(SCD_Struct_JT14)arg1 ;
...
-(void)setFlags:(SCD_Struct_JT15)arg1 ;
-(SCD_Struct_JT15)flags;
