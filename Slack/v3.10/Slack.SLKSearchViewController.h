...
@class NSString, _TtC5Slack16SLKSearchBarView, AKZSegmentedControl, _TtC5Slack30SLKPerformanceLoggingTableView, NSLayoutConstraint, UIView, UIActivityIndicatorView;
...
@property (retain,nonatomic) _TtC5Slack30SLKPerformanceLoggingTableView * tableView; 
