...
-(void)getRepliesForGenericChannel:(id)arg1 withTimestamp:(id)arg2 completion:(/*^block*/id)arg3 ;
...
-(void)sendMentionTextFromUser:(id)arg1 inChannel:(id)arg2 withLink:(id)arg3 completion:(/*^block*/id)arg4 ;
...
-(void)unPinGenericObject:(id)arg1 fromChannel:(id)arg2 withCompletion:(/*^block*/id)arg3 ;
-(void)pinGenericObject:(id)arg1 toChannel:(id)arg2 withCompletion:(/*^block*/id)arg3 ;
...
-(void)getExperiments:(/*^block*/id)arg1 ;
...
-(void)handleEnterpriseToken:(id)arg1 enterpriseId:(id)arg2 userId:(id)arg3 completion:(/*^block*/id)arg4 ;
...
-(void)canGetShareableInviteLink:(/*^block*/id)arg1 ;
-(void)getShareableInviteLink:(/*^block*/id)arg1 ;
...
-(void)unPinObjectWithID:(id)arg1 withType:(unsigned long long)arg2 fromChannel:(id)arg3 withCompletion:(/*^block*/id)arg4 ;
