...
@property (nonatomic,retain) NSString * email_pattern;              //@synthesize email_pattern=_email_pattern - In the implementation block
...
-(NSString *)email_pattern;
-(void)setEmail_pattern:(NSString *)arg1 ;
@end
