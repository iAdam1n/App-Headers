...
@interface TLRPCmessages_getAttachedStickers : TLMetaRpc {
	...
	TLInputStickeredMedia* _media;

}

@property (nonatomic,retain) TLInputStickeredMedia * media;              //@synthesize media=_media - In the implementation block
...
-(void)setMedia:(TLInputStickeredMedia *)arg1 ;
@end
