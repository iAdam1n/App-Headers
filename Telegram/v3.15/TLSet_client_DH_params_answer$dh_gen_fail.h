...
@interface TLSet_client_DH_params_answer$dh_gen_fail : TLSet_client_DH_params_answer {
	...
	NSData* _n_new_nonce_hash3;

}

@property (nonatomic,retain) NSData * n_new_nonce_hash3;              //@synthesize n_new_nonce_hash3=_n_new_nonce_hash3 - In the implementation block
...
-(void)setN_new_nonce_hash3:(NSData *)arg1 ;
-(NSData *)n_new_nonce_hash3;
@end
