...
@class TLChannelParticipant, NSArray, NSString;

@interface TLchannels_ChannelParticipant : NSObject <TLObject> {

	TLChannelParticipant* _participant;
	NSArray* _users;

}

@property (nonatomic,retain) TLChannelParticipant * participant;              //@synthesize participant=_participant - In the implementation block
...
-(void)setParticipant:(TLChannelParticipant *)arg1 ;
-(NSArray *)users;
