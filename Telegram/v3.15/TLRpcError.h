...
@property (nonatomic,retain) NSString * error_message;              //@synthesize error_message=_error_message - In the implementation block
...
-(void)setError_message:(NSString *)arg1 ;
@end
