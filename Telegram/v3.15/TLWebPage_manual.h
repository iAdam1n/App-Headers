...
@class NSString, TLPhoto, TLDocument, TLPage;
...
@property (nonatomic,retain) TLPage * cached_page;                  //@synthesize cached_page=_cached_page - In the implementation block
...
-(void)setCached_page:(TLPage *)arg1 ;
