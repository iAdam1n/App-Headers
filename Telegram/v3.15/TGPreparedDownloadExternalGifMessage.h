...
@class TGExternalGifSearchResult, NSString, TGImageInfo, NSArray;
...
-(id)initWithSearchResult:(id)arg1 localDocumentId:(long long)arg2 mimeType:(id)arg3 thumbnailInfo:(id)arg4 attributes:(id)arg5 caption:(id)arg6 replyMessage:(id)arg7 botContextResult:(id)arg8 replyMarkup:(id)arg9 ;
-(int)size;
