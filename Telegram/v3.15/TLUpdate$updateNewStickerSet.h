...
@interface TLUpdate$updateNewStickerSet : TLUpdate {
	...
	TLmessages_StickerSet* _stickerset;

}

@property (nonatomic,retain) TLmessages_StickerSet * stickerset;              //@synthesize stickerset=_stickerset - In the implementation block
...
-(TLmessages_StickerSet *)stickerset;
-(void)setStickerset:(TLmessages_StickerSet *)arg1 ;
@end
