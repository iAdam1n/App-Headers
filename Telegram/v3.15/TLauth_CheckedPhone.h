...
@interface TLauth_CheckedPhone : NSObject <TLObject> {
	...
	BOOL _phone_registered;

}

@property (assign,nonatomic) BOOL phone_registered;                 //@synthesize phone_registered=_phone_registered - In the implementation block
...
-(void)setPhone_registered:(BOOL)arg1 ;
@end
