...
@property (nonatomic,readonly) BOOL disableLinkPreviews;              //@synthesize disableLinkPreviews=_disableLinkPreviews - In the implementation block
...
-(id)initWithDisableLinkPreviews:(BOOL)arg1 ;
