...
@property (assign,nonatomic) int min_layer;                         //@synthesize min_layer=_min_layer - In the implementation block
@property (assign,nonatomic) int max_layer;                         //@synthesize max_layer=_max_layer - In the implementation block
...
-(int)min_layer;
-(void)setMin_layer:(int)arg1 ;
-(int)max_layer;
-(void)setMax_layer:(int)arg1 ;
