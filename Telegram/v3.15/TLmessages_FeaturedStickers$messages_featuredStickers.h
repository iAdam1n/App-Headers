...
@property (nonatomic,retain) NSArray * sets;                //@synthesize sets=_sets - In the implementation block
@property (nonatomic,retain) NSArray * unread;              //@synthesize unread=_unread - In the implementation block
...
-(NSArray *)sets;
-(void)setSets:(NSArray *)arg1 ;
-(NSArray *)unread;
-(void)setUnread:(NSArray *)arg1 ;
@end
