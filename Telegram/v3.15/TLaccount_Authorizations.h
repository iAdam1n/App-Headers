...
@property (nonatomic,retain) NSArray * authorizations;              //@synthesize authorizations=_authorizations - In the implementation block
...
-(void)setAuthorizations:(NSArray *)arg1 ;
@end
