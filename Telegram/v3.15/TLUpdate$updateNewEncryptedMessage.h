...
@interface TLUpdate$updateNewEncryptedMessage : TLUpdate {
	...
	int _qts;
	TLEncryptedMessage* _message;

}

@property (nonatomic,retain) TLEncryptedMessage * message;              //@synthesize message=_message - In the implementation block
...
-(int)qts;
-(void)setMessage:(TLEncryptedMessage *)arg1 ;
