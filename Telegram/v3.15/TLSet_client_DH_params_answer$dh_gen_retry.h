...
@interface TLSet_client_DH_params_answer$dh_gen_retry : TLSet_client_DH_params_answer {
	...
	NSData* _n_new_nonce_hash2;

}

@property (nonatomic,retain) NSData * n_new_nonce_hash2;              //@synthesize n_new_nonce_hash2=_n_new_nonce_hash2 - In the implementation block
...
-(void)setN_new_nonce_hash2:(NSData *)arg1 ;
-(NSData *)n_new_nonce_hash2;
@end
