...
+(id)snapshotOptionsForUri:(id)arg1 size:(out CGSize*)arg2 ;
+(id)mapAddressForUri:(id)arg1 size:(out CGSize*)arg2 ;
+(id)_performLoad:(id)arg1 isCancelled:(/*^block*/id)arg2 ;
+(id)resultForUnavailableImage:(BOOL)arg1 cornerRadius:(int)arg2 ;
+(BOOL)_isDataLocallyAvailableForUri:(id)arg1 ;
+(id)_performLoad:(id)arg1 image:(id)arg2 size:(CGSize)arg3 isCancelled:(/*^block*/id)arg4 ;
+(id)sourceMapIdentifierForUri:(id)arg1 size:(out CGSize*)arg2 ;
+(void)load;
