...
@class TLProtoMessage, NSString;

@interface TLProtoMessageCopy : NSObject <TLObject> {

	TLProtoMessage* _orig_message;

}

@property (nonatomic,retain) TLProtoMessage * orig_message;              //@synthesize orig_message=_orig_message - In the implementation block
...
-(TLProtoMessage *)orig_message;
-(void)setOrig_message:(TLProtoMessage *)arg1 ;
@end
