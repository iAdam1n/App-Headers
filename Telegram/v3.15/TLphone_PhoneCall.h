...
@class TLPhoneCall, NSArray, NSString;

@interface TLphone_PhoneCall : NSObject <TLObject> {

	TLPhoneCall* _phone_call;
	NSArray* _users;

}

@property (nonatomic,retain) TLPhoneCall * phone_call;              //@synthesize phone_call=_phone_call - In the implementation block
...
-(TLPhoneCall *)phone_call;
-(void)setPhone_call:(TLPhoneCall *)arg1 ;
-(NSArray *)users;
