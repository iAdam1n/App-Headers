...
@property (nonatomic,retain) NSData * n_new_nonce_hash;              //@synthesize n_new_nonce_hash=_n_new_nonce_hash - In the implementation block
...
-(void)setN_new_nonce_hash:(NSData *)arg1 ;
-(NSData *)n_new_nonce_hash;
@end
