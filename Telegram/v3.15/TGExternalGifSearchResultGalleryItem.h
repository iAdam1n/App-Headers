...
@class TGMediaSelectionContext, TGMediaEditingContext, TGExternalGifSearchResult, NSString;
...
@interface TGExternalGifSearchResultGalleryItem : NSObject <TGModernGalleryItem, TGWebSearchResultsGalleryItem, TGModernGalleryEditableItem> {
	...
	TGExternalGifSearchResult* _webSearchResult;

}

@property (nonatomic,readonly) TGExternalGifSearchResult * webSearchResult;              //@synthesize webSearchResult=_webSearchResult - In the implementation block
...
-(id)uniqueId;
-(Class)viewClass;
-(TGExternalGifSearchResult *)webSearchResult;
-(TGMediaEditingContext *)editingContext;
