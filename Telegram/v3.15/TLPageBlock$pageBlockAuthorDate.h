...
@property (nonatomic,retain) TLRichText * author;              //@synthesize author=_author - In the implementation block
@property (assign,nonatomic) int published_date;               //@synthesize published_date=_published_date - In the implementation block
...
-(void)setPublished_date:(int)arg1 ;
-(int)published_date;
-(TLRichText *)author;
-(void)setAuthor:(TLRichText *)arg1 ;
@end
