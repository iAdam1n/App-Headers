...
@class NSAttributedString, NSDataDetector, NSArray, NSDictionary, NSTextCheckingResult;
...
-(void)drawFramesetter:(CTFramesetterRef)arg1 attributedString:(id)arg2 textRange:(SCD_Struct_BI153)arg3 inRect:(CGRect)arg4 context:(CGContextRef)arg5 ;
