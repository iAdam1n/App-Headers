...
@class ASHandle, NSArray, NSDictionary, NSMutableDictionary, NSString, NSTimer, SDisposableSet, SPipe, TGAttachmentSheetWindow, TGButtonCollectionItem, TGCollectionMenuSection, TGCollectionMultilineInputItem, TGConversation, TGGroupInfoCollectionItem, TGHeaderCollectionItem, TGSwitchCollectionItem, TGUserInfoButtonCollectionItem, TGVariantCollectionItem;

@interface TGChannelGroupInfoController : TGCollectionMenuController <TGGroupInfoSelectContactControllerDelegate, TGAlertSoundControllerDelegate, TGLegacyCameraControllerDelegate, TGImagePickerControllerDelegate, ASWatcher>
{
    _Bool _editing;
    long long _peerId;
...
- (_Bool)canKickMembers;
- (_Bool)canInviteToChannel;
- (_Bool)canEditChannel;
