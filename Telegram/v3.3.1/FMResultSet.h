...
@property(retain, nonatomic) FMStatement *statement; // @synthesize statement=_statement;
@property(retain, nonatomic) NSMutableDictionary *columnNameToIndexMap; // @synthesize columnNameToIndexMap=_columnNameToIndexMap;
