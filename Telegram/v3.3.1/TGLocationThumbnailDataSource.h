...
@interface TGLocationThumbnailDataSource : TGImageDataSource
{
}

+ (id)_performLoad:(id)arg1 image:(id)arg2 size:(struct CGSize)arg3 isCancelled:(CDUnknownBlockType)arg4;
+ (id)_performLoad:(id)arg1 isCancelled:(CDUnknownBlockType)arg2;
+ (_Bool)_isDataLocallyAvailableForUri:(id)arg1;
+ (id)resultForUnavailableImage:(_Bool)arg1 cornerRadius:(int)arg2;
+ (id)sourceMapIdentifierForUri:(id)arg1 size:(out struct CGSize *)arg2;
+ (id)mapAddressForUri:(id)arg1 size:(out struct CGSize *)arg2;
+ (id)snapshotOptionsForUri:(id)arg1 size:(out struct CGSize *)arg2;
+ (void)load;
