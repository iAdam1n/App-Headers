...
@class TLInputPrivacyKey, NSArray;
...
@property (nonatomic,retain) TLInputPrivacyKey * key;              //@synthesize key=_key - In the implementation block
...
-(void)setKey:(TLInputPrivacyKey *)arg1 ;
-(Class)responseClass;
-(NSArray *)rules;
@end
