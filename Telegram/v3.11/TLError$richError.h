...
@property (nonatomic,retain) NSString * request_params;              //@synthesize request_params=_request_params - In the implementation block
...
-(void)setRequest_params:(NSString *)arg1 ;
-(NSString *)request_params;
