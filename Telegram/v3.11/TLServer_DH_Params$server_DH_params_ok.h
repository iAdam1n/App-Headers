...
@property (nonatomic,retain) NSData * encrypted_answer;              //@synthesize encrypted_answer=_encrypted_answer - In the implementation block
...
-(void)setEncrypted_answer:(NSData *)arg1 ;
-(NSData *)encrypted_answer;
@end
