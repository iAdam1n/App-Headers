...
@interface TGDatabase : NSObject {
	...
	SCD_Struct_TG70 _cachedDatabaseState;
...
@property (assign,nonatomic) SCD_Struct_TG70 cachedDatabaseState;                                //@synthesize cachedDatabaseState=_cachedDatabaseState - In the implementation block
...
-(id)_loadChannelsWithLowerBound:(SCD_Struct_TG74)arg1 upperBound:(SCD_Struct_TG74)arg2 count:(unsigned long long)arg3 ;
...
-(SCD_Struct_TG75)loadPeerCustomSettings:(long long)arg1 ;
-(void)storePeerCustomSettings:(long long)arg1 customSettings:(SCD_Struct_TG75)arg2 ;
...
-(SCD_Struct_TG76)_knownChannelEarlierRemoteMessageSortKey:(long long)arg1 important:(BOOL)arg2 ;
...
-(SCD_Struct_TG76)_knownChannelEarlierMessageSortKey:(long long)arg1 maxId:(int)arg2 ;
...
-(id)_loadChannelList;
-(id)_loadChannelImportantMessagesWithMinSortKey:(SCD_Struct_TG76)arg1 maxSortKey:(SCD_Struct_TG76)arg2 count:(unsigned long long)arg3 ;
-(id)_loadChannelMessagesWithMinSortKey:(SCD_Struct_TG76)arg1 maxSortKey:(SCD_Struct_TG76)arg2 count:(unsigned long long)arg3 ;
-(id)_loadChannelHolesWithMinSortKey:(SCD_Struct_TG76)arg1 maxTransparentSortKey:(SCD_Struct_TG76)arg2 unimportant:(BOOL)arg3 count:(unsigned long long)arg4 ;
...
-(void)updateChannelMessageSortKeyAndDispatch:(long long)arg1 previousSortKey:(SCD_Struct_TG76)arg2 updatedSortKey:(SCD_Struct_TG76)arg3 updatedMessage:(id)arg4 ;
...
-(id)_loadChannelUnimportantGroupsWithMinSortKey:(SCD_Struct_TG76)arg1 maxTransparentSortKey:(SCD_Struct_TG76)arg2 count:(unsigned long long)arg3 ;
-(void)channelMessages:(long long)arg1 maxTransparentSortKey:(SCD_Struct_TG76)arg2 count:(unsigned long long)arg3 important:(BOOL)arg4 mode:(int)arg5 completion:(/*^block*/id)arg6 ;
...
-(SCD_Struct_TG70)cachedDatabaseState;
-(void)setCachedDatabaseState:(SCD_Struct_TG70)arg1 ;
