...
@interface TLUpdate$updateEncryption : TLUpdate {
	...
	int _date;
	TLEncryptedChat* _chat;

}

@property (nonatomic,retain) TLEncryptedChat * chat;              //@synthesize chat=_chat - In the implementation block
...
-(void)setChat:(TLEncryptedChat *)arg1 ;
@end
