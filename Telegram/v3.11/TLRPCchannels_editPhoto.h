...
@class TLInputChannel, TLInputChatPhoto;
...
@property (nonatomic,retain) TLInputChatPhoto * photo;              //@synthesize photo=_photo - In the implementation block
...
-(int)layerVersion;
-(Class)responseClass;
-(void)setPhoto:(TLInputChatPhoto *)arg1 ;
