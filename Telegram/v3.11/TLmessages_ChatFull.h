...
@class TLChatFull, NSArray, NSString;
...
@property (nonatomic,retain) TLChatFull * full_chat;                //@synthesize full_chat=_full_chat - In the implementation block
...
-(TLChatFull *)full_chat;
-(void)setFull_chat:(TLChatFull *)arg1 ;
-(NSArray *)chats;
-(NSArray *)users;
