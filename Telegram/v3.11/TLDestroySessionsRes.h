...
@interface TLDestroySessionsRes : NSObject <TLObject> {
	...
	NSArray* _destroy_results;

}

@property (nonatomic,retain) NSArray * destroy_results;              //@synthesize destroy_results=_destroy_results - In the implementation block
...
-(NSArray *)destroy_results;
-(void)setDestroy_results:(NSArray *)arg1 ;
@end
