...
@interface TLBadMsgNotification$bad_server_salt : TLBadMsgNotification {
	...
	long long _n_new_server_salt;

}

@property (assign,nonatomic) long long n_new_server_salt;              //@synthesize n_new_server_salt=_n_new_server_salt - In the implementation block
...
-(void)setN_new_server_salt:(long long)arg1 ;
-(long long)n_new_server_salt;
@end
