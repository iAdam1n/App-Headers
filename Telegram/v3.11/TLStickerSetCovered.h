...
@class TLStickerSet, TLDocument, NSString;
...
@property (nonatomic,retain) TLDocument * cover;                    //@synthesize cover=_cover - In the implementation block
