...
-(void)reloadVariantAtSortKey:(SCD_Struct_TG76)arg1 group:(id)arg2 jump:(BOOL)arg3 top:(BOOL)arg4 messageIdForVisibleHoleDirection:(int)arg5 scrollBackMessageId:(int)arg6 animated:(BOOL)arg7 ;
