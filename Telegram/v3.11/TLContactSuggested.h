...
@interface TLContactSuggested : NSObject <TLObject> {
	...
	int _user_id;
	int _mutual_contacts;

}

@property (assign,nonatomic) int user_id;                           //@synthesize user_id=_user_id - In the implementation block
@property (assign,nonatomic) int mutual_contacts;                   //@synthesize mutual_contacts=_mutual_contacts - In the implementation block
...
-(int)mutual_contacts;
-(void)setMutual_contacts:(int)arg1 ;
@end
