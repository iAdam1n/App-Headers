...
@class TGSignalImageViewModel, TGModernImageViewModel;
...
-(id)initWithPeer:(id)arg1 incoming:(BOOL)arg2 text:(id)arg3 imageSignalGenerator:(/*^block*/id)arg4 imageSignalIdentifier:(id)arg5 icon:(id)arg6 truncateTextInTheMiddle:(BOOL)arg7 system:(BOOL)arg8 ;
