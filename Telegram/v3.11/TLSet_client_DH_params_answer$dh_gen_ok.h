...
@property (nonatomic,retain) NSData * n_new_nonce_hash1;              //@synthesize n_new_nonce_hash1=_n_new_nonce_hash1 - In the implementation block
...
-(void)setN_new_nonce_hash1:(NSData *)arg1 ;
-(NSData *)n_new_nonce_hash1;
@end
