...
@interface GCDAsyncSocket : NSObject {
	...
	SCD_Struct_GC142* streamContext;
...
@property (assign,nonatomic) BOOL useTcpNodelay;              //@synthesize useTcpNodelay=_useTcpNodelay - In the implementation block
...
-(BOOL)useTcpNodelay;
-(void)setUseTcpNodelay:(BOOL)arg1 ;
