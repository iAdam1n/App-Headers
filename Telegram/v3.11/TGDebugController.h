...
@class TGSwitchCollectionItem, NSString;

@interface TGDebugController : TGCollectionMenuController <MFMailComposeViewControllerDelegate, UINavigationControllerDelegate> {
