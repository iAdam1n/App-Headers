...
@class TLInputChannel, TLChannelMessagesFilter;
...
@property (nonatomic,retain) TLChannelMessagesFilter * filter;              //@synthesize filter=_filter - In the implementation block
...
-(void)setFilter:(TLChannelMessagesFilter *)arg1 ;
-(int)pts;
-(Class)responseClass;
