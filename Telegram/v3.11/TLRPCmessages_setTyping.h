...
@class TLInputPeer, TLSendMessageAction;

@interface TLRPCmessages_setTyping : TLMetaRpc {

	TLInputPeer* _peer;
	TLSendMessageAction* _action;

}

@property (nonatomic,retain) TLInputPeer * peer;                        //@synthesize peer=_peer - In the implementation block
@property (nonatomic,retain) TLSendMessageAction * action;              //@synthesize action=_action - In the implementation block
...
-(void)setAction:(TLSendMessageAction *)arg1 ;
-(Class)responseClass;
@end
