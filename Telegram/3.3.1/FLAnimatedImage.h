...
@interface FLAnimatedImage : NSObject
{
    ...
    CDUnknownBlockType _imageDrawingBlock;
...
@property(copy, nonatomic) CDUnknownBlockType imageDrawingBlock; // @synthesize imageDrawingBlock=_imageDrawingBlock;
- (void).cxx_destruct;
- (id)description;
...
- (void)dealloc;
- (id)initWithAnimatedGIFData:(id)arg1 imageDrawingBlock:(CDUnknownBlockType)arg2;
- (id)init;
