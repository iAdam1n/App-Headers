...
@property(readonly, nonatomic) TGBridgeImageMediaAttachment *imageAttachment; // @synthesize imageAttachment=_imageAttachment;
- (void).cxx_destruct;
- (void)_unserializeParametersWithCoder:(id)arg1;
- (void)_serializeParametersWithCoder:(id)arg1;
- (_Bool)renewable;
- (id)initWithImageAttachment:(id)arg1 size:(struct CGSize)arg2;
