...
@interface GCDAsyncSocket : NSObject
{
    ...
    _Bool _shouldAddControlByteToFirstPacket;
}
...
@property(nonatomic) _Bool shouldAddControlByteToFirstPacket; // @synthesize shouldAddControlByteToFirstPacket=_shouldAddControlByteToFirstPacket;
