...
@property(nonatomic) _Bool traceExecution; // @synthesize traceExecution=_traceExecution;
@property(nonatomic) _Bool checkedOut; // @synthesize checkedOut=_checkedOut;
@property(nonatomic) int busyRetryTimeout; // @synthesize busyRetryTimeout=_busyRetryTimeout;
@property(nonatomic) _Bool crashOnErrors; // @synthesize crashOnErrors=_crashOnErrors;
@property(nonatomic) _Bool logsErrors; // @synthesize logsErrors=_logsErrors;
@property(retain, nonatomic) NSMutableDictionary *cachedStatements; // @synthesize cachedStatements=_cachedStatements;
- (void).cxx_destruct;
- (void)makeFunctionNamed:(id)arg1 maximumArguments:(int)arg2 withBlock:(CDUnknownBlockType)arg3;
- (void)setSoftShouldCacheStatements:(_Bool)arg1;
