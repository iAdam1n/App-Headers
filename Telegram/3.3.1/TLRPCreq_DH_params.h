...
@property(nonatomic) long long public_key_fingerprint; // @synthesize public_key_fingerprint=_public_key_fingerprint;
@property(retain, nonatomic) NSData *q; // @synthesize q=_q;
@property(retain, nonatomic) NSData *p; // @synthesize p=_p;
