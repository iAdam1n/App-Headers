...
@class NSString, FBComponentTableViewDataSource, FBFriendingToolbox, FBProfileFriendListDataSource, FBPullToRefreshView, FBScenePath, NSMutableArray, UISearchBar, FBPopoverActionSheet, FBMemPerson, UIView, FBUserSession, UIScrollView;
...
-(void)_didTapPopoverMenuWriteToWallButton:(id)arg1 ;
