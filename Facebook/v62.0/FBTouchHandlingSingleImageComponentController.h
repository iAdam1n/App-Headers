...
@class FBTouchHandlingSingleImageComponent, NSString;

@interface FBTouchHandlingSingleImageComponentController : CKComponentController <FBPhotoDisplayingComponentPhotoViewProviderDelegate>

@property (nonatomic,readonly) FBTouchHandlingSingleImageComponent * component; 
