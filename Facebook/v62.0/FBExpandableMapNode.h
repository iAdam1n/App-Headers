...
-(CGSize)_interpolateCenterFromStartingCenter:(CGSize)arg1 endingCenter:(CGSize)arg2 progress:(double)arg3 ;
...
-(id)initWithCoordinateRegion:(SCD_Struct_FB5)arg1 session:(id)arg2 displayContext:(id)arg3 annotations:(id)arg4 mapType:(unsigned long long)arg5 ;
