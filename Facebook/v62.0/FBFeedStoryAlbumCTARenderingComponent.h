...
@class FBFeedToolbox, FBMemAlbum, NSString;

@interface FBFeedStoryAlbumCTARenderingComponent : CKCompositeComponent <FBFeedStoryAttachmentCTARenderingComponent> {
