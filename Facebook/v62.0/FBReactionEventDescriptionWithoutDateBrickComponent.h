...
@class FBReactionEventDescriptionWithoutDateBrickComponentConfig;

@interface FBReactionEventDescriptionWithoutDateBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {

	id<FBReactionAction> _action;
	FBReactionEventDescriptionWithoutDateBrickComponentConfig* _config;
