...
@interface FBReactionPageAttributionFooterAttachmentComponent : CKCompositeComponent <FBReactionAttachmentsComponent> {
...
-(void)textComponentTapped:(id)arg1 context:(id)arg2 ;
@end
