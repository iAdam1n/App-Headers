...
@class FBUserSession, FBCrowdsourcingFeatherController, NSString;

@interface FBLightweightCrowdsourcingIntentHandler : NSObject <FBIntentHandler> {

	id<FBNavigationCoordinator> _navigationCoordinator;
	FBUserSession* _session;
	FBCrowdsourcingFeatherController* _featherController;
