...
@interface FBFeedVPVdLoggingPipelineProvider : NSObject {
	...
	BOOL _vpvdDeduplicationKeyTrackerEnabled;
...
-(id)initWithMaximumRecentVPVdDeduplicationKeys:(unsigned long long)arg1 durationThreshold:(double)arg2 feedEventListener:(id)arg3 vpvdDeduplicationKeyTrackerEnabled:(BOOL)arg4 ;
@end
