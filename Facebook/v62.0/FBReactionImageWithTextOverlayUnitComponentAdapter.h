...
@class UIView, FBMemReactionImageWithTextOverlayComponent, FBReactionContext;

@interface FBReactionImageWithTextOverlayUnitComponentAdapter : FBReactionBaseUnitComponentAdapter {

	UIView* _componentView;
	FBMemReactionImageWithTextOverlayComponent* _unitComponent;
