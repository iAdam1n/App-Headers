...
@class FBMemPhoto, FBFeedToolbox, NSString;

@interface FBFeedProfilePictureUpsellContentComponent : CKCompositeComponent <FBFeedStoryAttachmentCTARenderingComponent> {
