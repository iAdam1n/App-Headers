...
#import <Facebook/FBReactionGametimeFanFavoriteComponentDelegate.h>

@protocol FBQueriedReactionUnitFieldsProtocol, FBQueriedReactionUnitComponentFieldsProtocol;
@class FBReactionContext, CKComponentHostingView, FBMemModelObject, NSString;

@interface FBReactionGametimeFanFavoriteComponentAdapter : FBReactionBaseUnitComponentAdapter <FBScenePathHolding, FBReactionGametimeFanFavoriteComponentDelegate> {
...
-(id)componentView;
-(void)FBReactionGametimeFanFavoriteComponentDidUpdate;
-(void)FBReactionGametimeFanFavoriteDidTapVoteForAwayTeam;
-(void)FBReactionGametimeFanFavoriteDidTapVoteForHomeTeam;
@end
