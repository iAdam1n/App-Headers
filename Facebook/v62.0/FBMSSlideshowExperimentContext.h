...
@interface FBMSSlideshowExperimentContext : FBExperimentContext {
	...
	double _delayBeforeAnimation;
	double _animationDuration;

}

@property (nonatomic,readonly) double delayBeforeAnimation;              //@synthesize delayBeforeAnimation=_delayBeforeAnimation - In the implementation block
