...
@class FBMemReactionUnitPageContactInfoComponent, FBMemModelObject, FBReactionContext;

@interface FBReactionPageContactInfoBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {
