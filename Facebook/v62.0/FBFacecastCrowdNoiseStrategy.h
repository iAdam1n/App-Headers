...
@class FBUserSession, FBMemFeedback, FBMemVideo, NSString, NSArray, FBFacecastCrowdNoiseExperimentContext, FBCrowdNoiseReactionImageProvider;
...
@interface FBFacecastCrowdNoiseStrategy : NSObject <FBCrowdNoiseStrategy> {
	...
	FBFacecastCrowdNoiseExperimentContext* _experiment;
