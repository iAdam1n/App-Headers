...
@class UIAccessibilityElement, CKComponentHostingView;

@interface FBEntityCardComponentCell : UITableViewCell {
...
+(double)desiredHeightForConstrainedSize:(CGSize)arg1 model:(id)arg2 context:(id)arg3 ;
