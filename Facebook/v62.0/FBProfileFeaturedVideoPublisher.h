...
@interface FBProfileFeaturedVideoPublisher : NSObject <FBComposerPublisherStatusListener> {
...
@property (nonatomic,copy,readonly) NSString * profileFeaturedVideoMediaID;              //@synthesize profileFeaturedVideoMediaID=_profileFeaturedVideoMediaID - In the implementation block
...
-(id)initWithSession:(id)arg1 targetID:(id)arg2 video:(id)arg3 completion:(/*^block*/id)arg4 ;
-(void)upload;
