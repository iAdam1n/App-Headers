...
@property (nonatomic,readonly) unsigned long long tooltipAllowanceLevel;                                                //@synthesize tooltipAllowanceLevel=_tooltipAllowanceLevel - In the implementation block
