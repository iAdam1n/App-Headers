...
@interface FBSearchResultsHeaderLinkComponent : CKCompositeComponent {

	FBSearchComponentModel* _resultEdgeModel;
	FBSearchResultsContext* _context;
	BOOL _shouldOpenPulseIfTapped;

}
+(id)newWithResultEdgeModel:(id)arg1 context:(id)arg2 shouldOpenPulseIfTapped:(BOOL)arg3 ;
-(void)didTapLink;
@end
