...
@class FBGraphSearchResultsDownloader, NSString;

@interface FBGraphSearchRichMediaPhotosOfComponentController : CKComponentController <FBSearchResultsDownloaderDelegate> {
