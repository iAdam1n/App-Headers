...
-(id)initWithPhotoId:(id)arg1 originalPhotoId:(id)arg2 width:(id)arg3 height:(id)arg4 image:(id)arg5 lowResImage:(id)arg6 highResImage:(id)arg7 faceboxes:(id)arg8 faceboxRect:(id)arg9 cropRect:(id)arg10 date:(id)arg11 localImage:(id)arg12 ;
