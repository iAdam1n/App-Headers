...
@interface FBReactionComponentsDownloadRequest : FBGraphQLPagedDownloadRequest {
...
-(id)initWithComponentId:(id)arg1 callbackPerformer:(id)arg2 videoThumbnailSize:(id)arg3 ;
@end
