...
#import <Facebook/FBSnacksStackProvider.h>
...
@class CKComponentHostingView, FBSnacksToolbox, FBCache, FBSnacksKitThreadsModel, NSString;

@interface FBInlineSnacksDataSource : NSObject <FBSnacksEventHandler, FBSnacksStackProvider, FBBackstageStackDataStoreListener, FBCollectionViewSectionDataSource, CKComponentHostingViewDelegate, FBStreamListener, FBGraphQLConnectionControllerLoadListener, FBGraphQLConnectionControllerNetworkListener> {
	...
	BOOL _loading;
	FBCache* _dataStoreCache;
	id<FBCollectionViewMutating> _collectionViewMutator;
	id<FBFeedViewTopDataSourceDelegate> _feedViewTopDataSourceDelegate;
	FBSnacksKitThreadsModel* _model;

}

@property (nonatomic,retain) FBSnacksKitThreadsModel * model;                                                       //@synthesize model=_model - In the implementation block
...
-(id)dataStoreForPerson:(id)arg1 ;
-(void)didHidePerson:(id)arg1 ;
-(void)_reloadSnacks;
-(BOOL)_shouldShowViewer:(id)arg1 ;
-(void)_reloadAnimated:(BOOL)arg1 ;
-(void)stackDataStore:(id)arg1 didUpdatePerson:(id)arg2 ;
-(id)initWithType:(int)arg1 toolbox:(id)arg2 ;
-(id)_dedupedPerson:(id)arg1 ;
-(long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2 ;
-(id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2 ;
-(long long)numberOfSectionsInCollectionView:(id)arg1 ;
-(CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3 ;
-(FBSnacksKitThreadsModel *)model;
-(void)setModel:(FBSnacksKitThreadsModel *)arg1 ;
@end
