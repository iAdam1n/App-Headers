...
@protocol FBProtileSectionsDownloaderDelegate;
@class FBGraphQLConnectionController, NSString;

@interface FBProtileSectionsDownloader : NSObject <FBGraphQLConnectionControllerListener, FBGraphQLConnectionControllerLoadListener> {

	FBGraphQLConnectionController* _connectionController;
	NSString* _profileID;
	BOOL _hasDoneInitialLoad;
	BOOL _shouldUseHScroll;
	NSString* _bumpEnabled;
	id<FBProtileSectionsDownloaderDelegate> _delegate;

}

@property (assign,nonatomic,__weak) id<FBProtileSectionsDownloaderDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(void)loadInitialProtileSectionsIfNecessary;
...
-(void)setDelegate:(id<FBProtileSectionsDownloaderDelegate>)arg1 ;
-(void)dealloc;
-(id<FBProtileSectionsDownloaderDelegate>)delegate;
@end
