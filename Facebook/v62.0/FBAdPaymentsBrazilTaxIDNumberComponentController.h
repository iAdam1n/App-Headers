...
@class FBAdPaymentsBrazilTaxIDInputHandler;

@interface FBAdPaymentsBrazilTaxIDNumberComponentController : FBAdPaymentsFormComponentController {

	FBAdPaymentsBrazilTaxIDInputHandler* _textInputHandler;
