...
@class FBPagesSideFeedPaymentViewModel, NSMutableDictionary;

@interface FBPagesPadSideFeedPaymentUnitController : FBSideFeedUnitController {

	FBPagesSideFeedPaymentViewModel* _model;
