...
@class FBReactionContext, FBMemModelObject, FBCommentPublisher, FBMemFeedStory;

@interface FBReactionCommentComposerBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {
