...
@class FBUserSession, FBGroupCreationConfig, FBGroupCreationFlowCoordinator, NSString;

@interface FBGroupCreationIntentHandler : NSObject <FBIntentHandler> {
...
-(id)initWithNavigationCoordinator:(id)arg1 session:(id)arg2 creationConfig:(id)arg3 ;
@end
