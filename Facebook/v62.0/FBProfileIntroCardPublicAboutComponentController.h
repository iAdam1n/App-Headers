...
@interface FBProfileIntroCardPublicAboutComponentController : CKComponentController <FBComponentControllerWorkingRangeListening, FBComponentControllerWorkingRangeListenerProviding> {

	NSMutableSet* _loggedTypes;
...
-(void)didMount;
-(void)didTapEditPublicAboutButton;
