...
@class NSArray, FBMemAppAttributionActionLink, FBFeedToolbox, NSString;

@interface FBFeedStoryAppAttributionCTAComponent : CKCompositeComponent <FBFeedStoryCTARenderingComponent, FBFeedCTACustomLoggingComponentProtocol> {

	NSArray* _actionLinks;
	FBMemAppAttributionActionLink* _displayedActionLink;
