...
@protocol FBQueriedFeedUnitFieldsProtocol, FBServiceHelperProtocol;
@class FBMemModelObject, FBFeedSecondaryActionContext, NSString;

@interface FBFeedRemoveMusicServiceAction : NSObject <FBFeedSecondaryAction> {

	FBMemModelObject*<FBQueriedFeedUnitFieldsProtocol> _unit;
	FBFeedSecondaryActionContext* _context;
	id<FBServiceHelperProtocol> _helper;
...
-(id)initWithFeedUnit:(id)arg1 context:(id)arg2 helper:(id)arg3 ;
-(id)title;
