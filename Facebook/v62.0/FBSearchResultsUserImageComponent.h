...
@interface FBSearchResultsUserImageComponent : CKCompositeComponent <FIGCardContentHScrollChildCompliant> {

	SEL _tapHandler;
	FBSearchComponentModel* _model;

}
+(id)newWithModel:(id)arg1 context:(id)arg2 tapAction:(SEL)arg3 ;
