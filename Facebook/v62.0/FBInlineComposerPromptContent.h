...
@class FBInlineComposerProductionPrompt, FBInlineComposerPhotoRemindersPrompt, FBInlineComposerMagicStoryPrompt, FBInlineComposerPasteboardLinkPrompt, NSArray, FBInlineComposerMoviePrompt, FBInlineComposerGoodFriendsPrompt;
...
-(void)matchMediaPickerPrompt:(/*^block*/id)arg1 productionPrompt:(/*^block*/id)arg2 photoReminderPrompt:(/*^block*/id)arg3 magicStoryPrompt:(/*^block*/id)arg4 pasteboardLinkPrompt:(/*^block*/id)arg5 actionButtonsPrompt:(/*^block*/id)arg6 moviePrompt:(/*^block*/id)arg7 goodFriendsPrompt:(/*^block*/id)arg8 draftRecoveryPrompt:(/*^block*/id)arg9 ;
