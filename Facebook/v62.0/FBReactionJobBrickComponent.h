...
@class FBReactionContext, FBReactionSeeJobDetailActionAdapter;

@interface FBReactionJobBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {

	FBReactionContext* _context;
	FBReactionSeeJobDetailActionAdapter* _actionAdapter;
