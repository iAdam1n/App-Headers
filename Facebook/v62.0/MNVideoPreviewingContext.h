...
@property (nonatomic,copy,readonly) MNVideoPreviewingData * videoPreviewingData;              //@synthesize videoPreviewingData=_videoPreviewingData - In the implementation block
...
-(id)initWithVideoPreviewingData:(id)arg1 defaultActionItemsFlag:(unsigned long long)arg2 customActionItems:(id)arg3 sourceRect:(CGRect)arg4 ;
-(MNVideoPreviewingData *)videoPreviewingData;
