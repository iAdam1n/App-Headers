...
@interface FBApplistPrivacyEditData : FBGraphQLInput {
...
@property (nonatomic,copy) NSString * applistId;                     //@synthesize applistId=_applistId - In the implementation block
...
-(NSString *)applistId;
-(void)setApplistId:(NSString *)arg1 ;
@end
