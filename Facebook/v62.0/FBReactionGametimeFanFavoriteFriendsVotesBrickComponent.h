...
@protocol FBQueriedReactionUnitFieldsProtocol, FBQueriedReactionUnitComponentFieldsProtocol, FBReactionGametimeFanFavoriteFriendsVotesBrickComponentResizeDelegate;
@class FBReactionContext, FBMemModelObject;

@interface FBReactionGametimeFanFavoriteFriendsVotesBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {
...
+(id)newWithReactionContext:(id)arg1 resultStyle:(id)arg2 reactionUnit:(id)arg3 reactionUnitComponent:(id)arg4 position:(unsigned long long)arg5 indexPath:(id)arg6 resizeDelegate:(id)arg7 ;
