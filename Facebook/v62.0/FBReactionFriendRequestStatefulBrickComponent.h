...
@interface FBReactionFriendRequestStatefulBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {

	FBReactionContext* _reactionContext;
	id<FBReactionAction> _positiveAction;
	id<FBReactionAction> _negativeAction;
