...
+(id)newWithCameraMode:(long long)arg1 captureState:(unsigned long long)arg2 angle:(double)arg3 captureStateChangedToPhotoEvent:(id)arg4 captureStateChangedToVideoEvent:(id)arg5 captureButtonDisabled:(BOOL)arg6 overridingAction:(SEL)arg7 toolbox:(id)arg8 ;
