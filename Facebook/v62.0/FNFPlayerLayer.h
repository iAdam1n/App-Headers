...
@interface FNFPlayerLayer : CAEAGLLayer <FNFDecompressionSessionDelegate, FNFPlayerDisplayEngine, FNFAVPlayerLayer> {
	...
	SCD_Struct_FB257 _bufferTimes[60];
...
-(void)_requestData;
-(id)initWithConfigs:(SCD_Struct_FB185)arg1 ;
-(void)_displayLinkCallback:(id)arg1 ;
-(void)invalidateRenderer:(id)arg1 ;
-(void)setRenderingThreadPriority:(double)arg1 ;
-(void)yieldDecompressedBuffer:(CVBufferRef)arg1 presentationTimeStamp:(SCD_Struct_FB257)arg2 presentationDuration:(SCD_Struct_FB257)arg3 iFrame:(unsigned long long)arg4 ;
...
-(void)_addBuffer:(CVBufferRef)arg1 presentationTimeStamp:(SCD_Struct_FB257)arg2 iFrameEnqueued:(unsigned long long)arg3 ;
-(void)display:(CVBufferRef)arg1 presentationTimeStamp:(SCD_Struct_FB257)arg2 presentationDuration:(SCD_Struct_FB257)arg3 iFrameEnqueued:(unsigned long long)arg4 ;
