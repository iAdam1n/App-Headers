...
@class UIControl, FBReactionContext, FBUserSession, FBReactionSessionInfo;

@interface FBReactionViewEventPostsActionAdapter : FBReactionBaseActionAdapter {
...
-(void)_openEventStoryStreamViewController;
-(void)_viewEventPosts;
-(id)actionView;
