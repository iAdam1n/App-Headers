...
@class FBUserSession, FBListViewController, FBMemPerson, FBProfilePersonUpdateListenerAnnouncer, FBProfileCurationTaggingModelUpdateStatusListenerAnnouncer, FBProfileCurationTagsActionBar, NSString;

@interface FBProfileCurationTaggingViewController : UIViewController <FBEntityCardViewControllerProtocol> {

	FBUserSession* _session;
	FBListViewController* _listViewController;
	FBMemPerson* _person;
	FBProfilePersonUpdateListenerAnnouncer* _personUpdateListenerAnnouncer;
	FBProfileCurationTaggingModelUpdateStatusListenerAnnouncer* _curationTaggingModelUpdateStatusListenerAnnouncer;
