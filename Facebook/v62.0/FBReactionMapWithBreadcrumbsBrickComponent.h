...
@interface FBReactionMapWithBreadcrumbsBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {

	id<FBReactionAction> _mapAction;
...
-(void)mapAreaTapped;
-(void)breadcrumbTapped:(id)arg1 withContext:(id)arg2 ;
@end
