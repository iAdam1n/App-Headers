...
@class FBReactionCardHeaderViewNew, FBMemModelObject, FBReactionContext;

@interface FBReactionPageTextHeaderUnitComponentAdapter : FBReactionBaseUnitComponentAdapter {

	FBReactionCardHeaderViewNew* _componentView;
