...
-(void)faceDetector:(id)arg1 didCompleteWithFaceBoxes:(id)arg2 inImage:(id)arg3 inVideoAsset:(id)arg4 atTimestamp:(SCD_Struct_FB257)arg5 framesPerSecond:(double)arg6 ;
-(void)videoSampler:(id)arg1 didFinishForVideoAsset:(id)arg2 cancellable:(id)arg3 ;
-(void)videoSampler:(id)arg1 didGetImage:(id)arg2 forVideoAsset:(id)arg3 atTimestamp:(SCD_Struct_FB257)arg4 error:(id)arg5 ;
-(id)_getVideoIDForAsset:(id)arg1 ;
-(NSMutableDictionary *)videoIDsToVideoTagItems;
-(void)faceRecognizer:(id)arg1 didProcessFaceBoxes:(id)arg2 inVideoAsset:(id)arg3 atTimestamp:(SCD_Struct_FB257)arg4 ;
