...
-(id)friendsSharing;
-(void)_processResponse:(id)arg1 successBlock:(/*^block*/id)arg2 ;
-(void)loadDataWithFriendsSharingCount:(long long)arg1 successBlock:(/*^block*/id)arg2 failureBlock:(/*^block*/id)arg3 ;
