...
@interface FBCameraPreviewComponentModel : FBValueObject <FBObjectShallowCopyProtocol, NSCopying> {
...
-(id)initWithPermissionsState:(long long)arg1 captureState:(unsigned long long)arg2 ;
-(id)shallowCopy;
@end
