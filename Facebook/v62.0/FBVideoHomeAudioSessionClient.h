...
@class FBSystemAudioSessionManager, NSString;

@interface FBVideoHomeAudioSessionClient : NSObject <FBAudioSessionManagerClient, FBSystemAudioSessionManagerListener> {

	FBSystemAudioSessionManager* _audioSessionManager;
	float _previousSystemOutputVolume;
	BOOL _forceUnmute;
	BOOL _previousIsMuted;
	BOOL _active;
	BOOL _listeningForAudioChanges;

}

@property (assign,nonatomic) BOOL active;                                              //@synthesize active=_active - In the implementation block
@property (assign,nonatomic) BOOL listeningForAudioChanges;                            //@synthesize listeningForAudioChanges=_listeningForAudioChanges - In the implementation block
...
-(BOOL)listeningForAudioChanges;
-(id)initWithAudioSessionManager:(id)arg1 ;
-(void)setListeningForAudioChanges:(BOOL)arg1 ;
-(void)dealloc;
-(BOOL)active;
