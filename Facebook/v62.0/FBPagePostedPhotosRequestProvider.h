...
@interface FBPagePostedPhotosRequestProvider : NSObject <FBGraphQLConnectionSyncStoreRequestProvider, FBMediaSetRequestProvider> {
...
-(id)initWithPageID:(id)arg1 pageSize:(id)arg2 ;
@end
