...
@protocol FBComposerExpressionPickerTabViewProtocol <NSObject>
@property (assign,nonatomic,__weak) id<FBComposerExpressionPickerTabViewDelegate> delegate; 
@property (assign,nonatomic) BOOL allowStickers; 
@required
