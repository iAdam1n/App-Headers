...
@class FBPlacePickerBaseViewController, NSString;

@interface FBCommentPlaceInfoAttachmentContextualizeComponentController : CKComponentController <FBPlacePickerViewControllerDelegate> {
