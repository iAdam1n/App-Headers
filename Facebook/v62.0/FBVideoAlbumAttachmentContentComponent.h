...
@class NSArray, FBVideoAlbumAttachmentChannelVideoPlayerComponent, FBVideoAlbumAttachmentSummaryComponent, NSMutableArray, FBFeedToolbox;
...
+(id)newWithContentInfo:(id)arg1 options:(const FBVideoAlbumAttachmentContentComponentOptions*)arg2 toolbox:(id)arg3 ;
+(id)initialState;
