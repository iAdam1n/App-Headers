...
@class MKPointAnnotation, FBReactionContext, FBMemModelObject;

@interface FBReactionPageMapWithNavigationBrickComponent : CKComponent <FBReactionBrickComponent> {
