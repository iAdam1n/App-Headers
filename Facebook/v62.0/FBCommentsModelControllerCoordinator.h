...
@interface FBCommentsModelControllerCoordinator : NSObject <FBCKCommentsStoreDelegate, FBStreamListener, FBCommentPublisherDelegate, FBCommentEditorDelegate, FBCommentDeleterDelegate, FBCommentsRefresherDelegate, FBCKStreamResponseHandlerProcessingDelegate> {
	...
	SCD_Struct_FB402 _requiredFetchLimit;
...
@property (nonatomic,readonly) SCD_Struct_FB402 requiredFetchLimit;                                                          //@synthesize requiredFetchLimit=_requiredFetchLimit - In the implementation block
...
-(SCD_Struct_FB402)requiredFetchLimit;
-(void)setLifecycleManager:(id<FBCommentsModelControllerCoordinatorLifecycleManaging>)arg1 ;
-(void)registerRequiredFetchLimit:(SCD_Struct_FB402)arg1 ;
