...
#import <Facebook/FBReactionGametimeFanFavoriteFriendsVotesBrickComponentResizeDelegate.h>

@protocol FBQueriedReactionUnitFieldsProtocol, FBQueriedReactionUnitComponentFieldsProtocol;
@class CKComponentHostingView, FBReactionContext, NSString, FBMemModelObject, NSIndexPath;

@interface FBReactionGametimeFanFavoriteFriendsVotesComponentAdapter : FBReactionBaseUnitComponentAdapter <FBReactionGametimeFanFavoriteFriendsVotesBrickComponentResizeDelegate> {
...
-(id)componentView;
-(void)fanFavoriteComponentWillResize:(id)arg1 ;
@end
