...
@interface FBReactionImageWithOverlayGridBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {

	NSDictionary* _imageOverlayActions;
...
-(void)tappedPhotoAtIndex:(id)arg1 ;
@end
