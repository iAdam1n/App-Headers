...
@interface FBReactionPYMLHorizontalScrollAttachmentComponent : CKCompositeComponent <FBReactionAttachmentsComponent> {

	FBHScrollComponent* _hScrollComponent;
	unsigned long long _totalPagesCount;
...
-(void)didLikeAPage:(id)arg1 index:(id)arg2 ;
@end
