...
#import <Facebook/FBVideoPlayerDelegate.h>
...
@property (assign,nonatomic) SCD_Struct_FB257 startTime; 
...
-(void)videoPlayerDidLoadPixelBuffer:(CVBufferRef)arg1 withTime:(SCD_Struct_FB257)arg2 ;
