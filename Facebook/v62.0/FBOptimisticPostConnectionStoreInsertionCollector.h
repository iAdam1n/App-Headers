...
@interface FBOptimisticPostConnectionStoreInsertionCollector : NSObject <FBGraphQLConnectionStoreListener, FBGraphQLConnectionControllerListener> {
...
-(id)initWithGraphQLConnection:(id)arg1 ;
