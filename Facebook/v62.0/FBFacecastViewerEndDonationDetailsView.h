...
@protocol FBFacecastViewerEndDonationDetailsViewDelegate;
@class FBUserSession, FBProfilePictureWithBadgeView, FBNetworkImageView, UIButton, UILabel, FBMemFundraiserPersonToCharity, FBMemVideo;
...
@interface FBFacecastViewerEndDonationDetailsView : UIView {
	...
	FBMemFundraiserPersonToCharity* _donationCampaign;
	FBMemVideo* _video;
	BOOL _hasDonated;
