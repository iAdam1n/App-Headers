...
@class FBMemEvent, FBUserSession, FBEventNode, FBFeedToolbox, FBRichStoryBlockDisplayContext, NSString;

@interface FBEventBlockController : NSObject <FBRichStoryBlockController> {

	FBMemEvent* _event;
	FBUserSession* _session;
	FBEventNode* _eventNode;
...
-(id)initWithEvent:(id)arg1 session:(id)arg2 displayContext:(id)arg3 ;
@end
