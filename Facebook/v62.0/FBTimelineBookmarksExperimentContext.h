...
@interface FBTimelineBookmarksExperimentContext : FBExperimentContext {
	...
	BOOL _enableLargeProfileCell;
	BOOL _enableProfilePicEdit;
	BOOL _enableCardContextItems;

}

@property (nonatomic,readonly) BOOL enableLargeProfileCell;              //@synthesize enableLargeProfileCell=_enableLargeProfileCell - In the implementation block
