...
@interface FBInspirationCameraNavigationBarComponent : CKCompositeComponent {

	id<FBCameraGenericEvent> _closeEvent;
	id<FBCameraGenericEvent> _switchCameraEvent;

}
+(id)newWithTopInset:(double)arg1 closeEvent:(id)arg2 switchCameraEvent:(id)arg3 session:(id)arg4 ;
