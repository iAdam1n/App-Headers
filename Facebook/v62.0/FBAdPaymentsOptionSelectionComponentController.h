...
@class FBUserSession, FBAdPaymentsEditableOptionView, NSString;

@interface FBAdPaymentsOptionSelectionComponentController : NSObject <FBAdPaymentsMountComponentController> {
...
-(id)initWithSession:(id)arg1 componentIdentifier:(id)arg2 optionText:(id)arg3 ;
-(void)activateSelection:(BOOL)arg1 ;
