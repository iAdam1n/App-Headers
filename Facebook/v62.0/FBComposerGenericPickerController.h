...
-(id)initWithUserSession:(id)arg1 updateHandler:(id)arg2 initialStateBlock:(/*^block*/id)arg3 listComponentBlock:(/*^block*/id)arg4 navigationBarBlock:(/*^block*/id)arg5 resultHandler:(/*^block*/id)arg6 analyticsModule:(id)arg7 toolbox:(id)arg8 ;
@end
