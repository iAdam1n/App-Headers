...
@interface FBReactionPageCommerceAttachmentComponent : CKCompositeComponent <FBReactionAttachmentsComponent> {
...
-(void)didSelectProduct:(id)arg1 withContext:(id)arg2 ;
@end
