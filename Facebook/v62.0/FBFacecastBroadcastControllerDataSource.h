...
@protocol FBFacecastBroadcastControllerDataSource <NSObject>
@optional
-(id)facecastBroadcastControllerAudioDataOutput:(id)arg1;
-(id)facecastBroadcastControllerVideoDataOutput:(id)arg1;
