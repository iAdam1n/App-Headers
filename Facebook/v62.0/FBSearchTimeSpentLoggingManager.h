...
@class FBUserSession, NSMutableDictionary, NSDictionary, NSString;

@interface FBSearchTimeSpentLoggingManager : NSObject <FBSearchResultsLogEventListener> {

	FBUserSession* _session;
	NSMutableDictionary* _analyticsSourceExtras;

}

@property (nonatomic,copy,readonly) NSDictionary * analyticsSourceExtras; 
@property (readonly) unsigned long long hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
-(NSDictionary *)analyticsSourceExtras;
