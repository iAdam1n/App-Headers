...
@class FBUserSession, NSMutableSet, NSMapTable, FBListFooterView, FBAnimationPerformanceLogger, FBPostingController, FBAutoScroller, FBFullscreenErrorView, FBFeedViewComposerOpenHandlerAttributes, FBTimelineFeedView, FBFeedBannerPresenter, FBFeedNetworkErrorBanner, FBFeedViewComposerOpenHandler, NSString, FBFeedSpinnerLoggingController, FBSideFeedLayoutManager, FBScenePath, FBStoryStreamViewControllerConfiguration, FBFeedTableViewDataSource;

@interface FBStoryMultiStreamViewController : UIViewController <FBFeedNetworkErrorBannerDelegate, FBFullScreenErrorViewDelegate, FBOneRowDataSourceListener, FBPresentableViewController, FBReachabilityListener, FBPostingControllerDelegate, FBFeedScrollingDelegate, FBContentRectProviding, UITableViewDelegate, UIScrollViewDelegate, FBTimelineFeedViewDelegate, FBScrollPositionRestoringTableViewRowIdentifierProvider, FBScrollPositionRestoringCollectionViewItemIdentifierProvider, FBStoryStreamFullscreenErrorViewInterface, FBComposerFlowDelegate, FBStreamListener, FBGraphQLConnectionControllerLoadListener, FBGraphQLConnectionControllerNetworkListener, FBFeedTableViewDataSourceDelegate, FBPullToRefreshViewDelegate, FBPopoverControllerDelegate, FBSegmentedTitleViewDelegate, UIActionSheetDelegate, FBScrolling, FBTableViewDataSourceDelegateTransitioning, FBBookmarkIdentifying> {
