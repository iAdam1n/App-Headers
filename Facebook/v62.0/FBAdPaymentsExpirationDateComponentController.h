...
@class FBPaymentsFormExpirationDateInputHandler;

@interface FBAdPaymentsExpirationDateComponentController : FBAdPaymentsFormComponentController {

	FBPaymentsFormExpirationDateInputHandler* _textInputHandler;
