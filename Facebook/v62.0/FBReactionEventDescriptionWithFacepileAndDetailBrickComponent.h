...
@class FBReactionEventDescriptionWithFacepileAndDetailBrickComponentConfig;

@interface FBReactionEventDescriptionWithFacepileAndDetailBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {

	id<FBReactionAction> _action;
	FBReactionEventDescriptionWithFacepileAndDetailBrickComponentConfig* _config;
