...
@class FBReactionEventDescriptionWithFacepileBrickComponentConfig;

@interface FBReactionEventDescriptionWithFacepileBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {

	id<FBReactionAction> _action;
	FBReactionEventDescriptionWithFacepileBrickComponentConfig* _config;
