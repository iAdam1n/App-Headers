...
@interface FBComposerMoviesPublishingListener : NSObject <FBComposerPublisherStatusListener> {
...
-(BOOL)_shouldLogPublishingEventsWithData:(id)arg1 ;
-(id)_descriptionForPublicationError:(id)arg1 ;
