...
#import <Facebook/FBComposerFeedTopicPickerViewControllerDelegate.h>
...
@class FBComposerCompositionState, FBUserSession, FBComposerFeedTopicPickerViewController, NSString;

@interface FBComposerFeedTopicPickerController : NSObject <FBComposerFeedTopicPickerViewControllerDelegate, FBComposerPickerController, FBComposerCompositionStateChangedListener> {

	FBComposerCompositionState* _compositionState;
	id<FBComposerUpdateHandler> _updateHandler;
	FBUserSession* _userSession;
	FBComposerFeedTopicPickerViewController* _viewController;
