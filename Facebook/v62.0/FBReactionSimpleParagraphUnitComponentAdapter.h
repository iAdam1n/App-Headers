...
@class FBReactionSimpleParagraphUnitComponentView, FBMemModelObject, FBReactionContext, UITapGestureRecognizer, NSString;

@interface FBReactionSimpleParagraphUnitComponentAdapter : FBReactionBaseUnitComponentAdapter {

	FBReactionSimpleParagraphUnitComponentView* _componentView;
