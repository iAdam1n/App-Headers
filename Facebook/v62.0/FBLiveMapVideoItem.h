...
@class NSSet, FBFeedToolbox, FBImageDownloader, FBScenePath;
...
@property (nonatomic,copy,readonly) NSSet * annotations;                         //@synthesize annotations=_annotations - In the implementation block
...
-(id)initWithAnnotations:(id)arg1 imageDownloader:(id)arg2 scenePath:(id)arg3 toolbox:(id)arg4 ;
