...
@class FBComposerViewToolbox, FBComposerMarketplaceCrossPostSetting, NSString;

@interface FBComposerGroupCommercePostToMarketplaceComponent : CKCompositeComponent {

	FBComposerViewToolbox* _toolbox;
	FBComposerMarketplaceCrossPostSetting* _marketplaceCrossPostSetting;
	BOOL _shouldShowToggle;
	BOOL _postToMarketplaceState;
	NSString* _groupID;
