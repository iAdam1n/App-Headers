...
#import <Facebook/FBAudioSessionClientProvider.h>
#import <Facebook/FBVideoAudioSessionManagerDelegate.h>
#import <Facebook/FBPlayerItemBuilder.h>
...
@class FBVideoPlaybackItem, FBMultiresolutionImageNode, FBVideoAudioMeterNode, FBVideoPlaybackController, ASDisplayNode, NSTimer, FBUserSession, NSString;
...
@interface FBVideoNode : ASDisplayNode <FBVideoPlaybackEventListener, FBAudioSessionClientProvider, FBVideoAudioSessionManagerDelegate, FBPlayerItemBuilder, FBMultiresolutionImageNodeDelegate, UIGestureRecognizerDelegate> {
	...
	FBVideoAudioMeterNode* _audioMeter;
...
-(void)_updateAudioMeterVisibility;
-(void)_stopStallTimer;
-(void)_stopCrossFade;
-(void)_hideAudioMeter;
...
-(void)_showAudioMeter;
-(void)_animateAudioMeterAlphaTo:(double)arg1 completion:(/*^block*/id)arg2 ;
-(BOOL)_wants360;
