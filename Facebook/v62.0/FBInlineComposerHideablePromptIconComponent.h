...
@class FBWebImageComponent;

@interface FBInlineComposerHideablePromptIconComponent : CKCompositeComponent {

	long long _state;
	FBWebImageComponent* _imageComponent;

}
+(id)newWithImageSpecifier:(id)arg1 state:(long long)arg2 session:(id)arg3 size:(const CKComponentSize*)arg4 attributes:(const unordered_map<CKComponentViewAttribute, CKBoxedValue, std::__1::hash<CKComponentViewAttribute>, std::__1::equal_to<CKComponentViewAttribute>, std::__1::allocator<std::__1::pair<const CKComponentViewAttribute, CKBoxedValue> > >*)arg5 ;
