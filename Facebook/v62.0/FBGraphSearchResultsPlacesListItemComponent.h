...
@interface FBGraphSearchResultsPlacesListItemComponent : CKCompositeComponent {
...
+(id)newWithResultEdgeModel:(id)arg1 displaySocialContent:(BOOL)arg2 context:(id)arg3 ;
