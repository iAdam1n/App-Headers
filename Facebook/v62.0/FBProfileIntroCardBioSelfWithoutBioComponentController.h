...
@interface FBProfileIntroCardBioSelfWithoutBioComponentController : CKComponentController <FBComponentControllerWorkingRangeListenerProviding, FBComponentControllerWorkingRangeListening> {
...
-(void)didTapSuggestedBio:(id)arg1 ;
-(void)didTapCrossButton:(id)arg1 ;
-(void)didTapAddBio:(id)arg1 ;
-(id)theComponent;
-(void)_editIntroCardBioWithSuggestedBio:(BOOL)arg1 ;
