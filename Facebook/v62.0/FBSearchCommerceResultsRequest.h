...
-(id)initWithTargetID:(id)arg1 callbackPerformer:(id)arg2 callSite:(unsigned long long)arg3 typeaheadSessionID:(id)arg4 querySource:(id)arg5 supportedRoles:(id)arg6 count:(unsigned long long)arg7 ;
-(id)description;
@end
