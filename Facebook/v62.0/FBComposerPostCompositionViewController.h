...
@class UIView, FBComposerPostCompositionNavigationBar, FBComposerPostCompositionExperimentContext, UIScrollView, CKComponentHostingView, FBComposerPostCompositionSheet, FBComposerPostCompositionComponentToolbox, FBComposerPostCompositionTransitionManager, FBUserSession, NSString;
