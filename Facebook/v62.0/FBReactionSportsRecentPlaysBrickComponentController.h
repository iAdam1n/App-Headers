...
@class FBSportsPlayByPlaySubscriptionHandler, NSString;

@interface FBReactionSportsRecentPlaysBrickComponentController : CKComponentController <FBSportsPlayByPlaySubscriptionHandlerDelegate> {

	FBSportsPlayByPlaySubscriptionHandler* _subHandler;
