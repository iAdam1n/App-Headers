...
@interface FBVideoChannelPlaylistComponentProvider : NSObject <CKComponentProvider, CKComponentSizeRangeProviding> {

	CKSizeRange _cellSizeRange;
...
-(id)initWithCellSizeRange:(CKSizeRange)arg1 ;
@end
