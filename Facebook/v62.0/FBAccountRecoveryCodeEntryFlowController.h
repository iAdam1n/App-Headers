...
#import <Facebook/FBAccountRecoveryCodeEntryFlowControlling.h>
...
@class FBAccountRecoveryFlowData, FBAccountRecoveryCodeEntryController, FBAccountRecoveryOtherSessionsFlowController, NSString;
...
@interface FBAccountRecoveryCodeEntryFlowController : NSObject <FBAccountRecoveryCodeEntryFlowControlling, FBAuthRecoveryControllingDelegate, FBAuthRecoveryControlling> {
	...
	FBAccountRecoveryCodeEntryController* _controller;
