...
@class FBLeadGenCountryPickerComponent, NSString;

@interface FBLeadGenCountryPickerComponentController : CKComponentController <FBPhoneCountryCodesPickerViewControllerDelegate>

@property (nonatomic,__weak,readonly) FBLeadGenCountryPickerComponent * component; 
