...
@class FBIntentTarget, FBFeedToolbox, FBAnalyticsInfo, FBMemStoryAttachment;

@interface FBCommerceProductItemSinglePhotoAttachmentComponent : CKCompositeComponent {
