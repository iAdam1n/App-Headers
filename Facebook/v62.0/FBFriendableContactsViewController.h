...
@class FBUserSession, FBFriendableContactsDataSource, NSString;

@interface FBFriendableContactsViewController : UIViewController <FBFriendCenterItem, FBFriendableContactsDataSourceDelegate> {
...
-(void)didFinishLoadingFriendableContacts:(id)arg1 ;
