...
@class FBUserSession, FBEventBuyTicketExternalPartnerModel, FBPaymentsPaymentMethodsCoordinator, FBPaymentsPINController, FBPaymentsTouchIDController, NSString;
...
-(id)initWithSession:(id)arg1 model:(id)arg2 pinController:(id)arg3 touchIDController:(id)arg4 ;
