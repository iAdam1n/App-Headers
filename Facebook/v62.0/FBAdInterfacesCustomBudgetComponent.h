...
+(id)newWithBudget:(id)arg1 minimumBudget:(id)arg2 maximumBudget:(id)arg3 baseBudgetValue:(unsigned long long)arg4 invalidEstimates:(BOOL)arg5 selected:(BOOL)arg6 valueChangeAction:(SEL)arg7 commitAction:(SEL)arg8 ;
+(id)initialState;
