...
#import <Facebook/FBNewCustomNavigationController.h>
#import <UIKit/UIPopoverControllerDelegate.h>
#import <Facebook/FBMovableNavigationBarViewControllerDelegate.h>
#import <Facebook/FBNavigationBarLayoutDelegate.h>
#import <Facebook/FBNavigationControllerInternal_DEPRECATED.h>
#import <Facebook/FBPopoverOverlayDelegate.h>
#import <Facebook/FBNavigationController_DEPRECATED.h>

@protocol FBNavigationBarDecorating;
@class NSMutableDictionary, UIPopoverController, FBNavigationBar, FBNavigationBarQueue, FBUserSession, NSMapTable, FBNavigationFakePushExecutor, UIViewController, UISearchDisplayController, NSString, FBJewelController, UINavigationBar;
...
-(id)initWithSession:(id)arg1 rootViewController:(id)arg2 navigationBarClass:(Class)arg3 movableNavigationBarEnabled:(BOOL)arg4 ;
-(id)initWithSession:(id)arg1 rootViewController:(id)arg2 externalNavigationBarClass:(Class)arg3 movableNavigationBarEnabled:(BOOL)arg4 ;
-(id)initWithSession:(id)arg1 navigationBarClass:(Class)arg2 toolbarClass:(Class)arg3 movableNavigationBarEnabled:(BOOL)arg4 ;
-(id)initWithSession:(id)arg1 rootViewController:(id)arg2 movableNavigationBarEnabled:(BOOL)arg3 ;
-(BOOL)hasInitialized;
