...
@class FBMemModelObject, UIView, FBMemLocation;

@interface FBReactionLargeMapUnitComponentAdapter : FBReactionBaseUnitComponentAdapter {
	...
	FBMemLocation* _annotationLocation;
