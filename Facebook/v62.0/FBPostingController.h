...
@protocol FBCompositionModelBundleCache, FBCompositionOwnershipTracker, FBPostingControllerDelegate;
@class FBPublisherManager, FBUserSession, FBComposerPublisherStatusEventFilter, NSMutableDictionary, NSString;

@interface FBPostingController : NSObject <FBComposerPublisherStatusListener, FBPublishingDataServerProcessingListener> {
...
-(id)initWithSession:(id)arg1 offlinePostingEnabled:(BOOL)arg2 compositionOwnershipTracker:(id)arg3 delegate:(id)arg4 ;
...
-(void)_didFinishLookupWithModelBundle:(id)arg1 publisherData:(id)arg2 response:(id)arg3 ;
-(void)dealloc;
@end
