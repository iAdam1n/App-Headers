...
+(id)initCommerceProductDetailsViewControllerWithSession:(id)arg1 productID:(id)arg2 attachmentID:(id)arg3 refID:(id)arg4 refType:(id)arg5 shouldUsePDPLite:(BOOL)arg6 ;
