...
@class FBPaymentsFormCardSecurityCodeInputHandler;

@interface FBAdPaymentsSecurityCodeComponentController : FBAdPaymentsFormComponentController {

	FBPaymentsFormCardSecurityCodeInputHandler* _textInputHandler;
