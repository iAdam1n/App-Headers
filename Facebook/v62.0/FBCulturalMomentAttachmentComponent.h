...
@class FBMemStoryAttachment, FBFeedToolbox, NSString;

@interface FBCulturalMomentAttachmentComponent : CKCompositeComponent <FBStoryAttachmentRenderingComponent> {
