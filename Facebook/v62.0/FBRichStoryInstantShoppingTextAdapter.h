...
@class FBMemInstantShoppingDocumentTextElement, FBRichStoryTextBlock, NSString;

@interface FBRichStoryInstantShoppingTextAdapter : NSObject <FBViewModelAdapter> {
