...
@class FBUserSession, FBProfileToolbox, FBProfileWizardStatusUpdateContentView, FBFeedInlineComposerController, UIView;
...
-(id)initWithWizardModel:(id)arg1 currentStepIndex:(unsigned long long)arg2 session:(id)arg3 feedInlineComposerController:(id)arg4 toolbox:(id)arg5 ;
