...
@property (nonatomic,copy,readonly) FBCharity * charity;                              //@synthesize charity=_charity - In the implementation block
...
-(id)initWithCharity:(id)arg1 coverPhoto:(id)arg2 title:(id)arg3 descriptionText:(id)arg4 endDate:(id)arg5 hasEndDate:(BOOL)arg6 goalAmount:(id)arg7 ;
