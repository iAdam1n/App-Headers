...
@interface FBTopicFeedsComposerLifecycleLogger : NSObject <FBComposerLifecycleListener> {

	NSArray* _bootstrappedTopicIDs;
...
-(void)_postComposedWithCompositionState:(id)arg1 ;
@end
