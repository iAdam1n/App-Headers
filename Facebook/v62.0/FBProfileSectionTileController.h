...
#import <Facebook/FBProfileSectionProtileController.h>

@protocol FBSectionedDataSourceWriting;
@class FBProtileItemsDownloader, FBUserSession, NSString;

@interface FBProfileSectionTileController : NSObject <FBProtileItemsDownloaderDelegate, FBProfileSectionController, FBProfileSectionProtileController> {
