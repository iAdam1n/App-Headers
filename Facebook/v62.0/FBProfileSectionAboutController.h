...
@interface FBProfileSectionAboutController : NSObject <FBProfileSectionController> {
...
-(void)configureWithPerson:(id)arg1 isViewingSelf:(BOOL)arg2 ;
-(id)initWithUniqueIdentifier:(id)arg1 writeInterface:(id)arg2 shouldShowExpandingButton:(BOOL)arg3 ;
