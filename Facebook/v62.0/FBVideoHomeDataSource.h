...
#import <Facebook/FBVideoHomeDataSourceListenerUnitManager.h>
...
@interface FBVideoHomeDataSource : NSObject <FBVideoHomeDataSourceListenerSubscriptionManager, FBVideoHomeDataSourceListenerUnitManager> {
...
-(id)updatedUnitWithUnitID:(id)arg1 ;
