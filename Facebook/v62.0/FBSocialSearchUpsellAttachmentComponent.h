...
@class FBMemFeedStory, FBFeedToolbox, FBMemPlaceRecommendationPostInfo, NSString;

@interface FBSocialSearchUpsellAttachmentComponent : CKCompositeComponent <FBStoryAttachmentRenderingComponent> {

	FBMemFeedStory* _parentStory;
	FBFeedToolbox* _toolbox;
	FBMemPlaceRecommendationPostInfo* _placeRecInfo;
