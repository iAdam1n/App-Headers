...
@class FBUFICommentBodyComponentState, FBTextWithEntitiesComponent;
...
@interface FBUFICommentBodyComponent : CKCompositeComponent {
	...
	SEL _didTapSeeMoreAction;

}
+(id)newWithComment:(id)arg1 style:(FBUFICommentBodyComponentStyle)arg2 toolbox:(id)arg3 ;
+(id)initialState;
