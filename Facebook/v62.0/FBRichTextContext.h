...
@property (assign,nonatomic) SCD_Struct_FB80 visibleRange;                                        //@synthesize visibleRange=_visibleRange - In the implementation block
...
-(void)enumerateTextFragmentsForTextRange:(SCD_Struct_FB80)arg1 usingBlock:(/*^block*/id)arg2 ;
...
-(void)_enumerateTextForTextRange:(SCD_Struct_FB80)arg1 measureOption:(unsigned long long)arg2 usingTextFragmentBlock:(/*^block*/id)arg3 textFragmentRunBlock:(/*^block*/id)arg4 ;
...
-(void)enumerateTextFragmentsForTextRange:(SCD_Struct_FB80)arg1 measureOption:(unsigned long long)arg2 usingBlock:(/*^block*/id)arg3 ;
-(void)enumerateTextRunsForTextRange:(SCD_Struct_FB80)arg1 usingBlock:(/*^block*/id)arg2 ;
...
-(void)setVisibleRange:(SCD_Struct_FB80)arg1 ;
-(SCD_Struct_FB80)visibleRange;
@end
