...
#import <Facebook/FBPhotoViewerBaseHeaderView.h>
#import <UIKit/UIToolbarDelegate.h>

@class UIToolbar, NSString;

@interface FBPhotoViewerLightThemedHeaderView : FBPhotoViewerBaseHeaderView <UIToolbarDelegate> {
