...
@property (assign,nonatomic) SCD_Struct_FB257 frameOffset;                                   //@synthesize frameOffset=_frameOffset - In the implementation block
...
-(void)setFrameOffset:(SCD_Struct_FB257)arg1 ;
