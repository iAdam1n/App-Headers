...
@class FBIntentTarget, FBAnalyticsInfo, FBFeedToolbox, FBMemFeedStory, NSString;

@interface FBVideoShareAttachmentComponent : CKCompositeComponent <FBForceTouchIntentProvider, FBStoryAttachmentRenderingComponent> {
...
+(id)supportedStyles;
+(void)setWillShowVideoAttachmentInline:(BOOL)arg1 ;
