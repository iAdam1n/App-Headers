...
@protocol FBVideoFromViewDelegate, FBVideoPlaylistPlayerDataSource, FBVideoPlaylistPlayerDelegate, FBDisplayableMediaTransitioningDelegate, FBFullScreenVideoViewControlling;
@class FBVideoPlayerFromMediaProvider, FBVideoPlayerComponentStatefulView, FBVideoViewManager, FBMediaUFIBarController, FBMemVideo, FBDisplayableMediaTransitionManager, FBVideoChannelFeedToolbox, UIScrollView, FBVideoChannelFullscreenSwipeableNuxController, UIPageViewController, NSMapTable, FBVideoChannelFeedExperimentContext, UIViewController, NSString;
...
-(id)initWithDelegate:(id)arg1 dataSource:(id)arg2 fromViewDelegate:(id)arg3 config:(SCD_Struct_FB139)arg4 didDismissBlock:(/*^block*/id)arg5 configureVideoFullscreenControllerBlock:(/*^block*/id)arg6 toolbox:(id)arg7 ;
