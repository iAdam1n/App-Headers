...
@interface FBProfileSectionIntroCardMegaphoneController : NSObject <FBProfileSectionController> {
...
-(void)showIntroCardMegaphoneWithPerson:(id)arg1 megaphonePresenter:(id)arg2 ;
-(void)hideIntroCardMegaphone;
