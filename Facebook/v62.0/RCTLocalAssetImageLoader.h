...
-(/*^block*/id)loadImageForURL:(id)arg1 size:(CGSize)arg2 scale:(double)arg3 resizeMode:(long long)arg4 progressHandler:(/*^block*/id)arg5 completionHandler:(/*^block*/id)arg6 ;
