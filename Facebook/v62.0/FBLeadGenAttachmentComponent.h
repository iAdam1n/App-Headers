...
@class FBMemLeadGenActionLink, FBFeedToolbox, FBAnalyticsInfo, FBMemStoryAttachment, NSString;
...
@property (nonatomic,readonly) FBMemLeadGenActionLink * actionLink;              //@synthesize actionLink=_actionLink - In the implementation block
...
-(FBMemLeadGenActionLink *)actionLink;
