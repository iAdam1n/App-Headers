...
@class FBNetworkerRequest, FBUserSession, FBGraphQLMutationHandle, NSString;

@interface FBComposerGoodwillFriendversaryCardRequestSender : NSObject <FBNetworkerRequestDelegate, FBPublishingRequestSender> {

	FBNetworkerRequest* _goodwillFriendversaryCardRequest;
...
-(void)_mutationDidSucceed;
-(void)_mutationDidFail:(id)arg1 ;
