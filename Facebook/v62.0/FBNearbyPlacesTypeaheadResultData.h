...
-(id)initWithSearchQuery:(id)arg1 latitude:(double)arg2 longitude:(double)arg3 cacheMeters:(unsigned long long)arg4 places:(id)arg5 topics:(id)arg6 querySuggestions:(id)arg7 searchSessionID:(id)arg8 ;
