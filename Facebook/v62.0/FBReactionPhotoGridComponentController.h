...
@interface FBReactionPhotoGridComponentController : CKComponentController <FBPhotoDisplayingComponentPhotoViewProviderDelegate>
...
-(unsigned long long)_indexOfPhoto:(id)arg1 ;
