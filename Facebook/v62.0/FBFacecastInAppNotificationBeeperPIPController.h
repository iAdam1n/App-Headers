...
@protocol FBFacecastInAppNotificationBeeperPIPControllerDelegate, FBCancelable, FBNotificationDataModel;
@class FBUserSession, FBMemFeedStory, FBMemVideo, FBFeedToolbox, FBTimer, FBVideoPIPController, FBVideoDisplayController, FBVideoPlayerComponentStatefulView, FBFacecastInAppNotificationStoryPreviewPlugin, NSString;
...
+(id)sharedInstance;
-(void)_queryStoryWithVideoID:(id)arg1 ;
-(void)startPIP;
...
-(void)startPIPWithSession:(id)arg1 videoID:(id)arg2 notification:(id)arg3 navigationCoordinator:(id)arg4 intentHandler:(id)arg5 delegate:(id)arg6 ;
-(void)dealloc;
