...
#import <Facebook/NTAugmentsDefaultModel.h>

@class NSDictionary, FBNativeTemplateContext, NSString;

@interface FBNativeTemplateCachedTemplateComponent : NTNativeTemplateComponent <NTHasComponentAttributes, NTAugmentsDefaultModel> {
...
+(BOOL)hasAugmentedModel:(id)arg1 ;
+(void)augmentNativeTemplateModel:(id)arg1 context:(id)arg2 processingBlock:(/*^block*/id)arg3 ;
