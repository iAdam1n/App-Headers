...
@class FBUserSession, FBPageActionHandlerToolbox, FBPagesReviewComposerController, FBMemPage, NSString;

@interface FBPageReviewActionHandler : NSObject <FBPagesReviewComposerControllerDelegate, FBPageActionHandling> {
