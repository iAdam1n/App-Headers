...
@class FBComposerPublisherStatusEventFilter, NSString;

@interface FBCommentComposerResharePostUpsellComponentController : CKComponentController <FBComposerFlowDelegate, FBComposerPublisherStatusListener> {

	FBComposerPublisherStatusEventFilter* _composerPublisherStatusEventFilter;
	BOOL _publishingShareNow;
