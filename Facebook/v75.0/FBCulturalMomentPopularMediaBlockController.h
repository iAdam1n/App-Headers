...
@class FBRichStoryBlock, FBCulturalMomentPopularMediaNode, FBInstantShoppingDisplayContext, NSString;

@interface FBCulturalMomentPopularMediaBlockController : FBBackgroundDeallocatedObject <FBRichStoryBlockController> {

	FBRichStoryBlock* _storyBlock;
	FBCulturalMomentPopularMediaNode* _node;
