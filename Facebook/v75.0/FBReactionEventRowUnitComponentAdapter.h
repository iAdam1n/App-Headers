...
@protocol FBQueriedReactionUnitFieldsProtocol, FBQueriedReactionUnitComponentFieldsProtocol, FBReactionActionAdapter;
@class FBMemModelObject, UIView, FBReactionContext, CKComponentHostingView, UIControl, FBConsistentLookasideCacheObservationHandle;

@interface FBReactionEventRowUnitComponentAdapter : FBReactionBaseUnitComponentAdapter {
