...
@property (nonatomic,readonly) FBFriendCenterFriendsSearchBarListenerAnnouncer * searchTermAnnouncer;              //@synthesize searchTermAnnouncer=_searchTermAnnouncer - In the implementation block
+(id)newWithAnnouncer:(id)arg1 fetchStatusListener:(id)arg2 toolbox:(id)arg3 ;
+(id)initialState;
-(FBFriendCenterFriendsSearchBarListenerAnnouncer *)searchTermAnnouncer;
@end
