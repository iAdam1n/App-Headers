...
@interface _FBReplySectionComponentViewComponentContext : NSObject {
...
+(id)newWithComponentActionAnnouncer:(id)arg1 cellStyle:(id)arg2 inlineReplyExpansionOptions:(id)arg3 replyLayoutDefinition:(id)arg4 vpvLoggingWorkingRangeListenerProvider:(/*^block*/id)arg5 ufiToolbox:(id)arg6 componentEditAnnouncer:(id)arg7 commentEditingDependencyProviders:(FBCommentEditingDependencyProviders)arg8 ;
