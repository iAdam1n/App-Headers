...
#import <Facebook/FBConfirmationToastViewControllerDelegate.h>
#import <Facebook/FBFacecastViewerMenuSharingHandler.h>

@protocol FBNavigationCoordinator;
@class FBUserSession, NSString, FBComposerTraits, FBPublisherManager, NSMutableSet, NSArray, FBFacecastLogger;

@interface FBFacecastViewerMenuSharer : NSObject <FBComposerFlowDelegate, FBComposerPublisherStatusListener, FBConfirmationToastViewControllerDelegate, FBFacecastViewerMenuSharingHandler> {
	...
	NSMutableSet* _composerSessionIDsForPendingPublications;
...
-(id)initWithSession:(id)arg1 videoID:(id)arg2 navigationCoordinator:(id)arg3 trackingCodes:(id)arg4 analyticsModule:(id)arg5 ;
-(void)_showConfirmationToast;
-(void)_didCompletePublishing;
-(void)confirmationToastViewDidDismiss:(id)arg1 ;
-(void)openComposerWithSharable:(id)arg1 avatar:(id)arg2 contentOrigin:(id)arg3 ;
@end
