...
@protocol FBNavigationCoordinator, FBQueriedVideoChannelFieldsProtocol;
@class FBMemModelObject;

@interface FBVideoCreatorChannelReactionBrickSectionComponent : CKCompositeComponent <FBReactionBrickComponent, FBHScrollImpressionLogging> {
