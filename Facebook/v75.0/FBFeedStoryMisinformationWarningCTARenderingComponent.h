...
@class NSString, FBFeedToolbox, FBAnalyticsInfo, UIViewController, FBMemMisinformationWarningActionLink;

@interface FBFeedStoryMisinformationWarningCTARenderingComponent : CKCompositeComponent <FBFeedStoryAttachmentCTARenderingComponent> {

	NSString* _urlString;
	FBFeedToolbox* _toolbox;
	FBAnalyticsInfo* _analyticsInfo;
	UIViewController* _actionSheetController;
	FBMemMisinformationWarningActionLink* _actionLink;
