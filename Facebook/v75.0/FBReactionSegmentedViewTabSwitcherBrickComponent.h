...
@class CKComponent, FBReactionContext, FBMemModelObject;

@interface FBReactionSegmentedViewTabSwitcherBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {

	CKComponent* _segmentedViewComponent;
