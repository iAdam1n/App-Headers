...
@class FBMemModelObject, NSString, FBFeedSecondaryActionContext;

@interface FBFeedUnFollowVideosAction : NSObject <FBFeedSecondaryAction> {
...
-(id)initWithVideoChannel:(id)arg1 videoID:(id)arg2 context:(id)arg3 ;
