...
#import <Facebook/FBAdPaymentsGraphRequestLogger.h>

@interface FBAdPaymentsSelectPaymentMethodsFlowLogger : FBAdPaymentsGraphRequestLogger {

	BOOL _isFirstBrazilInitiated;
	BOOL _isFirstSelectPaymentMethodInitiated;
