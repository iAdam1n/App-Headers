...
@interface FBGraphQLConnectionControllerAnnouncementForwarder : NSObject <FBGraphQLConnectionControllerListener> {
...
-(void)startListeningToConnectionController:(id)arg1 ;
@end
