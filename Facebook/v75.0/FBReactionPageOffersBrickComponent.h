...
@class FBReactionContext, FBReactionPageSeeOfferDetailsActionAdapter;

@interface FBReactionPageOffersBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {

	FBReactionContext* _reactionContext;
	FBReactionPageSeeOfferDetailsActionAdapter* _actionAdapter;
