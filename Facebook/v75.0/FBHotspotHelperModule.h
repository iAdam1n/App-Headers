...
@interface FBHotspotHelperModule : NSObject <FBMenuItemConfiguringModule, FBAppServiceConfiguringModule, FBURLSegueConfiguringModule, FBNuxPresenterConfiguringModule>
