...
@interface FBVerveAdPromotionCardVideoComponent : CKCompositeComponent {
...
+(id)newWithMedia:(const FBVerveAdPromotionCardVideoComponentGraphQL*)arg1 tapAction:(CKTypedComponentAction<>)arg2 toolbox:(id)arg3 ;
