...
@interface FBBirthdayTodayCellTextFieldComponentController : CKComponentController <FBComposerPublisherStatusListener> {
...
-(void)postBirthdayMessage;
-(void)retryPostingWithPublisherData:(id)arg1 ;
@end
