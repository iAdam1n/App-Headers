...
@class FBUserSession, FBRichStoryAnnotationBlock, FBISOverlayImageNode, NSString;

@interface FBRichStoryImageAnnotationController : NSObject <FBRichStoryBlockController> {

	FBUserSession* _session;
	FBRichStoryAnnotationBlock* _annotationBlock;
	FBISOverlayImageNode* _overlayNode;
...
-(id)initWithAnnotationBlock:(id)arg1 presentationAttributes:(id)arg2 session:(id)arg3 displayContext:(id)arg4 ;
@end
