...
@class CSRefImplementation;

@interface CSRefComponent : CKCompositeComponent {

	CSRefImplementation* _refImplementation;

}
+(id)newWithComponent:(id)arg1 refImplementation:(id)arg2 ;
