...
@interface FBReactionEventDescriptionBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {
...
+(double)sidePaddingForRenderIdiom:(unsigned long long)arg1 noAdditionalSidePadding:(BOOL)arg2 ;
