...
@class FBAnalyticsInfo, FBFeedToolbox, NSString;

@interface FBNoteAttachmentComponent : CKCompositeComponent <FBStoryAttachmentRenderingFragmentComponent> {
...
@property (nonatomic,readonly) Target* note;                                 //@synthesize note=_note - In the implementation block
...
+(id)newWithAttachment:(const FBNoteAttachmentComponentGraphQL*)arg1 options:(const FBStoryAttachmentRenderingComponentOptions*)arg2 toolbox:(id)arg3 ;
+(id)supportedStyles;
