...
@class FBUserSession, FBFNTopFriendsSharingDataController, FBLocationServicesAlwaysNUXViewController, NSString, NSArray, NSDictionary;

@interface FBLocationServicesAlwaysNUXPresenter : NSObject <FBNuxPresenter> {

	FBUserSession* _session;
	FBFNTopFriendsSharingDataController* _dataController;
	FBLocationServicesAlwaysNUXViewController* _nuxController;
