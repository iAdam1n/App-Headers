...
@class FBPageMegaphoneModel, FBMemPageMegaphoneCardController;

@interface FBPageMegaphoneComponent : CKCompositeComponent {

	FBPageMegaphoneModel* _model;
	FBMemPageMegaphoneCardController* _megaphoneCardController;
...
-(void)_hideMegaphone:(id)arg1 ;
-(void)_openMegaphoneActionURI:(id)arg1 ;
