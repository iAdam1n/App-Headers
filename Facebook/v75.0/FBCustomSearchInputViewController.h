...
@protocol FBSearchTextFieldProtocol, FBCustomSearchViewControllerProtocol, FBGraphSearchContentViewController;
@class FBSearchContext, UIView, FBKeyboardObserver, NSArray, FBKeyCommandHandler, FBGraphSearchTextInputBar, FBUserSession, NSString, NSNumber, UIViewController, CKComponentHostingView, FBGraphSearchInputManager, FBSearchTypeaheadSessionStatus, FBSearchTypeaheadViewController;
