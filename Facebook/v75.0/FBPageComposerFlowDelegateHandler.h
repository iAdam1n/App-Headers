...
@class FBUserSession, FBPublishingCompletionEventForwarder, NSString;

@interface FBPageComposerFlowDelegateHandler : NSObject <FBComposerFlowDelegate, FBPublishingCompletionEventListener> {
