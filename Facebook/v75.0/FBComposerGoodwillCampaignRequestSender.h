...
@interface FBComposerGoodwillCampaignRequestSender : NSObject <FBNetworkerRequestDelegate, FBPublishingRequestSender> {

	FBNetworkerRequest* _goodwillCampaignRequest;
