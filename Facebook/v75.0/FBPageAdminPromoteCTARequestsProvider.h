...
@interface FBPageAdminPromoteCTARequestsProvider : NSObject <FBAdInterfacesPromotionRequestsProviderProtocol> {
...
-(id)initWithBoostedComponentApp:(id)arg1 ;
...
-(id)_parseCTACreativeFromDefaultSpec:(id)arg1 page:(id)arg2 ;
-(id)initializationQueryWithPromotableObjectID:(id)arg1 audience:(id)arg2 pageID:(id)arg3 ;
@end
