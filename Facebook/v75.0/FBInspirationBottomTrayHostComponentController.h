...
#import <Facebook/FBInspirationBottomTraySwipeListener.h>

@class NSString;

@interface FBInspirationBottomTrayHostComponentController : CKComponentController <FBInspirationBottomTraySwipeListener> {
