...
@protocol FBPinnedConversationsViewerMostRecentPostTrackerListener;
@class FBUserSession, NSDate, FBMemFeedStory, NSString;

@interface FBPinnedConversationsViewerMostRecentPostTracker : NSObject <FBComposerPublisherStatusListener> {

	FBUserSession* _session;
	id<FBPinnedConversationsViewerMostRecentPostTrackerListener> _listener;
	NSDate* _manuallyPinnedPostDate;
	FBMemFeedStory* _viewerMostRecentPost;

}

@property (nonatomic,readonly) FBMemFeedStory * viewerMostRecentPost;              //@synthesize viewerMostRecentPost=_viewerMostRecentPost - In the implementation block
...
-(void)viewerDidPinPost:(id)arg1 ;
-(void)checkForNewPosts;
-(void)setManuallyPinnedPost:(id)arg1 pinnedTime:(id)arg2 ;
-(void)cacheDataForStory:(id)arg1 pinnedTime:(id)arg2 ;
-(void)setViewerMostRecentPost:(FBMemFeedStory *)arg1 ;
-(void)updateCachedFeedbackForViewerMostRecentPost:(id)arg1 ;
-(FBMemFeedStory *)viewerMostRecentPost;
-(void)dealloc;
@end
