...
@class FBFeedToolbox, FBMemGoodwillThrowbackPromotionFeedUnit, FBStoryShareHandler;

@interface FBGoodwillThrowbackPromotionFeedUnitNTComponent : CKCompositeComponent {
