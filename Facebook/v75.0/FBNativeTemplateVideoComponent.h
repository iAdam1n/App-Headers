...
@class NSDictionary, FBFullscreenEnabledVideoPlayerComponent, FBNativeTemplateContext, NSString;

@interface FBNativeTemplateVideoComponent : NTNativeTemplateComponent <NTHasGraphQL, NTHasComponentAttributes, NTHasTriggerableIntrinsicAction> {
