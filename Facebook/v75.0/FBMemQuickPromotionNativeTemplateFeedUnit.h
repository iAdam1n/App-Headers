...
#import <Facebook/FBQueriedNativeTemplateFeedObjectFieldsProtocol.h>

@class NSString;

@interface FBMemQuickPromotionNativeTemplateFeedUnit : FBWildeMemModelObject <FBHideable, FBQueriedFeedUnitFieldsProtocol, FBQueriedNativeTemplateFeedObjectFieldsProtocol>
