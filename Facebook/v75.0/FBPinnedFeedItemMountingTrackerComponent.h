...
@protocol FBPinnedFeedItemMountingTracker;
@interface FBPinnedFeedItemMountingTrackerComponent : CKCompositeComponent {
...
+(id)newWithComponent:(id)arg1 mountingTracker:(id)arg2 ;
