...
@protocol FBFeedOutboxListRowUpdater;
@class NSMutableArray, FBFeedComposerDataAdaptor, FBFeedToolbox, NSString;

@interface FBFeedOutboxListUpdater : NSObject <FBFeedComposerDataAdaptorDelegate, FBFeedOutboxListLifecycleListener> {
...
-(id)initWithRowUpdater:(id)arg1 dataAdaptor:(id)arg2 toolbox:(id)arg3 ;
