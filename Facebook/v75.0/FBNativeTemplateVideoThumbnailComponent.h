...
@class NSDictionary, FBFeedVideoThumbnailComponent, FBNativeTemplateContext, NSString;

@interface FBNativeTemplateVideoThumbnailComponent : NTNativeTemplateComponent <NTHasGraphQL, NTHasComponentAttributes, NTHasTriggerableIntrinsicAction> {
