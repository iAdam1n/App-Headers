...
@interface FBReactionUnitsStreamResponseHandler : FBStreamResponseHandler {
	...
	/*^block*/id _processResponseBlock;

}

@property (nonatomic,copy) id processResponseBlock;              //@synthesize processResponseBlock=_processResponseBlock - In the implementation block
...
-(id)initWithTargetID:(id)arg1 loadType:(unsigned long long)arg2 parser:(id)arg3 analytics:(id)arg4 processResponseBlock:(/*^block*/id)arg5 ;
-(id)processResponseBlock;
-(void)setProcessResponseBlock:(id)arg1 ;
@end
