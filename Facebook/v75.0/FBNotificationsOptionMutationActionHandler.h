...
@class FBNotificationsOptionsModificationService, NSString;

@interface FBNotificationsOptionMutationActionHandler : NSObject <FBNotificationsOptionsActionHandling> {
