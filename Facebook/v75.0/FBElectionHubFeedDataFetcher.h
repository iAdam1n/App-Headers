...
@interface FBElectionHubFeedDataFetcher : NSObject <FBGraphQLConnectionControllerListener, FBGraphQLConnectionControllerLoadListener> {

	BOOL _finishedInitialLoad;
	FBGraphQLConnectionController* _connectionController;
	id<FBElectionHubFeedDataFetcherDelegate> _delegate;

}

@property (assign,nonatomic,__weak) id<FBElectionHubFeedDataFetcherDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(void)loadInitial;
-(void)setDelegate:(id<FBElectionHubFeedDataFetcherDelegate>)arg1 ;
-(id<FBElectionHubFeedDataFetcherDelegate>)delegate;
@end
