...
@class FBFeedToolbox, FBMemStoryAttachment, NSString;

@interface FBMultiShareAttachmentComponent : CKCompositeComponent <FBStoryAttachmentRenderingFragmentComponent> {
...
+(id)newWithAttachment:(const FBMultiShareAttachmentComponentGraphQL*)arg1 options:(const FBStoryAttachmentRenderingComponentOptions*)arg2 toolbox:(id)arg3 ;
+(id)supportedStyles;
