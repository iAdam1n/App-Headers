...
-(id)initWithTargetID:(id)arg1 callbackPerformer:(id)arg2 callSite:(unsigned long long)arg3 bsid:(id)arg4 typeaheadSessionID:(id)arg5 ntCachedTemplateVersion:(id)arg6 ;
@end
