...
@protocol FBReactionAttachmentsAdapter;
@interface FBReactionAdapterWrappingAttachmentsComponent : CKCompositeComponent <FBReactionAttachmentsComponent> {

	id<FBReactionAttachmentsAdapter> _adapter;
