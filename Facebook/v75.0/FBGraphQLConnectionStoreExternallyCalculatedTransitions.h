...
@class FBGraphQLConnectionStoreStateTransitions, NSString;

@interface FBGraphQLConnectionStoreExternallyCalculatedTransitions : NSObject <FBGraphQLConnectionStoreStateModifying> {
