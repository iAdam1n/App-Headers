...
@class FBMemModelObject, FBReactionContext, NSString, FBHScrollComponent;

@interface FBVideoCreatorChannelHorizontalScrollReactionBricksComponent : CKCompositeComponent <FBReactionBrickComponent> {
