...
@class FBStoreLocatorViewController, UIScrollView, NSString;

@interface FBWatchAndLocalContentViewController : UIViewController <FBWatchAndMoreContentControlling, FBWatchAndMoreViewControllerDelegate> {

	FBStoreLocatorViewController* _storeLocator;
...
-(id)initWithStoreLocatorURL:(id)arg1 videoToolbox:(id)arg2 ;
