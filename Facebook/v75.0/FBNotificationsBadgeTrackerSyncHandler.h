...
@class FBNotificationsSyncManager, FBUserSession, NSString;

@interface FBNotificationsBadgeTrackerSyncHandler : NSObject <FBNotificationsSyncManagerListener> {
...
-(id)initWithSyncManager:(id)arg1 session:(id)arg2 ;
@end
