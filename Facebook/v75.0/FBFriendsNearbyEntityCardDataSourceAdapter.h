...
@interface FBFriendsNearbyEntityCardDataSourceAdapter : NSObject <FBEntityCardsPageDownloadQueryProvider> {
...
+(id)entityCardDataSourceWithEntities:(id)arg1 initialSelectedIndex:(unsigned long long)arg2 session:(id)arg3 ;
-(id)pageInfoKeyPath;
-(id)entityKeyPath;
