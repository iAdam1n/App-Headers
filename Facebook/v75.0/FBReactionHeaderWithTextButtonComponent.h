...
@interface FBReactionHeaderWithTextButtonComponent : CKCompositeComponent <FBReactionBrickComponent> {

	id<FBReactionAction> _headerTapAction;
	id<FBReactionAction> _buttonAction;
