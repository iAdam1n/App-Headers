...
@class FBUserSession, FBProfileBadgeFetcher, NSString;

@interface FBComposerProfileBadgeUpdateService : NSObject <FBComposerPublisherStatusListener, FBAppService> {

	FBUserSession* _session;
	FBProfileBadgeFetcher* _profileBadgeFetcher;
	BOOL _profileBadgeExperimentEnabled;
