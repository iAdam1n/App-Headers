...
@class FBUserSession, FBPageActionHandlerToolbox, FBPageSubscriptionsViewController, FBNuxController, FBMemPage, NSString;

@interface FBPageFollowActionHandler : NSObject <FBPageActionHandling> {
...
-(void)_showFollowActionNuxIfNecessaryForView:(id)arg1 ;
-(FBMemPage *)page;
