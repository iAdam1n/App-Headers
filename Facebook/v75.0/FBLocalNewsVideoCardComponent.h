...
@class FBMemFeedStory, FBMemVideo, FBLocalNewsToolbox, NSArray, FBLocalNewsVideoComponent, NSString;

@interface FBLocalNewsVideoCardComponent : CKCompositeComponent <FBLocalNewsCardRenderingComponentProvider> {

	FBMemFeedStory* _localNewsStory;
	FBMemVideo* _video;
	FBLocalNewsToolbox* _toolbox;
	NSArray* _trackingCodes;
	FBLocalNewsVideoComponent* _videoComponent;
