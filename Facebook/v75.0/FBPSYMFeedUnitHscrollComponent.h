...
@class FBFeedToolbox, FBAnalyticsInfo, FBMemPageStoriesYouMissedFeedUnit;

@interface FBPSYMFeedUnitHscrollComponent : CKCompositeComponent {

	FBFeedToolbox* _toolbox;
	FBAnalyticsInfo* _analyticsInfo;
	FBMemPageStoriesYouMissedFeedUnit* _unit;
