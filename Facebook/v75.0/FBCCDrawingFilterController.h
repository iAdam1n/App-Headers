...
@class FBMPDrawingFilter, NSString;

@interface FBCCDrawingFilterController : NSObject <FBCaptureCoordinatorFilterController> {

	FBMPDrawingFilter* _filter;
