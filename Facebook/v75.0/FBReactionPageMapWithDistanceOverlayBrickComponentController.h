...
@interface FBReactionPageMapWithDistanceOverlayBrickComponentController : CKComponentController <FBLocationAccessManagerDelegate>
...
-(void)updateLocationSucceededwithLocation:(id)arg1 ;
@end
