...
@class FBFeedGraphQLConnectionControllerAnnouncerFilter, FBFlattenedArrayController, FBLegacyStreamFeedFetchControllerQueue, NSString;

@interface FBMemLegacyStreamFeedFetchController : NSObject <FBGraphQLConnectionListener, FBStreamListener, FBGraphQLConnectionControllerLoadListener, FBGraphQLConnectionControllerNetworkListener, FBInvalidating> {
	...
	FBLegacyStreamFeedFetchControllerQueue* _fetchControllerQueue;
	BOOL _valid;
