...
@interface FBRichStoryTextStyle : NSObject {
	...
	SCD_Struct_FB814 _innerPadding;
	SCD_Struct_FB814 _margins;
...
@property (assign,nonatomic) SCD_Struct_FB814 innerPadding;                       //@synthesize innerPadding=_innerPadding - In the implementation block
@property (assign,nonatomic) SCD_Struct_FB814 margins;                            //@synthesize margins=_margins - In the implementation block
...
-(SCD_Struct_FB814)margins;
-(void)setMargins:(SCD_Struct_FB814)arg1 ;
