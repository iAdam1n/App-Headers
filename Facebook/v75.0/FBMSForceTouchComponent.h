...
@class FBIntentTarget, FBFeedToolbox, NSString;

@interface FBMSForceTouchComponent : CKCompositeComponent <FBForceTouchIntentProvider> {
...
+(id)newWithComponent:(id)arg1 intentTarget:(id)arg2 toolbox:(id)arg3 ;
