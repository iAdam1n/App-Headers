...
@interface FBISCenterOverlayNode : ASDisplayNode <FBOverlayNodeProtocol> {

	ASDisplayNode* _overlayNode;
	double _overlayFrameWidth;
...
-(id)initWithOverlayNode:(id)arg1 overlayFrameWidth:(double)arg2 ;
-(void)layout;
@end
