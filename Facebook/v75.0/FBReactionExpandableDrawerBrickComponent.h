...
@protocol FBQueriedReactionUnitFieldsProtocol, FBReactionUnitComponentAdapter;
@class FBReactionContext, FBMemModelObject;

@interface FBReactionExpandableDrawerBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {

	unsigned long long _state;
	FBReactionContext* _reactionContext;
	FBMemModelObject*<FBQueriedReactionUnitFieldsProtocol> _unit;
	id<FBReactionUnitComponentAdapter> _adapter;
