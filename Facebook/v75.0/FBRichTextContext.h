...
@interface FBRichTextContext : NSObject <NSCopying> {
	...
	CGSize _size;
	FBEventsDashboardScrollCounts _visibleRange;
...
@property (assign,nonatomic) FBEventsDashboardScrollCounts visibleRange;                          //@synthesize visibleRange=_visibleRange - In the implementation block
...
-(void)enumerateTextFragmentsForTextRange:(FBEventsDashboardScrollCounts)arg1 usingBlock:(/*^block*/id)arg2 ;
...
-(void)_enumerateTextForTextRange:(FBEventsDashboardScrollCounts)arg1 measureOption:(unsigned long long)arg2 usingTextFragmentBlock:(/*^block*/id)arg3 textFragmentRunBlock:(/*^block*/id)arg4 ;
...
-(void)enumerateTextFragmentsForTextRange:(FBEventsDashboardScrollCounts)arg1 measureOption:(unsigned long long)arg2 usingBlock:(/*^block*/id)arg3 ;
-(void)enumerateTextRunsForTextRange:(FBEventsDashboardScrollCounts)arg1 usingBlock:(/*^block*/id)arg2 ;
-(void)enumerateTruncationTextRunsForTextRange:(FBEventsDashboardScrollCounts)arg1 usingBlock:(/*^block*/id)arg2 ;
-(CTLineRef)extraLine;
...
-(void)setVisibleRange:(FBEventsDashboardScrollCounts)arg1 ;
-(FBEventsDashboardScrollCounts)visibleRange;
