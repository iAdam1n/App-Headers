...
@interface FBCommentPlaceInfoAttachmentHScrollPersonMiddleComponent : CKCompositeComponent {
...
+(id)newWithActor:(id)arg1 comment:(id)arg2 deleteAction:(CKTypedComponentAction<>)arg3 theme:(unsigned long long)arg4 toolbox:(id)arg5 attributes:(const unordered_map<CKComponentViewAttribute, CKBoxedValue, std::__1::hash<CKComponentViewAttribute>, std::__1::equal_to<CKComponentViewAttribute>, std::__1::allocator<std::__1::pair<const CKComponentViewAttribute, CKBoxedValue> > >*)arg6 ;
-(void)didTapPersonCard:(id)arg1 ;
@end
