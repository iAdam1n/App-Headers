...
@interface FBPageAttachmentComponent : CKCompositeComponent <FBForceTouchIntentProvider> {
...
+(id)newWithAttachment:(const FBPageAttachmentComponentGraphQL*)arg1 options:(const FBStoryAttachmentRenderingComponentOptions*)arg2 toolbox:(id)arg3 ;
