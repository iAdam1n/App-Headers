...
-(id)initWithTargetID:(id)arg1 callbackPerformer:(id)arg2 callSite:(unsigned long long)arg3 bsid:(id)arg4 typeaheadSessionID:(id)arg5 preloadedStoryIds:(id)arg6 count:(unsigned long long)arg7 ntCachedTemplateVersion:(id)arg8 ;
-(id)description;
@end
