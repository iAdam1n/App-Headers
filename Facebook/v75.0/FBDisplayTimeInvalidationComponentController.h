...
@interface FBDisplayTimeInvalidationComponentController : CKComponentController <FBComponentControllerWorkingRangeListenerProviding, FBComponentControllerWorkingRangeListening> {

	BOOL _alreadyBeenOnScreen;
...
-(void)notSpamAction;
-(void)secureMyAccountAction;
-(void)learnMoreAction;
-(void)deletePostAction:(id)arg1 ;
@end
