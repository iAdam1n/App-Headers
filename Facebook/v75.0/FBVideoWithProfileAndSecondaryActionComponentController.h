...
@class FBVideoWithProfileAndSecondaryActionComponent, NSString;

@interface FBVideoWithProfileAndSecondaryActionComponentController : CKComponentController <FBVideoPlaybackEventListener> {

	double _startedPlayingAtTime;

}

@property (nonatomic,readonly) FBVideoWithProfileAndSecondaryActionComponent * component; 
