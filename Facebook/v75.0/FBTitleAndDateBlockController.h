...
@class FBTitleAndDateNode, FBRichStoryEntityBlock, FBRichStoryBlockDisplayContext, NSString;

@interface FBTitleAndDateBlockController : FBBackgroundDeallocatedObject <FBRichStoryBlockController> {

	FBTitleAndDateNode* _titleAndDateNode;
