...
@class FBMemModelObject, UIView, FBReactionContext, CKComponentHostingView, FBFeedToolbox, UIControl, FBConsistentLookasideCacheObservationHandle, NSString;

@interface FBReactionEventDescriptionWithFacepileAndDetailUnitComponentAdapter : FBReactionBaseUnitComponentAdapter <FBReactionFixedHeightVerticallyCenteredViewDelegate> {
