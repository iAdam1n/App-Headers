...
@interface FBVideoSegmentedEncoder : NSObject {
	...
	SCD_Struct_FB100 _segmentDuration;
...
-(void)cancelEncoding;
-(id)initWithAssetWriter:(id)arg1 assetReader:(id)arg2 assetInput:(id)arg3 pixelAdaptor:(id)arg4 assetOutput:(id)arg5 mediaProcessor:(id)arg6 segmentDuration:(SCD_Struct_FB100)arg7 queue:(id)arg8 ;
