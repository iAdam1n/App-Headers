...
@class FBUserSession, FBPageActionHandlerToolbox, UIActionSheet, FBMemPage, NSString;

@interface FBPageLikeActionHandler : NSObject <UIActionSheetDelegate, FBPageActionHandling> {
...
-(void)_updateLikeAction:(BOOL)arg1 ;
-(FBMemPage *)page;
