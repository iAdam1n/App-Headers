...
@interface FBProfileDiscoveryBucketComponentController : CKComponentController <FBComponentControllerWorkingRangeListenerProviding, FBComponentControllerWorkingRangeListening>
...
-(void)createPhotoGridImage:(id)arg1 ;
@end
