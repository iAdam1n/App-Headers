...
@interface FBReactionPageInlineUpsellBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {
...
+(id)_createButtonBuilderForInlineUpsellComponent:(id)arg1 ;
-(void)didTap:(id)arg1 ;
@end
