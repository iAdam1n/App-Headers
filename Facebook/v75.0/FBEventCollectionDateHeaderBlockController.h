...
@class FBMemDocumentDateHeaderElement, FBEventCollectionDateHeaderNode, FBFeedToolbox, FBRichStoryBlockDisplayContext, NSString;

@interface FBEventCollectionDateHeaderBlockController : NSObject <FBRichStoryBlockController> {

	FBMemDocumentDateHeaderElement* _dateHeader;
	FBEventCollectionDateHeaderNode* _node;
...
-(id)initWithDateHeader:(id)arg1 session:(id)arg2 displayContext:(id)arg3 ;
