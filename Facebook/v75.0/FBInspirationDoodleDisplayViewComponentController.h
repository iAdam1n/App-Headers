...
@interface FBInspirationDoodleDisplayViewComponentController : CKStatefulViewComponentController <FBDrawingControllerDelegate> {

	CGRect _renderViewFrame;
...
-(void)resetUserInteractionDoodleView;
