...
-(void)performTransitionToPresentationAttributes:(id)arg1 onBlock:(id)arg2 animation:(SCD_Struct_FB196)arg3 ;
...
-(void)_finishTransitionForStoryBlock:(id)arg1 withTrackingVelocity:(CGPoint)arg2 animation:(SCD_Struct_FB196)arg3 ;
...
-(SCD_Struct_FB196)_transitionAnimationConfigurationForStoryBlock:(id)arg1 withVelocity:(double)arg2 ;
