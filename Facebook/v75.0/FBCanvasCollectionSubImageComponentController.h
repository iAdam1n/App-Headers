...
@class FBInstantShoppingDocumentDownloader, FBCanvasCollectionSubImageComponent, NSString;

@interface FBCanvasCollectionSubImageComponentController : CKComponentController <FBComponentControllerWorkingRangeListenerProviding, FBComponentControllerWorkingRangeListening> {

	FBInstantShoppingDocumentDownloader* _downloader;

}

@property (nonatomic,readonly) FBCanvasCollectionSubImageComponent * component; 
...
-(void)didTapOnSubAttachment:(id)arg1 ;
@end
