...
@interface FBMultiPickerVideoAttachment : NSObject <FBVideoAttachmentProtocol, NSCoding, NSCopying> {
	...
	NSURL* _trimmedURL;
	SCD_Struct_FB828 _editsValue;
	SCD_Struct_FB140 _allowEditingValue;
...
-(void)_exportVideoDataWithProgress:(/*^block*/id)arg1 completion:(/*^block*/id)arg2 fileURL:(id)arg3 videoExportConfig:(id)arg4 errorSimulation:(id)arg5 timeRange:(SCD_Struct_FB101)arg6 ;
