...
@protocol FBReactionAttachmentsAdapterDelegate, FBQueriedReactionUnitFieldsProtocol;
@class UIView, NSMutableArray, FBReactionContext, FBUserSession, FBMemModelObject, NSString;

@interface FBReactionEntityHorizontalScrollAttachmentsAdapter : FBReactionBaseAttachmentAdapter <_FBReactionAdapterProfileHelperDelegate, UIScrollViewDelegate, FBReactionAttachmentActionAdapterDelegate> {
