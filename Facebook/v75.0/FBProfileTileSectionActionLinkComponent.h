...
@protocol FBQueriedStoryActionLinkFieldsProtocol, FBProfileTileSectionComponentToolbox;
@class FBMemModelObject;

@interface FBProfileTileSectionActionLinkComponent : CKCompositeComponent {

	FBMemModelObject*<FBQueriedStoryActionLinkFieldsProtocol> _actionLink;
	id<FBProfileTileSectionComponentToolbox> _toolbox;

}
+(id)newWithActionLink:(id)arg1 toolbox:(id)arg2 ;
@end
