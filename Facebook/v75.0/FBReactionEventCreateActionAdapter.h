...
@class FBUserSession, FBReactionContext, FBEventCreationFlowCoordinator;

@interface FBReactionEventCreateActionAdapter : FBReactionBaseActionAdapter {

	FBUserSession* _session;
	FBReactionContext* _context;
	FBEventCreationFlowCoordinator* _coordinator;
