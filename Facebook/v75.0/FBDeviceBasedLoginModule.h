...
@interface FBDeviceBasedLoginModule : NSObject <FBAppServiceConfiguringModule, FBNuxPresenterConfiguringModule>
...
+(id)settingsNavigationControllerWithImageDownloader:(id)arg1 ;
@end
