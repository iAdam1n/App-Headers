...
@class FBMemOverlayActionLink, FBFeedToolbox, NSString;

@interface FBFeedStoryOverlayCTARenderingComponent : CKCompositeComponent <FBFeedStoryAttachmentCTARenderingComponent> {
