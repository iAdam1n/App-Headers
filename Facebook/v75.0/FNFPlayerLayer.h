...
#import <Facebook/FNFDecompressionSessionDelegate.h>
#import <Facebook/FNFPlayerDisplayEngine.h>
#import <Facebook/FNFAVPlayerLayer.h>
...
@interface FNFPlayerLayer : CAEAGLLayer <FNFDecompressionSessionDelegate, FNFPlayerDisplayEngine, FNFAVPlayerLayer> {
	...
	SCD_Struct_FB100 _bufferTimes[60];
...
-(void)_requestData;
-(id)initWithConfigs:(SCD_Struct_FN1587)arg1 ;
...
-(void)yieldDecompressedBuffer:(CVBufferRef)arg1 presentationTimeStamp:(SCD_Struct_FB100)arg2 presentationDuration:(SCD_Struct_FB100)arg3 iFrame:(unsigned long long)arg4 ;
...
-(void)_addBuffer:(CVBufferRef)arg1 presentationTimeStamp:(SCD_Struct_FB100)arg2 iFrameEnqueued:(unsigned long long)arg3 ;
-(void)display:(CVBufferRef)arg1 presentationTimeStamp:(SCD_Struct_FB100)arg2 presentationDuration:(SCD_Struct_FB100)arg3 iFrameEnqueued:(unsigned long long)arg4 ;
