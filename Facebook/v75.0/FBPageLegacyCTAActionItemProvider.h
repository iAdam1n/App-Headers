...
@class FBMemPage, FBMemPageCallToAction, FBUserSession, NSString;

@interface FBPageLegacyCTAActionItemProvider : NSObject <FBPageActionItemProviding> {

	FBMemPage* _page;
	FBMemPageCallToAction* _pageCallToAction;
...
+(id)ctaActionItemPreviewForCTAType:(id)arg1 ;
