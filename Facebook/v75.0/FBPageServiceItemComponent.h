...
@interface FBPageServiceItemComponent : CKCompositeComponent <FBPageServiceItemTappableTarget> {
...
+(id)newWithProductItem:(id)arg1 shouldHighlight:(BOOL)arg2 action:(CKTypedComponentAction<>)arg3 shouldKeepPriceHeight:(BOOL)arg4 ;
