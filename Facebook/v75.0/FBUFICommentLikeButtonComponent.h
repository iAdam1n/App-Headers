...
@interface FBUFICommentLikeButtonComponent : CKCompositeComponent {
	...
	FBUFICommentLikeButtonComponentGraphQL* _comment;
	FBUFICommentToolbox* _toolbox;
	CKTypedComponentAction<> _likeButtonAction;

}
+(id)newWithComment:(const FBUFICommentLikeButtonComponentGraphQL*)arg1 likeButtonAction:(CKTypedComponentAction<>)arg2 likeButtonAttributes:(unordered_map<CKComponentViewAttribute, CKBoxedValue, std::__1::hash<CKComponentViewAttribute>, std::__1::equal_to<CKComponentViewAttribute>, std::__1::allocator<std::__1::pair<const CKComponentViewAttribute, CKBoxedValue> > >*)arg3 theme:(unsigned long long)arg4 toolbox:(id)arg5 ;
