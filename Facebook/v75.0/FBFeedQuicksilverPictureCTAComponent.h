...
@class FBMemAppAttributionActionLink, FBMemFeedStory, FBFeedToolbox, NSString;

@interface FBFeedQuicksilverPictureCTAComponent : CKCompositeComponent <FBFeedStoryAttachmentCTARenderingComponent> {

	FBMemAppAttributionActionLink* _actionLink;
