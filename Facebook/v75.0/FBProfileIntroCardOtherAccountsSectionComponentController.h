...
@interface FBProfileIntroCardOtherAccountsSectionComponentController : CKComponentController <FBComponentControllerWorkingRangeListenerProviding, FBComponentControllerWorkingRangeListening> {
...
-(void)didTapEditLinksButton:(id)arg1 ;
-(void)didTapAddLinksButton:(id)arg1 ;
-(void)_didTapLinksButton;
@end
