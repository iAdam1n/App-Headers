...
@interface FBPersonCardSectionPeopleDiscoveryMutualityController : NSObject <FBProfileSectionController> {
...
-(void)configureWithPerson:(id)arg1 isViewingSelf:(BOOL)arg2 shouldHideContextListItemNux:(BOOL)arg3 ;
