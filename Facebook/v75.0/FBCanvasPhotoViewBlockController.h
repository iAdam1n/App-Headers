...
@class FBCanvasMediaViewNode, FBCanvasPhotoViewBlock, UIView, NSString;

@interface FBCanvasPhotoViewBlockController : FBBackgroundDeallocatedObject <FBRichStoryBlockController> {

	FBCanvasMediaViewNode* _photoViewNode;
	FBCanvasPhotoViewBlock* _storyBlock;
	UIView* _photoView;
