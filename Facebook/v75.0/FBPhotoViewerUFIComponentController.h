...
@interface FBPhotoViewerUFIComponentController : CKComponentController
-(void)shareAction:(id)arg1 context:(id)arg2 ;
-(void)likeAction:(id)arg1 ;
-(void)commentAction:(id)arg1 ;
-(void)reactionsInputPresentationAction:(id)arg1 ;
-(void)reactionsInputDismissalAction:(id)arg1 ;
@end
