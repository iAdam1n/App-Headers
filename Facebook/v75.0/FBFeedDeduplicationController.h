...
@interface FBFeedDeduplicationController : NSObject <FBFeedGraphQLConnectionManagerListener> {
...
-(id)feedDeduplicatorForEdgesStoreWithTargetID:(id)arg1 feedType:(long long)arg2 ;
