...
@interface FBPhotoViewerDisablingComponent : CKCompositeComponent {

	long long _theme;
	CKComponent* _component;

}
+(id)newWithComponent:(id)arg1 theme:(long long)arg2 disabled:(BOOL)arg3 scopeIdentifier:(id)arg4 ;
