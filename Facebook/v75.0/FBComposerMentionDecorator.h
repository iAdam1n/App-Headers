...
#import <Facebook/FBMemAvatarTaggingSearchProviderDelegate.h>
...
-(SCD_Struct_FB466)_detectChangedRangeIn:(id)arg1 from:(id)arg2 probableChangeEnd:(unsigned long long)arg3 ;
