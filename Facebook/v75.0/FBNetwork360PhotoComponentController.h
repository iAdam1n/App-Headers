...
@interface FBNetwork360PhotoComponentController : CKComponentController <FBComponentControllerWorkingRangeListenerProviding, FBComponentControllerWorkingRangeListening> {
...
-(void)forceReload360Photo;
-(void)load360PhotoIfNeededComponent:(id)arg1 ;
@end
