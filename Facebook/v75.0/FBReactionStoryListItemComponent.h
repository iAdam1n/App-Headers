...
@class FBReactionContext, FBMemFeedStory, FBMemModelObject;

@interface FBReactionStoryListItemComponent : CKCompositeComponent {
...
+(id)newWithAttachment:(id)arg1 unit:(id)arg2 reactionContext:(id)arg3 ;
-(void)tapped;
@end
