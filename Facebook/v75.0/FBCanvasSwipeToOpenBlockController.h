...
@class FBCanvasSwipeToOpenNode, NSDictionary, FBCanvasSwipeToOpenBlock, NSString;

@interface FBCanvasSwipeToOpenBlockController : NSObject <FBRichStoryBlockController> {

	FBCanvasSwipeToOpenNode* _swipeToOpenNode;
	NSDictionary* _presentationAttributes;
	FBCanvasSwipeToOpenBlock* _storyBlock;
