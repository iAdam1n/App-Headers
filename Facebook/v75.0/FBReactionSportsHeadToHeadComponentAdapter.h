...
@class CKComponentHostingView, FBMemModelObject, FBReactionContext;

@interface FBReactionSportsHeadToHeadComponentAdapter : FBReactionBaseUnitComponentAdapter {
