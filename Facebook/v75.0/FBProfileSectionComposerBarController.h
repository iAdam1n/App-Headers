...
@class FBUserSession, FBInlineComposerViewSpecifier, NSString;
...
-(void)setShowComposer:(BOOL)arg1 targetPerson:(id)arg2 ;
-(void)_createInlineComposerSpecifierWithTargetPerson:(id)arg1 ;
-(void)_showComposer;
-(void)_hideComposer;
