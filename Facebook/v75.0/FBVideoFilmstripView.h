...
@interface FBVideoFilmstripView : UIScrollView <FBVideoFilmstripViewGeometryDelegate, FBVideoFilmstripFrameViewDelegate, UIScrollViewDelegate, FBVideoFilmstripThumbnailStoreSource, FBVideoFilmstripScrubGestureRecognizerDelegate> {
	...
	SCD_Struct_FB1182 _filmDelegateMethods;
...
-(SCD_Struct_FB101)timeRangeForBounds;
-(SCD_Struct_FB101)timeRangeForRect:(CGRect)arg1 ;
-(double)xPositionForTime:(SCD_Struct_FB100)arg1 ;
...
-(/*^block*/id)thumbnailStore:(id)arg1 fetchThumbnailAtTime:(SCD_Struct_FB100)arg2 queue:(id)arg3 completionBlock:(/*^block*/id)arg4 ;
...
-(BOOL)_computeTimesForHorizontalPoints:(const double*)arg1 count:(unsigned long long)arg2 into:(SCD_Struct_FB100*)arg3 ;
-(double)effectivePointsPerSecond;
-(void)_recycleStripFrameViews;
-(SCD_Struct_FB100)_scrubberTimeForGestureRecognizer:(id)arg1 ;
