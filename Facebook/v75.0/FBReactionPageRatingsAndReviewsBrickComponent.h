...
@interface FBReactionPageRatingsAndReviewsBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {

	id<FBReactionAction> _seeAllRatingsAction;
	id<FBReactionAction> _writeReviewAction;
...
-(void)didTapOnRatingInfo:(id)arg1 ;
-(void)didTapOnWriteReviewButton:(id)arg1 ;
@end
