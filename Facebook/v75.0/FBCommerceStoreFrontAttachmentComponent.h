...
@interface FBCommerceStoreFrontAttachmentComponent : CKCompositeComponent <FBStoryAttachmentRenderingFragmentComponent> {
...
+(id)newWithAttachment:(const FBCommerceStoreFrontAttachmentComponentGraphQL*)arg1 options:(const FBStoryAttachmentRenderingComponentOptions*)arg2 toolbox:(id)arg3 ;
+(id)supportedStyles;
