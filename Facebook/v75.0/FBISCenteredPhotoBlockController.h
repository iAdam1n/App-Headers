...
@class ASDisplayNode, FBISMediaEntityBlock, FBUserSession, NSString;

@interface FBISCenteredPhotoBlockController : FBBackgroundDeallocatedObject <FBRichStoryBlockController> {

	ASDisplayNode* _photoNode;
