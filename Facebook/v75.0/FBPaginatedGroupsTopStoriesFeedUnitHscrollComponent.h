...
@class FBFeedToolbox, FBMemGroupTopStoriesFeedUnit, FBFeedInfiniteHScrollComponent;

@interface FBPaginatedGroupsTopStoriesFeedUnitHscrollComponent : CKCompositeComponent {

	FBFeedToolbox* _toolbox;
	FBMemGroupTopStoriesFeedUnit* _unit;
...
@property (nonatomic,readonly) FBMemGroupTopStoriesFeedUnit * unit;                            //@synthesize unit=_unit - In the implementation block
...
-(FBMemGroupTopStoriesFeedUnit *)unit;
@end
