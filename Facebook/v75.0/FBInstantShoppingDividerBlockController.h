...
@class ASDisplayNode, FBMemInstantShoppingDocumentDividerElement, NSString;

@interface FBInstantShoppingDividerBlockController : NSObject <FBRichStoryBlockController> {

	ASDisplayNode* _renderable;
	FBMemInstantShoppingDocumentDividerElement* _dividerElement;
