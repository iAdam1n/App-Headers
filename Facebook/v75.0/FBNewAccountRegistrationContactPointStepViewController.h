...
@class FBNewAccountRegistrationContactPointView, FBPhoneInputHandler, LPPhoneNumberFactory, FBNewAccountRegistrationStepView, NSString, FBNewAccountRegistrationData, NSArray;
