...
@interface FBActorSequenceToSeenByListIntentTransformer : NSObject <FBIntentHandler> {

	id<FBIntentHandler> _underlyingIntentHandler;
...
-(id)initWithUnderlyingIntentHandler:(id)arg1 feedback:(id)arg2 ;
@end
