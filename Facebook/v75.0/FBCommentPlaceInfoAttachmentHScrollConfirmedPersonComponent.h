...
@interface FBCommentPlaceInfoAttachmentHScrollConfirmedPersonComponent : CKCompositeComponent <FBHScrollImpressionLogging> {
...
+(id)newWithActor:(id)arg1 comment:(id)arg2 commentPlaceInfo:(id)arg3 scrollIndex:(unsigned long long)arg4 theme:(unsigned long long)arg5 toolbox:(id)arg6 attributes:(const unordered_map<CKComponentViewAttribute, CKBoxedValue, std::__1::hash<CKComponentViewAttribute>, std::__1::equal_to<CKComponentViewAttribute>, std::__1::allocator<std::__1::pair<const CKComponentViewAttribute, CKBoxedValue> > >*)arg7 ;
