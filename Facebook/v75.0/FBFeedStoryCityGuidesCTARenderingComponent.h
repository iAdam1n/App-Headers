...
@class FBFeedToolbox, FBMemPage, NSString;

@interface FBFeedStoryCityGuidesCTARenderingComponent : CKCompositeComponent <FBFeedStoryAttachmentCTARenderingComponent> {
