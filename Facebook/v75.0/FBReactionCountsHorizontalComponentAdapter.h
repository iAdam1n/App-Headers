...
@class UIView, FBMemModelObject, FBReactionContext, FBUserSession, NSMutableArray;

@interface FBReactionCountsHorizontalComponentAdapter : FBReactionBaseUnitComponentAdapter {
	...
	NSMutableArray* _actionAdapters;
