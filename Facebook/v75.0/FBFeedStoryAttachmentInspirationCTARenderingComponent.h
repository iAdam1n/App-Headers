...
@class FBFeedToolbox, FBMemInspirationActionLink, NSString;

@interface FBFeedStoryAttachmentInspirationCTARenderingComponent : CKCompositeComponent <FBFeedStoryAttachmentCTARenderingComponent> {

	FBFeedToolbox* _toolbox;
	FBMemInspirationActionLink* _actionLink;
	NSString* _storyID;
