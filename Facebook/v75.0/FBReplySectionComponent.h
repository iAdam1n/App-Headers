...
@class FBMemComment, FBFeedbackCommentsSectionComponentToolbox, FBCommentComponentActionListenerAnnouncer, FBCommentComponentEditListenerAnnouncer, FBReplySectionComponentListenerAnnouncer;

@interface FBReplySectionComponent : FBCompositeSectionComponent {
