...
#import <Facebook/FBPaymentsCartViewControllerDelegate.h>
...
@interface FBPaymentsSamplePaymentsModulesInvoiceCreationSection : NSObject <FBPaymentsCartViewControllerDelegate, FBPaymentsTableViewSection> {
...
-(void)cartViewControllerDidTapCancel:(id)arg1 ;
-(void)cartViewController:(id)arg1 didEncounterFatalError:(id)arg2 ;
-(void)cartViewControllerDidFinish:(id)arg1 ;
