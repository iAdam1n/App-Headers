...
@class FBReactionEventDescriptionWithDayAndTimeBrickComponentConfig;

@interface FBReactionEventDescriptionWithDayAndTimeBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {

	id<FBReactionAction> _action;
	FBReactionEventDescriptionWithDayAndTimeBrickComponentConfig* _config;
