...
@property (assign) BOOL needsRequestBioRow;                                                             //@synthesize needsRequestBioRow=_needsRequestBioRow - In the implementation block
...
-(void)setNeedsRequestBioRow:(BOOL)arg1 ;
