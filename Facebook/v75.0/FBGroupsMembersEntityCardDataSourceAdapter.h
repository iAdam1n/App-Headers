...
@interface FBGroupsMembersEntityCardDataSourceAdapter : NSObject <FBEntityCardsPageDownloadQueryProvider> {
...
+(id)entityCardDataSourceWithInfo:(id)arg1 session:(id)arg2 ;
-(id)pageInfoKeyPath;
-(id)entityKeyPath;
...
-(id)initWithSession:(id)arg1 groupID:(id)arg2 membersQueryType:(long long)arg3 ;
@end
