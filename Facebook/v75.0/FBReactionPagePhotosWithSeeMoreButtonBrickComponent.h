...
@class FBReactionContext, FBMemReactionPhotosHeaderWithSeeAllButtonComponent;

@interface FBReactionPagePhotosWithSeeMoreButtonBrickComponent : CKCompositeComponent <FBReactionBrickComponent> {

	FBReactionContext* _reactionContext;
	id<FBReactionAction> _action;
	FBMemReactionPhotosHeaderWithSeeAllButtonComponent* _photosComponent;
...
-(void)photoTapAction:(id)arg1 photo:(id)arg2 ;
-(void)seeAllTapped;
@end
